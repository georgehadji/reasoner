...
if want python; then
    # Keep in step with .github/workflows/test.yml -- this drifted to 2243 while
# that file said 2242, so the local gate disagreed with CI.
gate "ruff"   python scripts/ruff_ratchet.py --max 2236
