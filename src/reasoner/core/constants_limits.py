...
# Every alias below must exist in _MODEL_WHITELIST. Flux, Riverflow, Seedream,
# Recraft, MAI-Image and Grok-Imagine were removed from the registry when those
# providers left OpenRouter; keeping them here left the budget tier with a single
# working model and no working fallback at all.
IMAGE_GEN_PRESETS: dict[str, list[str]] = {
    "budget": [MODEL_GEMINI_FLASH_IMAGE, MODEL_QWEN_IMAGE_3],
    "premium": [MODEL_GPT54_IMAGE_2, MODEL_GEMINI_PRO_IMAGE],
    IMAGE_GEN_BUDGET_PRESET: [MODEL_GEMINI_FLASH_IMAGE, MODEL_QWEN_IMAGE_3],
    IMAGE_GEN_PREMIUM_PRESET: [MODEL_GPT54_IMAGE_2, MODEL_GEMINI_PRO_IMAGE],
}
IMAGE_GEN_FALLBACKS: dict[str, list[str]] = {
    "budget": [MODEL_GEMINI_31_FLASH_LITE_IMAGE, MODEL_GPT5_IMAGE_MINI],
    "premium": [MODEL_GPT5_IMAGE, MODEL_GEMINI_31_FLASH_IMAGE_PREVIEW, MODEL_QWEN_IMAGE_3_PRO],
    IMAGE_GEN_BUDGET_PRESET: [MODEL_GEMINI_31_FLASH_LITE_IMAGE, MODEL_GPT5_IMAGE_MINI],
    IMAGE_GEN_PREMIUM_PRESET: [MODEL_GPT5_IMAGE, MODEL_GEMINI_31_FLASH_IMAGE_PREVIEW, MODEL_QWEN_IMAGE_3_PRO],
}
