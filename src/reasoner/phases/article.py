...
ARTICLE_VERIFY_SYSTEM = (
    ...
    "Use the canonical five-value taxonomy:\n"
    "  - verified: claim matches source verbatim or near-verbatim\n"
    "  - supported: entailed by source, reworded\n"
    "  - partial: some support but incomplete\n"
    "  - speculative: opinion, hypothesis, or unverifiable claim\n"
    "  - unsupported: no source found, likely hallucinated\n"
    "Calculate a claim-support ratio (supported + partial*0.5 / total verifiable claims). "
    + JSON_ONLY_FOOTER
)
...
def article_verify_prompt(state: PipelineState, use_sonar: bool = False) -> str:
    ...
    return (
        ...
        f'"verdict": "verified|supported|partial|speculative|unsupported", '
        f'"source_url": "<url or null>", '
        f'"note": "<brief reason>"'
        f'}}], '
        f'"metrics": {{"total_claims": 0, "verified": 0, "supported": 0, "partial": 0, "speculative": 0, "unsupported": 0, "claim_support_ratio": 0.0}}, '
        ...
        f'"status": "verified|supported|partial|speculative|unsupported"'
        f'}}]}}'
    )
