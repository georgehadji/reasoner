...
export default function GlobalError({
  ...
  return (
    <html>
      ...
      <body className="flex min-h-[100dvh] flex-col items-center justify-center bg-[#131211] p-6 text-center">
        ...
        <h2 className="mb-2 text-xl font-semibold text-[#FAF9F5]">
          Critical Error
        </h2>
        <p className="mb-8 max-w-sm text-sm leading-relaxed text-[#A29C90]">
          The application failed to load. We&apos;ve been notified. Please refresh the page to try again.
        </p>
        <button
          onClick={() => reset()}
          className="inline-flex items-center justify-center rounded-xl bg-[#E39B80] px-5 py-2.5 text-sm font-semibold text-[#2A1610] transition-all hover:opacity-90 active:scale-[0.98]"
        >
          Refresh
        </button>
      </body>
