# Graph Report - Reasoner  (2026-06-20)

## Corpus Check
- 2602 files · ~1,065,324 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 36634 nodes · 52571 edges · 3015 communities (2536 shown, 479 thin omitted)
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 11517 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bc2a9a7d`
...
## Communities (3015 total, 479 thin omitted)

### Community 0 - "Article Pipeline"
Cohesion: 0.02
Nodes (78): AmbiguityDetectorSubAgent, AmbiguityDetectorSubAgent — ONE JOB: identify what is unclear or vague in the pr, _build_prompt(), _parse_result(), PhaseSubAgent, PhaseSubAgent — abstract base class for intra-phase focused reasoning agents.  E, Accumulate token usage and cost into PipelineState., One focused reasoning task within a pipeline phase. (+70 more)

### Community 1 - "Authentication & Security"
Cohesion: 0.03
Nodes (143): Authentication and rate-limiting FastAPI dependencies., FastAPI Dependency Injectors for SaaS Auth.  These functions are used as FastA, Reset quota service singleton (useful for tests)., Reset rate limiter singleton (useful for tests)., _reset_quota_service(), _reset_rate_limiter_instance(), SaaS Router — All new SaaS-related API endpoints.  This router is mounted in api, AuthenticationError (+135 more)

### Community 2 - "Event Sourcing & Domain Events"
Cohesion: 0.07
Nodes (78): Stop the background queue consumer., Background worker that consumes the event queue., Publish an event to all subscribers.          Handlers are called concurrently w, Execute handler with error isolation and retry., Clear all subscriptions., Get number of subscribers for an event type., Get total number of subscribers., Get or create the global event bus instance. (+70 more)

### Community 3 - "Verbalized Sampling & Benchmarks"
Cohesion: 0.06
Nodes (60): _extract_json(), GateAgent, Gate Agent — Lightweight pre-flight router that decides whether a user prompt sh, Return a GateDecision. Any failure falls back to pipeline., Extract the first JSON object from raw text., _check_depth(), JSONDepthExceededError, Safe JSON loading with depth limits to prevent stack exhaustion. (+52 more)

### Community 4 - "Neuro Memory & LTM"
Cohesion: 0.07
Nodes (38): ContextChunk, cosine_similarity(), L1Cache, L2Index, l3_scan(), Neuro Cache Hierarchy L1/L2/L3 with persona-aware similarity thresholds., Scan L3 (cold) memory files for relevant context.      Embeddings are cached as, size() (+30 more)

### Community 5 - "Widgets & Calculator"
Cohesion: 0.07
Nodes (70): BaseWidget, CalculatorWidget, Calculator Widget  Evaluates mathematical expressions using simpleeval (safe eva, Format result for display., Calculator widget for mathematical expressions.      Features:     - Basic arith, Extract expression from match., Evaluate mathematical expression., DiscoverWidget (+62 more)

### Community 6 - "Next.js API Routes"
Cohesion: 0.04
Nodes (65): Backward-compat shim — serializers moved to application/services/serializers.py., _extract_json(), get_architecture_components(), _check_pipeline_ownership(), delete_pipeline(), get_event_stats(), get_pipeline_status(), list_pipelines() (+57 more)

### Community 7 - "Article Detection & Styles"
Cohesion: 0.06
Nodes (33): CircuitBreaker, CircuitBreakerConfig, CircuitBreakerStats, CircuitOpenError, CircuitState, get_all_circuit_breakers(), get_circuit_breaker(), Reasoner Pipeline - Circuit Breaker Pattern Provides fault tolerance for LLM pro (+25 more)
...
Cohesion: 0.06
Nodes (33): Backward-compat shim — Neuro client moved to reasoner.clients., get_neuro_client(), Shared HTTP clients with connection pooling.  Reduces TCP handshake overhead for, Get or create a shared AsyncClient for Neuro endpoints., External context integration endpoint., Run the Reasoner pipeline with external context.      This endpoint accepts coll, run_with_context(), Persist ownership mapping for a pipeline run. (+25 more)

### Community 10 - "Alerting System"
Cohesion: 0.04
Nodes (57): ActiveFrictionGate, BehavioralAuditReport, BehavioralAuditStage, CoverageAuditStage, CoverageReport, EmbeddingModel, ExtractedClaim, FrictionAction (+49 more)

### Community 11 - "Application Entry Points"
Cohesion: 0.13
Nodes (22): ProviderUnavailableError, Provider service is unavailable.          This error IS retryable - may be a t, list_models(), Return all model IDs grouped by ecosystem., Return all model IDs grouped by ecosystem., Return all model IDs grouped by ecosystem., FineTunedProvider, Provider for fine-tuned models on custom endpoints.      Inherits all retry, str (+14 more)

### Community 12 - "Subagent Framework"
Cohesion: 0.06
Nodes (41): benchmark_vs_calibration(), main(), _pearson_r(), Calibration benchmark: verbalized entropy vs uncertainty correlation., Simulate entropy vs uncertainty measurements., benchmark_vs_calibration(), main(), _pearson_r() (+33 more)
...
Cohesion: 0.11
Nodes (45): cove_answer_prompt(), cove_draft_prompt(), cove_revise_prompt(), cove_verify_prompt(), PipelineState, pot_interpret_prompt(), build_followup_context(), _followup_context() (+37 more)
...
Cohesion: 0.03
Nodes (113): Fetch relevant past context from Neuro memory., Fetch relevant past context from Neuro memory., Fetch relevant past context from Neuro memory., Build a ReasonerPipeline from a PreflightDecision., Build a ReasonerPipeline from a PreflightDecision., Build a ReasonerPipeline from a PreflightDecision., Run the pipeline with the given decision. Returns final state., Run the pipeline with the given decision. Returns final state. (+105 more)

### Community 17 - "LLM Exceptions & Errors"
Cohesion: 0.06
Nodes (54): _collect_image_candidates(), _contains_policy_risk_terms(), _download_image_url(), _enhance_image_prompt(), _error_matches_any(), _extract_base64_from_text(), _extract_remote_urls_from_text(), _extract_text_from_content_parts() (+46 more)

### Community 18 - "Database Migrations"
Cohesion: 0.02
Nodes (120): CalculationRequest, DiscoverRequest, StockRequest, WeatherRequest, BaseModel, CalculationRequest, Protocol, ActiveFrictionGate (+112 more)
...
Cohesion: 0.14
Nodes (74): LLMExecutor, Stateless (per-call) infrastructure adapter that wraps ProviderRouter with     t, Update all token and model tracking fields on state., Compress fenced code blocks inside a prompt to save tokens.          Only compre, DecompositionHyperAgent, EnhancementHyperAgent, Orchestrates parallel synthesis subagents and produces FinalSolution., SynthesisHyperAgent (+66 more)
...
Cohesion: 0.06
Nodes (160): ParseError, Raised when LLM response cannot be parsed into expected structure., PhaseResult, How temperature should adapt on retry., Immutable record of one phase's execution.     Accumulated in PipelineState.pha, TemperatureStrategy, CriticScore, CritiqueScore (+152 more)
...
Cohesion: 0.04
Nodes (67): check_rate_limit(), get_client_id(), _get_rate_limiter_instance_auth_deps(), Factory for RateLimiter instance within auth_deps., Factory for RateLimiter instance within auth_deps., Extract client ID from request (IP + User-Agent)., Extract client ID from request (IP + User-Agent)., Check rate limit for request.     Raises HTTPException if rate limit exceeded. (+59 more)

### Community 30 - "Event Store Snapshot Tests"
Cohesion: 0.03
Nodes (64): PipelineState, Get condensed decomposition summary for token efficiency., Get condensed decomposition summary for token efficiency., Get condensed candidates summary for token efficiency., Backward-compat migration for --resume with old-format state files.         Als, Serialize complete state to dictionary (for persistence)., Save state to JSON file.                  Args:             path: File path t, Save state to JSON file.                  Args:             path: File path t (+56 more)

### Community 31 - "Frontend Phase Tests"
Cohesion: 0.10
Nodes (28): build_vs_prompt(), compute_verbalized_entropy(), _extract_json_block(), parse_vs_response(), Verbalized Sampling primitives — generation, parsing, normalization, sampling., Strip fences, regex-extract JSON, validate structure., Probability-weighted sample., Deterministic; tie → first. (+20 more)

### Community 32 - "Event Store Count Tests"
Cohesion: 0.05
Nodes (119): Scope, TaggedMemory — lightweight categorized conversation history store.  Organizes hi, Global Exception Handlers for FastAPI  Captures all unhandled exceptions, HTTP e, Build a safe JSON error response that doesn't leak internals., Handle HTTPException (4xx, 5xx from FastAPI/Starlette)., Handle RequestValidationError (malformed JSON, missing fields)., Catch-all handler for unhandled exceptions (500s)., Register all exception handlers on the FastAPI app. (+111 more)

### Community 33 - "Event Store List Tests"
Cohesion: 0.03
Nodes (101): create_checkout(), create_portal(), _get_paypal_service(), _get_stripe_service(), get_subscription(), paypal_webhook(), Public endpoint for Stripe webhooks., Public endpoint for PayPal webhooks. (+93 more)

### Community 34 - "Pricing & Cost Estimation"
Cohesion: 0.08
Nodes (31): clean_llm_artifacts(), InputSanitizer, Reasoner Pipeline - Input Sanitization Comprehensive input validation and saniti, Check for excessive character repetition., Check for other suspicious patterns., Sanitize problem input.      Args:         problem: Problem text from user, Result of sanitization operation., Strip invisible Unicode characters and LLM-specific control tokens from     outp (+23 more)

### Community 35 - "Event Store Get Tests"
Cohesion: 0.07
Nodes (29): BaseSubAgent, Extract the first valid JSON object from raw LLM text., One job. One cache. One execute() call., Return the focused system prompt for this sub-agent's single task., Parse the LLM's raw text into a structured dict.         Must always return a d, Run the sub-agent; returns SubAgentOutput (never raises)., Any, ProviderRouter (+21 more)
...
Cohesion: 0.07
Nodes (46): _get_build_provider(), run_article_retrieve_sources_phase(), BraveSearchAdapter, Brave Search API adapter — implements SearchServicePort.  Uses Brave Search API, Implements SearchServicePort for Brave Search API.      Graceful degradation: no, _decompose_query(), _extract_search_keywords(), get_discovery_client() (+38 more)

### Community 38 - "Chat Components & Hooks"
Cohesion: 0.09
Nodes (30): _extract_user_id(), generic_exception_handler(), _get_error_store(), http_exception_handler(), _log_error(), register_exception_handlers(), _safe_json_response(), validation_exception_handler() (+22 more)

### Community 39 - "Model Loading Tests"
Cohesion: 0.06
Nodes (55): Reset all usage_quotas at month start. Called by external scheduler., reset_all_quotas_monthly(), QuotaResult, Per-user query quota, reset monthly., Result of a quota check., UsageQuota, CachedQuotaRepository, Cache-aside decorator for a QuotaRepository.      - Reads hit Redis first, falli (+47 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (60): FastAPI router for all billing endpoints., BillingPort, Billing Port — Abstract interface for payment providers.  Stripe is the default, Port for subscription billing operations., Return a checkout URL for the user to complete payment., Return a billing portal URL for self-service management., Idempotently sync a subscription from a provider webhook event.          Args:, Immediately cancel a subscription at the provider. (+52 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (109): extract_json(), _parse_critique_scores(), Safely build CritiqueScore objects from raw LLM output.      CritiqueScore has, Safely build CritiqueScore objects from raw LLM output.      CritiqueScore has, Extract JSON object (dict) from LLM response.     Raises ParseError if no objec, Article writing pipeline phase logic., run_article_adversarial_verify_phase(), run_article_draft_phase() (+101 more)
...
Cohesion: 0.07
Nodes (49): BiasCritiqueSubAgent, CounterfactualSubAgent, EvidenceCritiqueSubAgent, CritiqueHyperAgent, Aggregate subagent findings into per-candidate CritiqueScore objects., Index a list of dicts by perspective name., Orchestrates parallel critique subagents and produces CritiqueScore list., LogicCritiqueSubAgent (+41 more)
...
Cohesion: 0.10
Nodes (27): BaseException, GateDecision, HyperContext, _extract_json(), GateAgent, GateDecision, Gate Agent — Lightweight pre-flight router that decides whether a user prompt s, Return a GateDecision. Any failure falls back to pipeline. (+19 more)
...
Cohesion: 0.08
Nodes (21): PipelineStarted, Pipeline execution started., EventStore, get_event_store(), Event Persistence Layer  Stores domain events in SQLite for durability and repla, Determine aggregate type from event type., Update aggregate state snapshot., Get or create database connection. (+13 more)
...
Cohesion: 0.07
Nodes (32): get_client_ip(), Resolve the actual client IP from a request.      Strategy:     1. If no trusted, check_preset_access(), check_quota(), check_quota_if_authenticated(), check_rate_limit(), _ensure_user_in_db(), get_current_user() (+24 more)
...
Cohesion: 0.09
Nodes (20): Persistent API key storage using SQLite (aiosqlite).  Provides durable storage f, PayPal implementation of BillingPort for one-time and subscription payments., datetime, AuthStore, Persistent API key storage using SQLite (aiosqlite).  Provides durable storage f, Retrieve a key by its hash. Returns None if not found., Increment usage_count and set last_used_at to now., Deactivate a key. Returns True if the key existed. (+12 more)
...
Cohesion: 0.11
Nodes (17): get_auth_adapter(), Auth adapter factory.  Selects the appropriate auth adapter based on environment, Get or create the global auth adapter., Override the auth adapter (useful for tests)., set_auth_adapter(), LocalAuthAdapter, Local Auth Adapter — Implements AuthPort using local JWT signing.  Used for: - D, Development auth adapter using local HS256 JWT.      Generates and validates tok (+9 more)
...
Cohesion: 0.07
Nodes (45): APIRouter, Lock, NeuroConfig, PersonaConfig, AuditRequest, AuditResponse, build_audit_system_prompt(), _cached_compress() (+37 more)

### Community 80 - "Community 80"
Cohesion: 0.02
Nodes (159): lifespan(), Background task to update active users gauge every 60s (Critical Enhancement 7.3, Background task to update active users gauge every 60s (Critical Enhancement 7.3, Application lifespan: startup and shutdown orchestration., Application lifespan: startup and shutdown orchestration., _update_active_users_loop(), AttachmentRef, ContextAnalysisRequest (+151 more)

### Community 81 - "Community 81"
Cohesion: 0.04
Nodes (82): _extract_balanced_structure(), extract_json_any(), _extract_json_array_value(), _extract_json_dict_fallback(), extract_json_list(), _extract_json_string_value(), extract_solution_prose(), _is_structural_quote() (+74 more)
...
Cohesion: 0.07
Nodes (33): _run_store, StopPipelineCommand, EventType, Types of domain events., ExecuteWidgetCommandHandler, get_handler_registry(), GetHistoryQueryHandler, GetPipelineStatusQueryHandler (+25 more)

### Community 94 - "Community 94"
Cohesion: 0.09
Nodes (29): clear_history(), delete_history_entry(), get_history(), get_history_entry(), get_tagged_history(), _list_history(), Search history endpoints., Clear all history for the authenticated user. (+21 more)
...
Cohesion: 0.02
Nodes (101): EventBus, get_event_bus(), handle_all_events(), handle_event(), init_default_subscribers(), log_all_events(), persist_all_events(), Start the background queue consumer. (+93 more)
...
Cohesion: 0.08
Nodes (28): get_phase_retry_budget(), get_phase_timeout(), get_quality_judge_model(), get_quality_judge_threshold(), Single source of truth for all hardcoded constants used across the Reasoner proj, Return the maximum number of retries allowed for a given phase., Return the maximum number of retries allowed for a given phase., Return the maximum number of retries allowed for a given phase. (+20 more)
...
Cohesion: 0.05
Nodes (44): Core abstractions for the Reasoner pipeline.  PhaseConfig  — per-phase LLM par, Clear the outputs written by the given phase so a retry starts clean., reset_phase_state(), Registry that maps method names to rendering strategies., Register a renderer for a method., Render pipeline state using the strategy for the given method., Return all registered method names., RendererService (+36 more)
...
Cohesion: 0.11
Nodes (24): LogRecord, configure_logging(), LogLevel, LogSource, Structured log entry in JSON format., Set request-scoped context for structured logging (Critical Enhancement 7.3)., Set correlation ID for current context., Logger that outputs structured JSON logs with correlation IDs. (+16 more)
...
Cohesion: 0.05
Nodes (70): _chunk_text(), _cosine_similarity(), DocumentVectorStore, Chunk and embed a document, writing embeddings to a JSON sidecar.          Args:, Retrieve the top-k most relevant chunks for a query.          Args:, Delete a document's vector sidecar., Split text into overlapping chunks.      Args:         text: Source text., Compute cosine similarity between two vectors. (+62 more)
...
Cohesion: 0.04
Nodes (55): BaseSubAgent, _parse_result(), BaseSubAgent — abstract base class every HyperGate sub-agent must extend.  Each, Extract the first valid JSON object from raw LLM text., One job. One cache. One execute() call., Return the focused system prompt for this sub-agent's single task., Parse the LLM's raw text into a structured dict.         Must always return a di, Run the sub-agent; returns SubAgentOutput (never raises). (+47 more)
...
Cohesion: 0.10
Nodes (26): _get_auth_manager_instance_auth_deps(), optional_auth(), Require valid API key authentication.     Raises HTTPException if authentication, Require valid API key authentication.     Raises HTTPException if authentication, Optional authentication - returns API key if provided, None otherwise., Optional authentication - returns API key if provided, None otherwise., Factory for AuthManager instance within auth_deps., Factory for AuthManager instance within auth_deps. (+18 more)
...
Cohesion: 0.07
Nodes (33): Lazy-load PostgreSQL symbols so asyncpg is not required at import time., Snapshot Strategy for Aggregate Performance  Periodic snapshots allow faster agg, PipelineStateData, Data class representing pipeline state., PostgreSQLEventStore, PostgreSQL-based event store for production.          Features:     - Connection, Save denormalized read model. Encrypts data (Phase 3: E2EE)., Get denormalized read model. Decrypts data (Phase 3: E2EE). (+25 more)
...
Cohesion: 0.09
Nodes (22): AEROSPACE_CONFIG, Aerospace vertical configuration for VS., LEGAL_CONFIG, Legal vertical configuration for VS., RADIOLOGY_CONFIG, Radiology vertical configuration for VS., Verbalized Sampling configuration models and vertical registry., VSVerticalConfig (+14 more)
...
Cohesion: 0.05
Nodes (52): BaseLLMProvider, complete(), LLMError, Raised when an LLM call fails after all retries., stream_complete(), BaseLLMProvider, ProviderUnavailableError, Provider service is unavailable.          This error IS retryable - may be a t (+44 more)

### Community 226 - "Community 226"
Cohesion: 0.07
Nodes (38): EncryptionService, make_event(), Retry attempt for failed operation., Retry attempt for failed operation., Retry attempt for failed operation., Retry attempt for failed operation., Factory function to create domain events.          Automatically sets:     - eve, Factory function to create domain events.          Automatically sets:     - eve (+30 more)

### Community 227 - "Community 227"
Cohesion: 0.04
Nodes (89): Per-session semantic vector store for uploaded documents.  Chunks uploaded file, delete_file(), _extract_docx(), _extract_image(), _extract_md(), _extract_pdf(), extract_text(), _extract_txt() (+81 more)
...
Cohesion: 0.07
Nodes (47): main(), Neuro CLI Manage the internal memory engine., Neuro Memory Engine CLI., Return value if numeric and not NaN, else '?'., Check health and statistics., Start the memory engine server., _safe_num(), start() (+39 more)
...
Cohesion: 0.09
Nodes (32): estimate_cost(), calculate_model_cost(), format_cost(), get_pricing(), _load_openrouter_pricing(), ModelPricing, print_cost_summary(), LLM Pricing Database Tracks per-token pricing for all supported models.  Pricing (+24 more)

### Community 250 - "Community 250"
Cohesion: 0.07
Nodes (26): CircuitBreaker, CircuitBreakerConfig, CircuitBreakerStats, CircuitState, get_all_circuit_breakers(), get_circuit_breaker(), Atomically check availability and acquire call slot if in HALF_OPEN.         Mu, Release call slot (decrement half_open_current_calls).         Must be called w (+18 more)

### Community 252 - "Community 252"
Cohesion: 0.11
Nodes (30): _compute_image_hash(), describe_image(), _detect_mime_type(), _encode_image_base64(), ocr_image(), Image and document extraction utilities using vision-capable LLMs., Extract verbatim text from an image using an OCR-optimized model via OpenRouter., Extract verbatim text from an image using an OCR-optimized model via OpenRouter. (+22 more)
...
Cohesion: 0.10
Nodes (19): ClientBucket, get_rate_limiter(), RateLimiter, Production-Ready Rate Limiter Token bucket algorithm with Redis-like sliding win, Reset sliding windows if expired., Check if request is allowed for client.                  Returns:             (a, Record a successful request (alternative to is_allowed)., Get rate limit stats for client. (+11 more)
...
Cohesion: 0.17
Nodes (15): ErrorOccurred, from_dict(), make_event(), MemoryRecalled, MemoryStored, Reasoner - Domain Events for Event Sourcing  All events are immutable (frozen da, New source added to context., Memory stored in Neuro system. (+7 more)
...
Cohesion: 0.09
Nodes (31): get_widget_registry(), reset_widget_registry(), api_models(), detect_widgets(), list_widgets(), Widget, suggestions, and UI status endpoints., List all available widgets., Detect widgets for a query. (+23 more)

### Community 268 - "Community 268"
Cohesion: 0.09
Nodes (17): CQRS, Concrete implementation of workflow services., HyperGate Pre-Routing, Neuro Long-Term Memory, Routing Table Patch, Provider Router with Fallbacks, ReasonerPipeline, CLI Cleanup Test (+9 more)
...
Cohesion: 0.10
Nodes (55): Reasoner - Event-Sourced Aggregates  Aggregates are the core transactional bou, asdict(), Simple asdict replacement for dataclasses., CandidateScored, ContextFetched, ContextVetted, PerspectiveGenerated, PhaseStarted (+47 more)
...
Cohesion: 0.05
Nodes (49): CompressionLevel, ContextCompressor, from_extension(), Language, Neuro Compression Module Optimizes text context for LLM efficiency. Uses "Neur, Convenience helper for quick compression., smart_compress(), Enum (+41 more)
...
Cohesion: 0.06
Nodes (94): measure_pipeline(), _MockLLM, _MockNLI, bool, float, str, ProviderError, Base exception for LLM provider errors. (+86 more)
...
Cohesion: 0.05
Nodes (44): BM25 Re-ranking, Circuit Breaker Pattern, Reasoner - Web Discovery Tool Provides internal web search capabilities for con, TestSearchFallbackBug, _bm25_score, _decompose_query, _normalize_url, _parse_freshness (+36 more)
...
Cohesion: 0.14
Nodes (14): ASGI App Entry Point, Circuit Breaker, Dual-Stream Frontend, Event Sourcing, Hexagonal Architecture, CLI Entry Point, Mixin Pattern, Token Bucket Rate Limiter (+6 more)
...
Cohesion: 0.06
Nodes (73): measure_pipeline(), _MockLLM, _MockNLI, Latency benchmark: VS vs baseline per deployment profile., ProviderError, Base exception for LLM provider errors., VS Claim Extraction stage — ClaimExtractionStage., VS Conflict Surfacing stage — ConflictSurfacingStage. (+65 more)
...
Cohesion: 0.12
Nodes (24): CriticDimensionScore, CriticDimensionScore, Score for one candidate across one critic's 4 dimensions., Score for one candidate across one critic's 4 dimensions., Score for one candidate across one critic's 4 dimensions., Score for one candidate across one critic's 4 dimensions., Score for one candidate across one critic's 4 dimensions., check_convergence() (+16 more)

### Community 728 - "Community 728"
Cohesion: 0.22
Nodes (8): metrics_endpoint(), Prometheus metrics endpoints (FastAPI layer).  Metric definitions are in reaso, Expose Prometheus metrics.      Critical Enhancement 7.2: generate_latest is s, generate_latest(), metrics_endpoint(), Prometheus metrics for Reasoner.  Critical Enhancements: - 7.2: metrics_endpoint, Expose Prometheus metrics.      Critical Enhancement 7.2: generate_latest is syn, Response
...
Cohesion: 0.05
Nodes (46): AuthenticationError, ConfigurationError, is_retryable(), JSONExtractionError, JSONValidationError, ModelNotFoundError, ParseError, PhaseError (+38 more)
...
Cohesion: 0.16
Nodes (12): close_redis(), get_redis(), Shared Redis connection pool for all Redis-backed features., Get or create shared Redis client., Override Redis client (useful for tests)., Close the shared Redis connection pool., set_redis(), Redis (+4 more)
...
Cohesion: 0.17
Nodes (20): get_architecture_components(), Lazy initialization of new architecture components., Lazy initialization of new architecture components., _check_pipeline_ownership(), delete_pipeline(), get_event_stats(), get_pipeline_status(), list_pipelines() (+12 more)
...
Cohesion: 0.27
Nodes (8): VS Behavioral Audit Observability stage., get_mean(), InMemoryVSEntropyStore, log_vs_behavioral_audit(), push(), VS Behavioral Audit Observability stage., size(), VSEntropyStore
...
Cohesion: 0.14
Nodes (15): _extract_json(), GateAgent, Return a GateDecision. Any failure falls back to pipeline., Extract the first JSON object from raw text., ProviderRouter, str, Any, bytes (+7 more)
...
Cohesion: 0.08
Nodes (29): _bm25_score(), _normalize_url(), _parse_freshness(), Normalize URL for deduplication.      Handles protocol, www, trailing slashes (, Normalize URL for deduplication.      Handles protocol, www, trailing slashes (, Simplified BM25-style relevance score between a query and a search result., Simplified BM25-style relevance score between a query and a search result., Derive a freshness score in [0, 1] from SearXNG's publishedDate field.      Re (+21 more)
...
Cohesion: 0.03
Nodes (118): _cache_key(), _load_cache(), _prune_memory_cache(), Simple FIFO eviction for the in-memory cache (thread-safe)., _save_cache(), HistoryEntry, _list_history(), List history entries, sorted by timestamp descending.      If user_id is provi (+110 more)

### Community 822 - "Community 822"
Cohesion: 0.17
Nodes (10): PhaseSubAgentInput, Data models for PhaseSubAgent communication protocol.  Phase-level subagents rec, Sent by a PhaseHyperAgent to each sub-agent., Any, str, PhaseSubAgentInput, PhaseSubAgentOutput, Data models for PhaseSubAgent communication protocol.  Phase-level subagents rec (+2 more)
...
Cohesion: 0.16
Nodes (21): Cross-encoder reranking service for search and memory retrieval.  Supports Coh, Rerank memory chunks (ContextChunk objects) before compression.      Args:, Score a single document against a query using Nemotron Rerank VL via logprobs., Rerank documents using NVIDIA Nemotron Rerank VL (free, via OpenRouter)., Rerank memory chunks (ContextChunk objects) before compression.      Args:, Strip null bytes, normalize Unicode, truncate., Strip null bytes, normalize Unicode, truncate., Rerank documents via cross-encoder (Cohere via OpenRouter by default).      Args (+13 more)
...
Cohesion: 0.51
Nodes (9): Parse JSON from an LLM response, degrading gracefully on failure.      Budget, run_coding_assemble_phase(), run_coding_generate_phase(), run_coding_review_phase(), run_coding_spec_phase(), run_coding_tests_phase(), _safe_extract_json(), PipelineState (+1 more)
...
Cohesion: 0.03
Nodes (114): Exception, AuthenticationError, classify_error(), ConfigurationError, InfrastructureError, is_retryable(), JSONExtractionError, JSONValidationError (+106 more)
...
Cohesion: 0.19
Nodes (11): ClientBucket, get_rate_limiter(), RateLimiter, Get or create global rate limiter., Token bucket for a client., Production rate limiter with multiple algorithms.          Features:     - To, Any, bool (+3 more)
...
Cohesion: 0.06
Nodes (51): SuggestionRequestModel, detect_topic(), extract_topic(), generate_suggestions(), generate_suggestions_async(), Smart Suggestions Engine Generates intelligent search suggestions based on parti, Async wrapper for generate_suggestions., Request for generating suggestions. (+43 more)
...
Cohesion: 0.15
Nodes (23): get_token_budget(), Get token budget for a specific role/phase., Get token budget for a specific role/phase., Get token budget for a specific role/phase., get_preset_price_tier(), Infer pricing tier from preset ID suffix., Infer pricing tier from preset ID suffix., enrich_problem_with_youtube() (+15 more)
...
Cohesion: 0.12
Nodes (36): perspective_prompt(), build_followup_context(), build_synthesis_context(), _followup_context(), is_article_request(), is_referential_followup(), Build a compact follow-up context block for injection into prompts.      Resul, Wrap user-controlled text in explicit delimiters. (+28 more)
...
Cohesion: 0.10
Nodes (32): CodeSafetyError, Raised when code is blocked by the safety guard., NoopExecutor, NoopExecutor — graceful degradation when sandbox is unavailable.  Returns execut, Fallback executor that returns a disabled result.      Used when the platform sa, SubprocessExecutor — sandboxed subprocess execution for PoT verification.  Runs, Execute Python code in an isolated subprocess.      Thread-safety: uses tempfile, SubprocessExecutor (+24 more)
...
Cohesion: 0.40
Nodes (5): 2. Internal Architecture, Engine Architecture, Engine Categories, Request Flow, Result Deduplication
...
Cohesion: 0.14
Nodes (4): Detect if widget should activate based on patterns., Extract parameters from query using regex patterns., Extract parameters from regex match.                  Override in subclasses for, WidgetRegistry
...
Cohesion: 0.08
Nodes (52): _collect_image_candidates(), _contains_policy_risk_terms(), _download_image_url(), _enhance_image_prompt(), _error_matches_any(), _extract_base64_from_text(), _extract_remote_urls_from_text(), _extract_text_from_content_parts() (+44 more)
...
Cohesion: 0.67
Nodes (3): Fixes Applied, P1 Fixes (All Completed), P2 Fixes (All Completed)
...
Cohesion: 0.05
Nodes (108): get_event_bus(), get_event_store(), get_pipeline_service(), get_preset_service(), get_search_service(), Factory that returns a FastAPI dependency enforcing minimum subscription tier., Dependency provider for PresetService., Dependency provider for PipelineService. (+100 more)
...
Cohesion: 0.07
Nodes (24): Any, bool, float, Match, Detect if this widget should activate for the given query.                  Args, Execute the widget with given parameters.                  Args:             par, Extract parameters from the query.                  Args:             query: Use, Detect if widget should activate based on patterns. (+16 more)
...
Cohesion: 0.18
Nodes (10): 1. What SearXNG Is, 7. Failure Modes & Mitigations, 9. Appendix: All Touchpoints, Core Principles, Data Flow, Environment Variables, File-by-File Reference, How It Differs from a Search Engine (+2 more)
...
Cohesion: 0.13
Nodes (15): 6. Reasoner Integration Map, Architecture Overview, `ArticlePipelineMixin._phase_article_retrieve()` (`article_pipeline.py`), Layer 2: Pipeline Mixins, Layer 3: API Routes, Layer 4: Widgets, Layer 5: Sub-agents, `ResearchMixin._phase_research_web_search()` (`research_mixin.py`) (+7 more)
...
Cohesion: 0.22
Nodes (8): ARA Pipeline v2.0 — Complete Project Handover Audit, Executive Summary, Failure Mode Catalog, P1 Failure Modes (No Mitigation Strategy), P1 Technical Debt Details, PHASE 4 — TECHNICAL DEBT ANALYSIS, PHASE 5 — FAILURE MODE ANALYSIS, Technical Debt Register
...
Cohesion: 0.67
Nodes (3): main(), Run 3 additional method API tests sequentially., run_one()
...
## Knowledge Gaps
- **21355 isolated node(s):** `nodes`, `edges`, `protocol_version`, `timestamp`, `mode` (+21350 more)
...
- **Why does `PipelineState` connect `Event Store Snapshot Tests` to `Community 2691`, `Community 261`, `Redis & Caching`, `Phase Quality & Prompts`, `Community 277`, `Chat UI Components`, `Community 279`, `Community 278`, `Snapshot Tests`, `Synthesis Serialization`, `IP Anonymization & GDPR`, `Community 290`, `Event Store Save Tests`, `Community 807`, `Community 2727`, `Community 41`, `Community 43`, `Community 2732`, `Community 2733`, `Community 821`, `Community 2742`, `Community 826`, `Community 2746`, `Community 2877`, `Community 834`, `Community 2755`, `Community 837`, `Community 838`, `Community 841`, `Community 842`, `Community 843`, `Community 80`, `Community 210`, `Community 727`, `Community 2779`, `Community 737`, `Community 745`, `Community 112`, `Community 757`, `Community 763`, `Community 253`, `Community 2815`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `PipelineEventType` connect `Synthesis Serialization` to `Community 289`, `Community 226`, `Community 97`, `Community 100`, `Next.js API Routes`, `Community 262`, `Redis & Caching`, `Community 106`, `Community 274`, `Snapshot Tests`, `Event Store Snapshot Tests`?**
