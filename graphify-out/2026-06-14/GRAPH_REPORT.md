# Graph Report - Reasoner  (2026-06-14)

## Corpus Check
- 2601 files · ~1,060,318 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 36428 nodes · 51908 edges · 3031 communities (2558 shown, 473 thin omitted)
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 11168 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5fa0dfe0`
...
## Communities (3031 total, 473 thin omitted)

### Community 0 - "Article Pipeline"
Cohesion: 0.02
Nodes (85): AmbiguityDetectorSubAgent, AmbiguityDetectorSubAgent — ONE JOB: identify what is unclear or vague in the pr, _build_prompt(), _parse_result(), PhaseSubAgent, PhaseSubAgent — abstract base class for intra-phase focused reasoning agents.  E, Accumulate token usage and cost into PipelineState., One focused reasoning task within a pipeline phase. (+77 more)

### Community 1 - "Authentication & Security"
Cohesion: 0.04
Nodes (68): FastAPI router for all billing endpoints., PayPal implementation of BillingPort for one-time and subscription payments., BillingPort, Billing Port — Abstract interface for payment providers.  Stripe is the default, Port for subscription billing operations., Return a checkout URL for the user to complete payment., Return a billing portal URL for self-service management., Idempotently sync a subscription from a provider webhook event.          Args: (+60 more)

### Community 2 - "Event Sourcing & Domain Events"
Cohesion: 0.08
Nodes (74): Stop the background queue consumer., Background worker that consumes the event queue., Publish an event to all subscribers.          Handlers are called concurrently w, Execute handler with error isolation and retry., Clear all subscriptions., Get number of subscribers for an event type., Get total number of subscribers., Get or create the global event bus instance. (+66 more)

### Community 3 - "Verbalized Sampling & Benchmarks"
Cohesion: 0.05
Nodes (85): measure_pipeline(), _MockLLM, _MockNLI, Latency benchmark: VS vs baseline per deployment profile., ProviderError, Base exception for LLM provider errors., VS Behavioral Audit Observability stage., VS Calibration stage — OutputCalibrationStage. (+77 more)
...
Cohesion: 0.06
Nodes (34): BM25 Re-ranking, Circuit Breaker Pattern, Reasoner - Web Discovery Tool Provides internal web search capabilities for con, TestSearchFallbackBug, TestSearchFallbackBug, _bm25_score, _decompose_query, _normalize_url (+26 more)
...
Cohesion: 0.08
Nodes (46): Reasoner - File Upload Module Handles file uploads and text extraction from PDF,, delete_file(), _extract_docx(), _extract_image(), _extract_md(), _extract_pdf(), extract_text(), _extract_txt() (+38 more)
...
Cohesion: 0.07
Nodes (27): _extract_json(), GateAgent, Gate Agent — Lightweight pre-flight router that decides whether a user prompt sh, Extract the first JSON object from raw text., build_router(), cmd_list_models(), main(), parse_args() (+19 more)

### Community 12 - "Subagent Framework"
Cohesion: 0.04
Nodes (54): BaseSubAgent, _extract_json(), _parse_result(), BaseSubAgent — abstract base class every HyperGate sub-agent must extend.  Each, Extract the first valid JSON object from raw LLM text., One job. One cache. One execute() call., Return the focused system prompt for this sub-agent's single task., Parse the LLM's raw text into a structured dict.         Must always return a di (+46 more)
...
Cohesion: 0.10
Nodes (48): cove_answer_prompt(), cove_draft_prompt(), cove_revise_prompt(), cove_verify_prompt(), PipelineState, build_followup_context(), _followup_context(), get_language_instruction() (+40 more)
...
Cohesion: 0.05
Nodes (89): get_phase_retry_budget(), get_phase_timeout(), get_quality_judge_model(), get_quality_judge_threshold(), Single source of truth for all hardcoded constants used across the Reasoner proj, Return the maximum number of retries allowed for a given phase., Return the LLM model to use for quality judging based on preset tier., Return the minimum score required to pass quality evaluation. (+81 more)

### Community 17 - "LLM Exceptions & Errors"
Cohesion: 0.03
Nodes (110): AuthenticationError, classify_error(), ConfigurationError, InfrastructureError, is_retryable(), JSONExtractionError, JSONValidationError, LLMError (+102 more)
...
Cohesion: 0.07
Nodes (57): _collect_image_candidates(), _contains_policy_risk_terms(), _download_image_url(), _enhance_image_prompt(), _error_matches_any(), _extract_base64_from_text(), _extract_remote_urls_from_text(), _extract_text_from_content_parts() (+49 more)
...
Cohesion: 0.04
Nodes (77): ClaimLabel, Reasoner Pipeline - Output Renderer Rich terminal display and JSON export, with, Dispatch to the appropriate method-specific renderer., render_pipeline_result(), Dispatch to the appropriate method-specific renderer., render_pipeline_result(), _render_pre_mortem(), Renderer strategy registry for Reasoner pipeline methods. (+69 more)

### Community 23 - "JSON Parsing Utilities"
Cohesion: 0.10
Nodes (96): LLMExecutor, Stateless (per-call) infrastructure adapter that wraps ProviderRouter with     t, DecompositionHyperAgent, EnhancementHyperAgent, Orchestrates parallel synthesis subagents and produces FinalSolution., SynthesisHyperAgent, JSONDepthExceededError, Raised when JSON nesting exceeds the configured maximum depth. (+88 more)
...
Cohesion: 0.03
Nodes (133): ArticleFlow, Article reasoning workflow strategy., Article workflow:     1. Retrieve Sources     2. Draft     3. Adversarial Ver, PhaseStep, Base interfaces for workflow strategies., A single step in a reasoning flow., Port defining core services provided by the orchestrator to workflows., Protocol for reasoning workflow strategies. (+125 more)
...
Cohesion: 0.07
Nodes (135): ParseError, Raised when LLM response cannot be parsed into expected structure., PhaseResult, How temperature should adapt on retry., Immutable record of one phase's execution.     Accumulated in PipelineState.pha, TemperatureStrategy, CriticDimensionScore, CriticScore (+127 more)

### Community 28 - "IP Anonymization & GDPR"
Cohesion: 0.03
Nodes (76): clear_memory_cache(), Clear the in-memory cache (thread-safe)., clear_cache(), _extract_user_id(), generic_exception_handler(), _get_error_store(), http_exception_handler(), _log_error() (+68 more)

### Community 29 - "Quality Gates"
Cohesion: 0.05
Nodes (37): BaseLLMProvider, complete(), LLMError, Raised when an LLM call fails after all retries., stream_complete(), BaseLLMProvider, External context integration endpoint., Run the Reasoner pipeline with external context.      This endpoint accepts coll (+29 more)

### Community 30 - "Event Store Snapshot Tests"
Cohesion: 0.04
Nodes (47): PipelineState, Get condensed decomposition summary for token efficiency., Get condensed candidates summary for token efficiency., Serialize complete state to dictionary (for persistence)., Save state to JSON file.                  Args:             path: File path t, Load state from JSON file.                  Args:             path: File path, Complete pipeline state — passed between phases., Complete pipeline state — passed between phases. (+39 more)

### Community 31 - "Frontend Phase Tests"
Cohesion: 0.04
Nodes (53): ActiveFrictionGate, BehavioralAuditReport, BehavioralAuditStage, CoverageAuditStage, CoverageReport, EmbeddingModel, ExtractedClaim, FrictionDecision (+45 more)

### Community 32 - "Event Store Count Tests"
Cohesion: 0.07
Nodes (111): FastAPI middleware classes for security, memory limits, and request timeouts., Scope, TaggedMemory — lightweight categorized conversation history store.  Organizes hi, Global Exception Handlers for FastAPI  Captures all unhandled exceptions, HTTP e, Build a safe JSON error response that doesn't leak internals., Handle HTTPException (4xx, 5xx from FastAPI/Starlette)., Handle RequestValidationError (malformed JSON, missing fields)., Catch-all handler for unhandled exceptions (500s). (+103 more)

### Community 33 - "Event Store List Tests"
Cohesion: 0.04
Nodes (86): create_checkout(), create_portal(), _get_paypal_service(), _get_stripe_service(), get_subscription(), paypal_webhook(), Public endpoint for Stripe webhooks., Public endpoint for PayPal webhooks. (+78 more)
...
Cohesion: 0.03
Nodes (134): Reset all usage_quotas at month start. Called by external scheduler., reset_all_quotas_monthly(), check_preset_access(), check_quota(), check_quota_if_authenticated(), check_rate_limit(), _ensure_user_in_db(), get_current_user() (+126 more)
...
Cohesion: 0.05
Nodes (53): AttachmentRef, CalculationRequest, ContextAnalysisRequest, DiscoverRequest, GenerateImageRequest, Pydantic request/response schemas for the Reasoner API., Request model for image generation., Request model for image generation. (+45 more)
...
Cohesion: 0.05
Nodes (50): BaseException, GateDecision, HyperContext, BaseSubAgent, Extract the first valid JSON object from raw LLM text., One job. One cache. One execute() call., Return the focused system prompt for this sub-agent's single task., Parse the LLM's raw text into a structured dict.         Must always return a d (+42 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (84): HistoryEntry, _list_history(), List history entries, sorted by timestamp descending.      If user_id is provi, Save a history entry to disk., _save_history_entry(), get_critical_phases(), get_phase_start_models(), Phase execution helpers extracted from streaming.py.  Contains:   - _PHASE_ROLE_ (+76 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (109): extract_json(), _parse_critique_scores(), Safely build CritiqueScore objects from raw LLM output.      CritiqueScore has, Extract JSON object (dict) from LLM response.     Raises ParseError if no objec, Article writing pipeline phase logic., run_article_adversarial_verify_phase(), run_article_draft_phase(), run_article_refine_phase() (+101 more)
...
Cohesion: 0.03
Nodes (77): ChatFeedMessage, ChatFeedProps, ContinueButton(), MessageActions(), RenderedPhase, ChatMessage, ChatMessageProps, MemoryBadge() (+69 more)
...
Cohesion: 0.09
Nodes (57): Reasoner - Event-Sourced Aggregates  Aggregates are the core transactional bou, asdict(), Simple asdict replacement for dataclasses., CandidateScored, ContextFetched, ContextVetted, PerspectiveGenerated, PhaseStarted (+49 more)
...
Cohesion: 0.06
Nodes (39): methods(), Registry that maps method names to rendering strategies., Register a renderer for a method., Render pipeline state using the strategy for the given method., Return all registered method names., RendererService, RenderStrategy, Serialize state for passing to next LLM call.                  Args: (+31 more)
...
Cohesion: 0.09
Nodes (92): Aggregate, PipelineStateData, Get current state as dictionary., Data class representing pipeline state., Data class representing widget state., Base class for all aggregates.          Provides:     - Event sourcing (apply, Event-sourced aggregate for widget execution.          Tracks widget lifecycle, Apply event-specific state changes. (+84 more)
...
Cohesion: 0.07
Nodes (47): APIRouter, Lock, get_agent_data_dir(), get_persona(), NeuroConfig, PersonaConfig, AuditRequest, AuditResponse (+39 more)
...
Cohesion: 0.08
Nodes (48): _extract_balanced_structure(), extract_json_any(), _extract_json_array_value(), _extract_json_dict_fallback(), extract_json_list(), _extract_json_string_value(), extract_solution_prose(), _is_structural_quote() (+40 more)
...
Cohesion: 0.07
Nodes (32): APIKey, AuthManager, AuthorizationError, get_auth_manager(), Simple Token-Based Authentication Middleware Production-ready auth with API key, Hash API key using SHA-256., Set a key with LRU eviction., Generate a new API key.          Args:             name: Human-readable name for (+24 more)

### Community 93 - "Community 93"
Cohesion: 0.07
Nodes (28): _run_store, StopPipelineCommand, ExecuteWidgetCommandHandler, get_handler_registry(), GetHistoryQueryHandler, GetPipelineStatusQueryHandler, HandlerRegistry, ListPresetsQueryHandler (+20 more)

### Community 94 - "Community 94"
Cohesion: 0.04
Nodes (84): Run a phase coroutine, yielding SSE keepalive comments.          Yields ": keepa, run_phase_with_keepalive(), Execute the reasoning pipeline., Decorator that records phase duration in ``state.phase_durations``., Refactored Reasoner Orchestrator.     Now uses WorkflowStrategy composition ins, ReasonerPipeline, timed(), make_phase_result() (+76 more)
...
Cohesion: 0.04
Nodes (58): ErrorOccurred, Error occurred during execution., Error occurred during execution., _fire_and_forget(), get_postgres_store(), initialize_postgres_store(), PostgreSQLEventStore, PostgreSQL Event Store  Production-grade event persistence using PostgreSQL. Sup (+50 more)

### Community 99 - "Community 99"
Cohesion: 0.05
Nodes (42): Persistent API key storage using SQLite (aiosqlite).  Provides durable storage f, datetime, Permission scopes for API access control., Scope, AuthStore, Persistent API key storage using SQLite (aiosqlite).  Provides durable storage f, Retrieve a key by its hash. Returns None if not found., Increment usage_count and set last_used_at to now. (+34 more)

### Community 100 - "Community 100"
Cohesion: 0.03
Nodes (61): EventBus, get_event_bus(), handle_all_events(), handle_event(), init_default_subscribers(), log_all_events(), persist_all_events(), Start the background queue consumer. (+53 more)
...
Cohesion: 0.03
Nodes (122): Authentication and rate-limiting FastAPI dependencies., FastAPI Dependency Injectors for SaaS Auth.  These functions are used as FastA, Reset quota service singleton (useful for tests)., Reset rate limiter singleton (useful for tests)., _reset_quota_service(), _reset_rate_limiter_instance(), SaaS Router — All new SaaS-related API endpoints.  This router is mounted in api, AuthenticationError (+114 more)

### Community 106 - "Community 106"
Cohesion: 0.05
Nodes (44): EventStoreCorruptionError, Raised when event store data is inconsistent (e.g. version gaps after compaction, __getattr__(), __getattr__(), Infrastructure Persistence Package  Event storage and retrieval for event-source, Lazy-load PostgreSQL symbols so asyncpg is not required at import time., Serialize aggregate state for storage., Load snapshot from storage. (+36 more)

### Community 107 - "Community 107"
Cohesion: 0.06
Nodes (36): EventStore, get_event_store(), Save events to the event store.          Events are persisted atomically withi, Determine aggregate type from event type., Update aggregate state snapshot., SQLite-based event store for persistence.          Features:     - Append-onl, Get events for an aggregate.          Optionally filter by minimum version for, Deserialize database row to domain event. (+28 more)

### Community 108 - "Community 108"
Cohesion: 0.05
Nodes (53): _get_pipeline_owner(), Pipeline ownership tracking — shared between API and websocket layers.  Extrac, Return the user_id that owns *pipeline_id*, or None if not tracked., Persist ownership mapping for a pipeline run., _save_pipeline_owner(), _get_pipeline_owner(), Pipeline ownership tracking — shared between API and websocket layers.  Extrac, Return the user_id that owns *pipeline_id*, or None if not tracked. (+45 more)

### Community 109 - "Community 109"
Cohesion: 0.03
Nodes (78): check_rate_limit(), _get_auth_manager_instance_auth_deps(), get_client_id(), optional_auth(), Require valid API key authentication.     Raises HTTPException if authentication, Require valid API key authentication.     Raises HTTPException if authentication, Optional authentication - returns API key if provided, None otherwise., Optional authentication - returns API key if provided, None otherwise. (+70 more)
...
Cohesion: 0.14
Nodes (14): delete_history_entry(), get_history(), get_history_entry(), get_tagged_history(), Search history endpoints., Get search history for the authenticated user., Get history entries by tag for the authenticated user., Get a specific history entry (must belong to the authenticated user). (+6 more)
...
Cohesion: 0.04
Nodes (52): Backward-compat shim — Neuro client moved to reasoner.clients., Backward-compat shim — serializers moved to application/services/serializers.py., get_neuro_client(), Shared HTTP clients with connection pooling.  Reduces TCP handshake overhead for, Get or create a shared AsyncClient for Neuro endpoints., _list_history(), Persist ownership mapping for a pipeline run., List history entries, sorted by timestamp descending.      If user_id is provide (+44 more)
...
Cohesion: 0.07
Nodes (26): error_result(), _execute_impl(), Execute with error handling., success_result(), Any, float, Match, Widget Protocol (Hexagonal Architecture Port)  Defines the interface that all wi (+18 more)
...
Cohesion: 0.07
Nodes (36): Error Persistence Layer  Stores application errors in SQLite for durability and, ErrorEntry, ErrorStats, ErrorStore, Error Persistence Layer  Stores application errors in SQLite for durability an, Run sync function in thread pool with locking., Initialize database schema., Remove errors older than retention period. (+28 more)

### Community 180 - "Community 180"
Cohesion: 0.07
Nodes (62): _extract_balanced_structure(), extract_json_any(), _extract_json_array_value(), _extract_json_dict_fallback(), extract_json_list(), _extract_json_string_value(), extract_solution_prose(), _is_structural_quote() (+54 more)
...
Cohesion: 0.03
Nodes (79): PhaseConfig, LLM call parameters for a single phase.     Frozen so preset overrides produce, build_auto_preset(), get_method_from_preset(), get_preset_tier(), PipelinePreset, Core preset domain logic: dataclass, validation, and helpers., Extract method name from preset string. (+71 more)
...
Cohesion: 0.08
Nodes (49): _collect_image_candidates(), _contains_policy_risk_terms(), _download_image_url(), _enhance_image_prompt(), _error_matches_any(), _extract_base64_from_text(), _extract_text_from_content_parts(), _generate_image_guarded() (+41 more)
...
Cohesion: 0.09
Nodes (16): AuditService, Audit Service — Logs query executions as domain events.  Publishes to the Even, EventBus, get_event_bus(), handle_all_events(), handle_event(), init_default_subscribers(), log_all_events() (+8 more)
...
Cohesion: 0.07
Nodes (36): Deserialize from dictionary., EncryptionService, make_event(), Retry attempt for failed operation., Retry attempt for failed operation., Factory function to create domain events.          Automatically sets:     - eve, RetryAttempted, PostgreSQLEventStore (+28 more)

### Community 227 - "Community 227"
Cohesion: 0.11
Nodes (35): build_followup_context(), build_synthesis_context(), _followup_context(), is_article_request(), is_referential_followup(), Build a compact follow-up context block for injection into prompts.      Resul, Wrap user-controlled text in explicit delimiters., Detect if the user is asking for a structured written piece. (+27 more)

### Community 228 - "Community 228"
Cohesion: 0.06
Nodes (105): BaseModel, measure_pipeline(), _MockLLM, _MockNLI, bool, float, str, ProviderError (+97 more)
...
Cohesion: 0.06
Nodes (35): 0de94406-8233-4e62-a786-9d349c3ec2dd, 10e1a925-9d05-4e60-862b-aab21cbd2456, 17600e48-e303-46fc-a7f2-d044ffd91f8c, 1b020eb7-4eda-42f5-9908-18d5fc520965, 225c9182-38f2-46b5-bdbd-be7413f60905, 2369eb54-5ba4-423c-8b54-934a79e4c970, 27f952b2-88e0-4320-92d1-85ff69826cc8, 33e7fce5-28ca-4ace-a0e7-f0999acd7930 (+27 more)

### Community 233 - "Community 233"
Cohesion: 0.03
Nodes (60): CircuitBreaker, CircuitBreakerConfig, CircuitBreakerStats, CircuitOpenError, CircuitState, get_all_circuit_breakers(), get_circuit_breaker(), Reasoner Pipeline - Circuit Breaker Pattern Provides fault tolerance for LLM pro (+52 more)
...
Cohesion: 0.07
Nodes (38): benchmark_vs_calibration(), main(), _pearson_r(), Calibration benchmark: verbalized entropy vs uncertainty correlation., Simulate entropy vs uncertainty measurements., benchmark_vs_calibration(), main(), _pearson_r() (+30 more)
...
Cohesion: 0.11
Nodes (9): PipelineAggregate, Event-sourced aggregate for pipeline execution.          Maintains the complet, Apply event-specific state changes., Get current pipeline state., Check if pipeline has completed., Check if pipeline has failed., Check if pipeline is still running., Check if pipeline can be resumed from current state. (+1 more)

### Community 250 - "Community 250"
Cohesion: 0.12
Nodes (30): AgentConfig, _apply_defaults(), _build_persona(), _build_provider(), _build_resilient(), get_agent_data_dir(), get_persona(), load_config() (+22 more)
...
Cohesion: 0.08
Nodes (37): _get_build_provider(), _decompose_query(), DiscoveryClient, _extract_search_keywords(), get_discovery_client(), get_search_client(), get_searxng_base_url(), PerplexitySearchClient (+29 more)
...
Cohesion: 0.06
Nodes (33): Insert a new API key. Metadata is encrypted (Phase 3: E2EE)., Encrypt data and return a URL-safe base64 encoded string., Lazy-load PostgreSQL symbols so asyncpg is not required at import time., Snapshot Strategy for Aggregate Performance  Periodic snapshots allow faster agg, PipelineStateData, Data class representing pipeline state., get_postgres_store(), initialize_postgres_store() (+25 more)
...
Cohesion: 0.12
Nodes (26): _cache_key(), get_cache_stats(), _load_cache(), _prune_disk_cache(), _prune_memory_cache(), Remove oldest cache files if the directory exceeds the max size., # NOTE: This is a per-process cache. For horizontal scaling, use Redis or, Return memory cache telemetry. (+18 more)
...
Cohesion: 0.06
Nodes (52): get_phase_retry_budget(), get_phase_timeout(), get_quality_judge_model(), get_quality_judge_threshold(), get_token_budget(), Single source of truth for all hardcoded constants used across the Reasoner proj, Get token budget for a specific role/phase., Get token budget for a specific role/phase. (+44 more)
...
Cohesion: 0.15
Nodes (10): Serialize state to dictionary., Serialize state to dictionary., Get events that haven't been persisted yet., Serialize event to dictionary for storage., Serialize event to dictionary for storage., Deserialize event from dictionary., Deserialize event from dictionary., asdict() (+2 more)

### Community 287 - "Community 287"
Cohesion: 0.12
Nodes (17): main(), Neuro CLI Manage the internal memory engine., Neuro Memory Engine CLI., Return value if numeric and not NaN, else '?'., Check health and statistics., Start the memory engine server., _safe_num(), start() (+9 more)

### Community 288 - "Community 288"
Cohesion: 0.10
Nodes (23): _chunk_text(), _cosine_similarity(), DocumentVectorStore, Per-session semantic vector store for uploaded documents.  Chunks uploaded file, Chunk and embed a document, writing embeddings to a JSON sidecar.          Args:, Retrieve the top-k most relevant chunks for a query.          Args:, Delete a document's vector sidecar., Split text into overlapping chunks.      Args:         text: Source text. (+15 more)
...
Cohesion: 0.06
Nodes (33): PreflightDecision, PipelineOrchestrator — single entry point for pipeline execution.  Used by: ap, Fetch relevant past context from Neuro memory., Fetch relevant past context from Neuro memory., Build a ReasonerPipeline from a PreflightDecision., Build a ReasonerPipeline from a PreflightDecision., Run the pipeline with the given decision. Returns final state., Neuro learn and history persistence after pipeline completes. (+25 more)
...
Cohesion: 0.14
Nodes (16): _get_rate_limiter_instance_auth_deps(), Factory for RateLimiter instance within auth_deps., Factory for RateLimiter instance within auth_deps., ClientBucket, get_rate_limiter(), RateLimiter, Production-Ready Rate Limiter Token bucket algorithm with Redis-like sliding wi, # NOTE: This is a per-process singleton. For horizontal scaling (+8 more)
...
Cohesion: 0.09
Nodes (32): get_architecture_components(), Lazy initialization of new architecture components., Lazy initialization of new architecture components., build_provider(), list_models(), Model registry and provider factory., Build a provider instance from a model ID string., Build a provider instance from a model ID string. (+24 more)
...
Cohesion: 0.11
Nodes (21): ErrorOccurred, from_dict(), make_event(), MemoryRecalled, MemoryStored, Reasoner - Domain Events for Event Sourcing  All events are immutable (frozen da, New source added to context., Memory stored in Neuro system. (+13 more)
...
Cohesion: 0.14
Nodes (16): _call_with_circuit(), Call LLM for role. On LLMError or timeout, tries a fallback provider:, Call LLM for role. On LLMError or timeout, tries a fallback provider:, Build router from model ID strings., Build router from model ID strings., Call a provider with circuit-breaker protection., Return the provider for a role, with per-instance caching., Build metadata dict for the LLM call. (+8 more)
...
Cohesion: 0.06
Nodes (48): BiasCritiqueSubAgent, CounterfactualSubAgent, EvidenceCritiqueSubAgent, CritiqueHyperAgent, Aggregate subagent findings into per-candidate CritiqueScore objects., Index a list of dicts by perspective name., Orchestrates parallel critique subagents and produces CritiqueScore list., LogicCritiqueSubAgent (+40 more)
...
Cohesion: 0.11
Nodes (21): _bm25_score(), _normalize_url(), _parse_freshness(), Normalize URL for deduplication.      Handles protocol, www, trailing slashes (, Normalize URL for deduplication.      Handles protocol, www, trailing slashes (, Simplified BM25-style relevance score between a query and a search result., Simplified BM25-style relevance score between a query and a search result., Derive a freshness score in [0, 1] from SearXNG's publishedDate field.      Re (+13 more)

### Community 790 - "Community 790"
Cohesion: 0.17
Nodes (30): _action_scrape(), _action_uploads_search(), _action_web_search(), _build_iteration_prompt(), _Citation, _cosine_similarity(), _map_step_type(), Iterative tool-calling researcher — Prism logic ported to Python. (+22 more)
...
Cohesion: 0.08
Nodes (31): Base exception for all Reasoner pipeline errors.          Attributes:, ReasonerError, Exception, BaseLLMProvider, LLMError, Raised when an LLM call fails after all retries., is_retryable(), Check if an error is retryable. (+23 more)
...
Cohesion: 0.10
Nodes (24): CompressionLevel, ContextCompressor, from_extension(), Language, Neuro Compression Module Optimizes text context for LLM efficiency. Uses "Neur, Convenience helper for quick compression., smart_compress(), Core abstractions for the Reasoner pipeline.  PhaseConfig  — per-phase LLM par (+16 more)

### Community 813 - "Community 813"
Cohesion: 0.17
Nodes (14): _check_depth(), Safe JSON loading with depth limits to prevent stack exhaustion., Recursively check nesting depth of parsed JSON object., Parse JSON with a strict depth limit.      Args:         data: JSON string or by, safe_json_loads(), Any, bytes, int (+6 more)
...
Cohesion: 0.24
Nodes (10): all_healthy(), _check_openrouter_key(), _check_perplexity_key(), HealthReport, Startup health validation — auto-disables features when dependencies are missing, Quick validation that the OpenRouter key is not empty and syntactically valid., Quick validation that the Perplexity key is not empty and syntactically valid., Run all health checks and return a report.      This function is idempotent — ca (+2 more)
...
Cohesion: 0.15
Nodes (15): FileSearchPort, Research phase logic., run_research_web_search_phase(), PrismFileSearch, Searches uploaded file chunks by semantic similarity., classify_query(), PrismClassification, Prism query classifier — ports Prism's classifier.ts to Python. (+7 more)
...
Cohesion: 0.24
Nodes (11): _check_openrouter_key(), _check_perplexity_key(), HealthReport, Startup health validation — auto-disables features when dependencies are missing, Quick validation that the OpenRouter key is not empty and syntactically valid., Quick validation that the Perplexity key is not empty and syntactically valid., Run all health checks and return a report.      This function is idempotent — ca, validate_all() (+3 more)
...
Cohesion: 0.17
Nodes (11): FileChunk, FileChunk, Port for semantic search over uploaded file chunks., _cosine_similarity(), FileSearchPort implementation using Neuro embeddings and uploaded file sidecars., int, str, float (+3 more)
...
Cohesion: 0.09
Nodes (23): lifespan(), Background task to update active users gauge every 60s (Critical Enhancement 7.3, Background task to update active users gauge every 60s (Critical Enhancement 7.3, Application lifespan: startup and shutdown orchestration., Application lifespan: startup and shutdown orchestration., _update_active_users_loop(), Shared Redis connection pool for all Redis-backed features., Override Redis client (useful for tests). (+15 more)
...
Cohesion: 0.33
Nodes (8): pot_execute_prompt(), pot_generate_prompt(), pot_interpret_prompt(), pot_execute_prompt(), pot_generate_prompt(), pot_interpret_prompt(), PipelineState, str
...
Cohesion: 0.07
Nodes (34): AuthenticationError, ConfigurationError, is_retryable(), JSONExtractionError, JSONValidationError, ModelNotFoundError, ParseError, PhaseError (+26 more)
...
Cohesion: 0.08
Nodes (28): main(), Self-Healing Loop Orchestrator  This script connects the independent self-heal, Run a python script and return success., run_script(), _build_context(), export_healing_context(), Export recent telemetry to healing_context.json for static healing scripts.  Cal, Query TelemetryStore and aggregate by preset. (+20 more)

### Community 2719 - "Community 2719"
Cohesion: 0.24
Nodes (11): SearchServicePort, main(), MockSearchClient, Quick smoke test for Prism modules outside pytest., test_classify_query_defaults_on_empty_json(), test_classify_query_parsing(), test_classify_query_uses_problem_as_fallback(), test_prism_research_dedupes_by_url() (+3 more)
...
Cohesion: 0.11
Nodes (27): get_widget_registry(), api_models(), detect_widgets(), list_widgets(), Widget, suggestions, and UI status endpoints., List all available widgets., Detect widgets for a query., Check if UI integration is available. (+19 more)
...
Cohesion: 0.40
Nodes (3): Sentry initialization for FastAPI.  Critical Enhancement 7.5: traces_sample_rate, init_sentry(), Sentry initialization for FastAPI.  Critical Enhancement 7.5: traces_sample_rate
...
Cohesion: 0.67
Nodes (3): main(), Run 4 method API tests sequentially., run_one()
...
Cohesion: 0.38
Nodes (11): Parse JSON from an LLM response, degrading gracefully on failure.      Budget, run_coding_assemble_phase(), run_coding_generate_phase(), run_coding_review_phase(), run_coding_spec_phase(), run_coding_tests_phase(), _safe_extract_json(), Any (+3 more)
...
Cohesion: 0.24
Nodes (7): _extract_json(), GateAgent, Gate Agent — Lightweight pre-flight router that decides whether a user prompt s, Return a GateDecision. Any failure falls back to pipeline., Extract the first JSON object from raw text., ProviderRouter, str
...
Cohesion: 0.29
Nodes (6): _extract_json(), GateAgent, Return a GateDecision. Any failure falls back to pipeline., Extract the first JSON object from raw text., ProviderRouter, str
...
## Knowledge Gaps
- **21594 isolated node(s):** `nodes`, `edges`, `protocol_version`, `timestamp`, `mode` (+21589 more)
...
- **Why does `DocumentVectorStore` connect `Community 288` to `Community 201`, `Event Store Get Tests`, `Community 151`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `PipelineState` connect `Event Store Snapshot Tests` to `Community 2689`, `Community 2690`, `Community 2691`, `Community 2692`, `Community 262`, `Community 2695`, `Phase Quality & Prompts`, `Chat UI Components`, `Community 790`, `Community 279`, `Snapshot Tests`, `Community 278`, `Synthesis Serialization`, `Community 2716`, `Community 2717`, `Community 2719`, `Community 290`, `Community 291`, `Event Store Get Tests`, `Community 2727`, `Community 40`, `Community 41`, `Community 826`, `Community 829`, `Community 834`, `Community 837`, `Community 838`, `Community 199`, `Community 841`, `Community 842`, `Community 843`, `Community 844`, `Community 845`, `Community 206`, `Community 210`, `Community 2902`, `Community 727`, `Community 94`, `Community 227`, `Community 763`, `Community 253`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._