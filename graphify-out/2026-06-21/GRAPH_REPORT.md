# Graph Report - Reasoner  (2026-06-21)

## Corpus Check
- 2678 files · ~1,136,160 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 37688 nodes · 53555 edges · 3110 communities (2634 shown, 476 thin omitted)
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 11518 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `002072fc`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- [[_COMMUNITY_Article Pipeline|Article Pipeline]]
- [[_COMMUNITY_Authentication & Security|Authentication & Security]]
- [[_COMMUNITY_Event Sourcing & Domain Events|Event Sourcing & Domain Events]]
- [[_COMMUNITY_Verbalized Sampling & Benchmarks|Verbalized Sampling & Benchmarks]]
- [[_COMMUNITY_Neuro Memory & LTM|Neuro Memory & LTM]]
- [[_COMMUNITY_Widgets & Calculator|Widgets & Calculator]]
- [[_COMMUNITY_Next.js API Routes|Next.js API Routes]]
- [[_COMMUNITY_Article Detection & Styles|Article Detection & Styles]]
- [[_COMMUNITY_Redis & Caching|Redis & Caching]]
- [[_COMMUNITY_Image Generation & Encryption|Image Generation & Encryption]]
- [[_COMMUNITY_Alerting System|Alerting System]]
- [[_COMMUNITY_Application Entry Points|Application Entry Points]]
- [[_COMMUNITY_Subagent Framework|Subagent Framework]]
- [[_COMMUNITY_Pipeline Control & Cancellation|Pipeline Control & Cancellation]]
- [[_COMMUNITY_Reasoning Phase Prompts|Reasoning Phase Prompts]]
- [[_COMMUNITY_Circuit Breaker & Resilience|Circuit Breaker & Resilience]]
- [[_COMMUNITY_Phase Quality & Prompts|Phase Quality & Prompts]]
- [[_COMMUNITY_LLM Exceptions & Errors|LLM Exceptions & Errors]]
- [[_COMMUNITY_Database Migrations|Database Migrations]]
- [[_COMMUNITY_Stripe Billing & SaaS|Stripe Billing & SaaS]]
- [[_COMMUNITY_Image Generation API|Image Generation API]]
- [[_COMMUNITY_Frontend Pages|Frontend Pages]]
- [[_COMMUNITY_Chat UI Components|Chat UI Components]]
- [[_COMMUNITY_JSON Parsing Utilities|JSON Parsing Utilities]]
- [[_COMMUNITY_Event Store Tests|Event Store Tests]]
- [[_COMMUNITY_Snapshot Tests|Snapshot Tests]]
- [[_COMMUNITY_CQRS Query Handlers|CQRS Query Handlers]]
- [[_COMMUNITY_Synthesis Serialization|Synthesis Serialization]]
- [[_COMMUNITY_IP Anonymization & GDPR|IP Anonymization & GDPR]]
- [[_COMMUNITY_Quality Gates|Quality Gates]]
- [[_COMMUNITY_Event Store Snapshot Tests|Event Store Snapshot Tests]]
- [[_COMMUNITY_Frontend Phase Tests|Frontend Phase Tests]]
- [[_COMMUNITY_Event Store Count Tests|Event Store Count Tests]]
- [[_COMMUNITY_Event Store List Tests|Event Store List Tests]]
- [[_COMMUNITY_Pricing & Cost Estimation|Pricing & Cost Estimation]]
- [[_COMMUNITY_Event Store Get Tests|Event Store Get Tests]]
- [[_COMMUNITY_Event Store Stats Tests|Event Store Stats Tests]]
- [[_COMMUNITY_Event Store Save Tests|Event Store Save Tests]]
- [[_COMMUNITY_Chat Components & Hooks|Chat Components & Hooks]]
- [[_COMMUNITY_Model Loading Tests|Model Loading Tests]]
...
1. `PipelineState` - 538 edges
2. `PipelineState` - 170 edges
3. `EventType` - 165 edges
4. `DomainEvent` - 165 edges
5. `WorkflowServices` - 162 edges
6. `ProviderRouter` - 159 edges
7. `PipelineCompleted` - 143 edges
8. `PipelineFailed` - 120 edges
9. `ReasonerPipeline` - 117 edges
10. `DomainEvent` - 106 edges

## Surprising Connections (you probably didn't know these)
- `ASGI App Entry Point` --conceptually_related_to--> `Reasoner AI Reasoning Orchestrator`  [AMBIGUOUS]
  asgi.py → AGENTS.md
- `CLI Entry Point` --conceptually_related_to--> `Reasoner AI Reasoning Orchestrator`  [AMBIGUOUS]
  main.py → AGENTS.md
- `Start All Orchestrator` --conceptually_related_to--> `Reasoner AI Reasoning Orchestrator`  [AMBIGUOUS]
  start_all.py → AGENTS.md
- `main()` --conceptually_related_to--> `Self-Healing CI`  [INFERRED]
  autonomous_debug.py → AGENTS.md
- `main()` --conceptually_related_to--> `SearXNG Search`  [INFERRED]
  kill_servers.py → AGENTS.md

## Hyperedges (group relationships)
- **he_agents** — agents_hypergate, agents_dual_stream_frontend, agents_alembic, agents_supabase, agents_next_js, agents_pydantic, agents_postgresql, agents_tailwind_css_v4, agents_searxng, agents_redis, agents_event_sourcing, agents_mixin_pattern, agents_agents_md, agents_cqrs, agents_token_optimization [INFERRED 0.85]
- **he_architectural_audit_v5** — architectural_audit_v5_hypergate, architectural_audit_v5_strategy_a, architectural_audit_v5_alembic, architectural_audit_v5_supabase, architectural_audit_v5_high_findings, architectural_audit_v5_verbalized_sampling, architectural_audit_v5_postgresql, architectural_audit_v5_strategy_b, architectural_audit_v5_pipelinestate, architectural_audit_v5_redis, architectural_audit_v5_medium_findings, architectural_audit_v5_sqlalchemy, architectural_audit_v5_critical_findings, architectural_audit_v5_architectural_audit_v5_md, architectural_audit_v5_stripe [INFERRED 0.85]
- **he_audit_report** — audit_report_api_init_py, audit_report_supabase, audit_report_circuitbreaker, audit_report_postgresql, audit_report_searxng, audit_report_runstatemanager, audit_report_redis, audit_report_presets_py, audit_report_presetservice, audit_report_audit_report_md, audit_report_renderer_py, audit_report_ratelimiter, audit_report_neuro_ltm, audit_report_stripe, audit_report_eventbus [INFERRED 0.85]
- **he_codebase_mindmap** — codebase_mindmap_ui_next, codebase_mindmap_core, codebase_mindmap_hypergate, codebase_mindmap_api_py, codebase_mindmap_neuro, codebase_mindmap_codebase_mindmap_md, codebase_mindmap_presets_py, codebase_mindmap_models_py, codebase_mindmap_main_py, codebase_mindmap_application, codebase_mindmap_asgi_py, codebase_mindmap_infrastructure, codebase_mindmap_llm_py, codebase_mindmap_api, codebase_mindmap_phases_py [INFERRED 0.85]
- **he_color_palette** — color_palette_border, color_palette_surface, color_palette_dark_theme, color_palette_accent, color_palette_color_palette, color_palette_shadow, color_palette_red, color_palette_text_2, color_palette_method_accent_rgb, color_palette_bg, color_palette_light_theme, color_palette_surface_2, color_palette_green, color_palette_text [INFERRED 0.85]
- **he_deployment_strategy** — deployment_strategy_postgresql, deployment_strategy_phase_6_security, deployment_strategy_phase_2_auth, deployment_strategy_phase_1_foundation, deployment_strategy_alembic, deployment_strategy_phase_9_scale, deployment_strategy_supabase, deployment_strategy_stripe, deployment_strategy_searxng, deployment_strategy_phase_4_billing, deployment_strategy_redis, deployment_strategy_phase_7_monitoring, deployment_strategy_docker_compose, deployment_strategy_phase_5_stripe_webhooks, deployment_strategy_phase_8_frontend_polish [INFERRED 0.85]
- **he_design** — design_design_md, design_typography_scale, design_component_library, design_spacing_scale, design_layout_grid, design_tailwind_css, design_theme_provider, design_css_variables, design_color_system, design_animation_tokens [INFERRED 0.85]
- **he_documentation_overview** — documentation_overview_design_md, documentation_overview_setup_mindmap_md, documentation_overview_ux_optimization_research_md, documentation_overview_deployment_strategy_md, documentation_overview_codebase_mindmap_md, documentation_overview_graphify_integration_txt, documentation_overview_vs_md, documentation_overview_audit_report_md, documentation_overview_monitoring_guide_md, documentation_overview_saas_9_phase_roadmap_md, documentation_overview_mcp_server_guide_md, documentation_overview_agents_md, documentation_overview_ux_optimization_md, documentation_overview_architectural_audit_v5_md, documentation_overview_e2e_encryption_research_md [INFERRED 0.85]
- **he_e2e_encryption_research** — e2e_encryption_research_mls, e2e_encryption_research_crystals_kyber, e2e_encryption_research_crystals_dilithium, e2e_encryption_research_e2e_encryption_research_md, e2e_encryption_research_cloudflare_keyless_ssl, e2e_encryption_research_double_ratchet, e2e_encryption_research_oauth_2_0_pushed_authorization_requests, e2e_encryption_research_hashicorp_vault, e2e_encryption_research_hsm, e2e_encryption_research_signal_protocol, e2e_encryption_research_post_quantum_cryptography, e2e_encryption_research_aws_kms, e2e_encryption_research_x3dh [INFERRED 0.85]
- **he_environment** — environment_anthropic_api_key, environment_deepseek_api_key, environment_openrouter_api_key, environment_moonshot_api_key, environment_environment, environment_sentry_traces_sample_rate, environment_perplexity_api_key, environment_supabase_anon_key, environment_redis_url, environment_google_api_key, environment_admin_api_key, environment_rate_limit_per_minute, environment_server_host, environment_cors_origins, environment_xai_api_key [INFERRED 0.85]
- **he_graphify_integration** — graphify_integration_graphify_integration_txt, graphify_integration_graphify_out, graphify_integration_graphify_integration, graphify_integration_graph_html, graphify_integration_graphify, graphify_integration_graph_report_md, graphify_integration_graph_json, graphify_integration_graphify_cli [INFERRED 0.85]
- **he_mcp_server_guide** — mcp_server_guide_tools, mcp_server_guide_claude_desktop, mcp_server_guide_stdio_transport, mcp_server_guide_resources, mcp_server_guide_zod, mcp_server_guide_copilot, mcp_server_guide_model_context_protocol, mcp_server_guide_cline, mcp_server_guide_prompts, mcp_server_guide_mcp_server_guide_md, mcp_server_guide_sse_transport, mcp_server_guide_mcp_server [INFERRED 0.85]
- **he_monitoring_guide** — monitoring_guide_memory_usage, monitoring_guide_latency, monitoring_guide_prometheus, monitoring_guide_alerting_rules, monitoring_guide_alertmanager, monitoring_guide_error_rate, monitoring_guide_grafana, monitoring_guide_metrics_endpoint, monitoring_guide_monitoring_guide_md, monitoring_guide_sentry, monitoring_guide_circuit_breaker, monitoring_guide_health_checks [INFERRED 0.85]
- **he_openrouter_integration_plan** — openrouter_integration_plan_openai_compatible_api, openrouter_integration_plan_openrouter, openrouter_integration_plan_cost_tracking, openrouter_integration_plan_model_whitelist, openrouter_integration_plan_llm_registry, openrouter_integration_plan_provider_fallback, openrouter_integration_plan_openrouter_integration_plan_md, openrouter_integration_plan_openrouter_integration_plan, openrouter_integration_plan_streaming_support [INFERRED 0.85]
- **he_progress_tracker** — progress_tracker_tailwind_v4_migration, progress_tracker_strategy_a, progress_tracker_openrouter, progress_tracker_next_js_16_migration, progress_tracker_strategy_b, progress_tracker_saas_9_phase_roadmap, progress_tracker_searxng, progress_tracker_e2e_encryption, progress_tracker_mcp_server, progress_tracker_graphify, progress_tracker_progress_tracker_md, progress_tracker_vs [INFERRED 0.85]
- **he_roadmap_phases_1_9** — roadmap_phases_1_9_phase_6_security, roadmap_phases_1_9_phase_2_auth, roadmap_phases_1_9_phase_1_foundation, roadmap_phases_1_9_roadmap_phases_1_9_md, roadmap_phases_1_9_phase_9_scale, roadmap_phases_1_9_phase_4_billing, roadmap_phases_1_9_phase_7_monitoring, roadmap_phases_1_9_phase_5_stripe_webhooks, roadmap_phases_1_9_phase_8_frontend_polish, roadmap_phases_1_9_phase_3_quotas [INFERRED 0.85]
- **he_saas_9_phase_roadmap** — saas_9_phase_roadmap_supabase, saas_9_phase_roadmap_supabase_auth, saas_9_phase_roadmap_phase_7_monitoring, saas_9_phase_roadmap_postgresql, saas_9_phase_roadmap_phase_1_foundation, saas_9_phase_roadmap_searxng, saas_9_phase_roadmap_phase_4_billing, saas_9_phase_roadmap_redis, saas_9_phase_roadmap_phase_5_stripe_webhooks, saas_9_phase_roadmap_saas_9_phase_roadmap_md, saas_9_phase_roadmap_domain_entities, saas_9_phase_roadmap_stripe_billing, saas_9_phase_roadmap_phase_6_security, saas_9_phase_roadmap_phase_2_auth, saas_9_phase_roadmap_stripe [INFERRED 0.85]
- **he_strategy_a** — strategy_a_strategy_a, strategy_a_api_init_py, strategy_a_event_store_py, strategy_a_eventbus, strategy_a_strategy_a_md, strategy_a_threadpoolexecutor, strategy_a_threading_lock, strategy_a_runstatestore, strategy_a_asyncio_event [INFERRED 0.85]
- **he_strategy_b_refactor_plan** — strategy_b_refactor_plan_api_init_py, strategy_b_refactor_plan_rendererservice, strategy_b_refactor_plan_strategy_b, strategy_b_refactor_plan_cqrs, strategy_b_refactor_plan_strategy_b_refactor_plan_md, strategy_b_refactor_plan_application_layer, strategy_b_refactor_plan_pipeline_py, strategy_b_refactor_plan_presets_py, strategy_b_refactor_plan_presetservice, strategy_b_refactor_plan_pipelineflow, strategy_b_refactor_plan_searchservice, strategy_b_refactor_plan_renderer_py, strategy_b_refactor_plan_event_bus [INFERRED 0.85]
- **he_setup_mindmap** — setup_mindmap_anthropic_api_key, setup_mindmap_openai, setup_mindmap_asyncpg, setup_mindmap_env, setup_mindmap_setup_mindmap_md, setup_mindmap_anthropic, setup_mindmap_httpx, setup_mindmap_aiosqlite, setup_mindmap_openai_api_key, setup_mindmap_git, setup_mindmap_google_api_key, setup_mindmap_python_3_10, setup_mindmap_api_keys, setup_mindmap_uvicorn, setup_mindmap_pydantic [INFERRED 0.85]
- **he_strategy_a_execution_summary** — strategy_a_execution_summary_step_3, strategy_a_execution_summary_api_init_py, strategy_a_execution_summary_step_2, strategy_a_execution_summary_runstatestore_wrapper, strategy_a_execution_summary_eventstore, strategy_a_execution_summary_strategy_a_execution_summary_md, strategy_a_execution_summary_step_5, strategy_a_execution_summary_step_3_cancellation_toctou_race_fix, strategy_a_execution_summary_step_1_bus_py_isolation, strategy_a_execution_summary_step_4_eventstore_concurrency_fix, strategy_a_execution_summary_step_4, strategy_a_execution_summary_step_5_runstatestore_wrapper, strategy_a_execution_summary_runstatestore, strategy_a_execution_summary_step_2_circular_import_check, strategy_a_execution_summary_step_1 [INFERRED 0.85]
- **he_temperature_values** — temperature_values_phase_1_decomposition, temperature_values_phase_5_synthesis, temperature_values_temperature_values, temperature_values_phase_0_classification, temperature_values_phase_2_perspectives, temperature_values_phase_4_stress_testing, temperature_values_phase_3_critique [INFERRED 0.85]
- **he_ui_ux_audit_and_optimization_plan** — ui_ux_audit_and_optimization_plan_focus_system, ui_ux_audit_and_optimization_plan_wcag_aa, ui_ux_audit_and_optimization_plan_tooltip, ui_ux_audit_and_optimization_plan_tailwind_v4, ui_ux_audit_and_optimization_plan_background_optimization, ui_ux_audit_and_optimization_plan_focus_states, ui_ux_audit_and_optimization_plan_touch_target_fixes, ui_ux_audit_and_optimization_plan_ui_ux_audit_and_optimization_plan_md, ui_ux_audit_and_optimization_plan_touch_targets, ui_ux_audit_and_optimization_plan_contrast_failures, ui_ux_audit_and_optimization_plan_contrast_audit, ui_ux_audit_and_optimization_plan_css_variables, ui_ux_audit_and_optimization_plan_threebackground, ui_ux_audit_and_optimization_plan_typography_system [INFERRED 0.85]
- **he_ux_optimization** — ux_optimization_continue_generating, ux_optimization_feedback_loop, ux_optimization_compact_phase_cards, ux_optimization_cost_transparency, ux_optimization_inline_source_citations, ux_optimization_ux_optimization_md, ux_optimization_keyboard_shortcuts, ux_optimization_drag_and_drop_uploads, ux_optimization_error_recovery, ux_optimization_inline_memory_indicator, ux_optimization_dark_mode_transitions, ux_optimization_command_palette [INFERRED 0.85]
- **he_ux_optimization_research** — ux_optimization_research_completion_signal, ux_optimization_research_chat_page_monolith, ux_optimization_research_method_selection_opacity, ux_optimization_research_file_validation_alert, ux_optimization_research_skip_link, ux_optimization_research_mobile_touch_target_increase, ux_optimization_research_live_region, ux_optimization_research_ux_optimization_research_md, ux_optimization_research_streaming_markdown_re_renders, ux_optimization_research_prefers_reduced_motion, ux_optimization_research_accent_color, ux_optimization_research_phasetimeline_re_computation, ux_optimization_research_quality_scores, ux_optimization_research_error_color, ux_optimization_research_mobile_touch_targets [INFERRED 0.85]
- **he_vs** — vs_nli, vs_probe_generation, vs_decomposition, vs_coverage_audit, vs_verbalized_sampling, vs_claim_extraction, vs_generationstrategy, vs_radiology, vs_k_candidates, vs_verification_routing, vs_vs_md, vs_behavioral_audit, vs_feature_flags, vs_legal, vs_vs [INFERRED 0.85]
- **he_method** — method_analogical, method_socratic, method_debate, method_scientific, method_jury, method_pre_mortem, method_bayesian, method_delphi, method_research, method_method, method_dialectical, method_iterative, method_multi_perspective [INFERRED 0.85]
- **he_architecture** — architecture_hypergate, architecture_data_flow, architecture_monorepo, architecture_browser, architecture_28_events, architecture_neuro_ltm, architecture_service_boundaries, architecture_searxng, architecture_fastapi, architecture_next_js_16, architecture_event_sourced_aggregates, architecture_architecture_md, architecture_arapipeline [INFERRED 0.85]
- **he_backend** — backend_hypergate, backend_orchestration, backend_cqrs, backend_event_bus, backend_backend_md, backend_preset_service, backend_application_layer, backend_renderers, backend_fastapi, backend_middleware, backend_quota_service, backend_billing_service, backend_mixins, backend_search_service, backend_api_routes [INFERRED 0.85]
- **he_data** — data_postgresql, data_indexeddb, data_data_md, data_neuro_ltm, data_sqlite, data_pipelinestate, data_auth_store, data_token_cache, data_redis, data_event_store, data_quota_repo, data_file_uploads, data_subscription_repo, data_feedback_store, data_pipeline_owner_tracking [INFERRED 0.85]
- **he_dependencies** — dependencies_supabase, dependencies_dependencies_md, dependencies_next_js, dependencies_glm, dependencies_google_ai, dependencies_kimi, dependencies_xai, dependencies_ollama, dependencies_searxng, dependencies_redis, dependencies_mistral, dependencies_stripe, dependencies_perplexity, dependencies_swr, dependencies_anthropic [INFERRED 0.85]
- **he_frontend** — frontend_react_19, frontend_indexeddb, frontend_tailwind_css_v4, frontend_frontend_md, frontend_ui_next, frontend_zustand, frontend_hooks, frontend_component_hierarchy, frontend_typescript_5, frontend_test_files, frontend_next_js_16, frontend_lib_utilities, frontend_state_management, frontend_page_tree, frontend_app_router [INFERRED 0.85]
- **he_searxng_p0_implementation_plan** — searxng_p0_implementation_plan_bm25, searxng_p0_implementation_plan_in_flight_deduplication, searxng_p0_implementation_plan_hybrid_mode, searxng_p0_implementation_plan_engine_diversity, searxng_p0_implementation_plan_searxng_p0_implementation_plan_md, searxng_p0_implementation_plan_time_range, searxng_p0_implementation_plan_searxng, searxng_p0_implementation_plan_redis_cache, searxng_p0_implementation_plan_smart_search, searxng_p0_implementation_plan_p0_optimizations, searxng_p0_implementation_plan_language_propagation, searxng_p0_implementation_plan_discoveryclient, searxng_p0_implementation_plan_searxng_integration, searxng_p0_implementation_plan_query_decomposition, searxng_p0_implementation_plan_circuit_breaker [INFERRED 0.85]
- **he_vs_constants** — vs_constants_w_support, vs_constants_k_defaults, vs_constants_vs_constants_md, vs_constants_generationstrategy, vs_constants_tail_thresholds, vs_constants_w_entropy, vs_constants_w_nli, vs_constants_json_parse_error_strategy, vs_constants_vsdeploymentprofile, vs_constants_vsconstants, vs_constants_w_rank, vs_constants_calibration_weights [INFERRED 0.85]
- **he_readme** — readme_reasoner_quota_exceeded_total, readme_reasoner_queries_total, readme_prometheus, readme_alerting_rules, readme_alertmanager, readme_metrics_endpoint, readme_monitoring_readme_md, readme_reasoner_query_duration_seconds_bucket, readme_required_metrics, readme_reasoner_postgres_pool_free [INFERRED 0.85]
- **he_readme** — readme_graphify_readme_md, readme_graphify_out, readme_mcp_server, readme_tree_sitter, readme_graph_html, readme_graphify, readme_graph_report_md, readme_knowledge_graph, readme_graph_json, readme_graphify_cli [INFERRED 0.85]
- **he_alerts** — alerts_alert, alerts_get_memory_usage_percent, alerts_alertconfig, alerts_loggingnotifier, alerts_collectors, alerts_alertrule, alerts_alertnotifier, alerts_alertseverity, alerts_alertmanager, alerts_get_alert_manager, alerts_get_circuit_breaker_open_count, alerts_slacknotifier, alerts_webhooknotifier, alerts_alerts_py [INFERRED 0.85]
- **he_audit** — audit_log_pipeline_event, audit_auditeventtype, audit_audit_py, audit_duration, audit_get_audit_logger, audit_auditevent, audit_log_api_request, audit_auditlogger, audit_audittimer, audit_log_api_response [INFERRED 0.85]
- **he_check_keys** — check_keys_check_keys_py, check_keys_openrouter_api_key [INFERRED 0.85]
- **he_health_check** — health_check_health_check_py, health_check_check_provider_health, health_check_healthstatus, health_check_get_system_health, health_check_providerhealthchecker, health_check_provider_health, health_check_registry, health_check_healthcheckresult, health_check_providerhealth, health_check_get_health_checker [INFERRED 0.85]
- **he_observability** — observability_spandata, observability_end_span, observability_observability_py, observability_metricdata, observability_clear_buffers, observability_observe, observability_inject_trace_context, observability_get_trace_context, observability_trace_context, observability_get_metrics_buffer, observability_observe_decorator, observability_extract_trace_context, observability_start_span, observability_functions, observability_get_spans_buffer [INFERRED 0.85]
- **he_rate_limit** — rate_limit_limiter, rate_limit_ratelimitconfig, rate_limit_ratelimiter, rate_limit_tokenbucket, rate_limit_create_limiter, rate_limit_slowapi, rate_limit_slowapi_available, rate_limit_rate_limit_py, rate_limit_is_slowapi_available, rate_limit_get_rate_limiter [INFERRED 0.85]
- **he_retry_utils** — retry_utils_retry_utils_py, retry_utils_retry_with_backoff, retry_utils_circuitopenerror, retry_utils_retryable_exceptions, retry_utils_retryconfig, retry_utils_circuit_breaker [INFERRED 0.85]
- **he_reverse_deps** — reverse_deps_reverse_deps_py, reverse_deps_python_files, reverse_deps_reverse_deps_txt [INFERRED 0.85]
- **he_start_server** — start_server_api_app, start_server_start_server_py, start_server_uvicorn [INFERRED 0.85]
- **he_summarize** — summarize_summarize_py, summarize_python_files, summarize_py_summaries_txt [INFERRED 0.85]
- **he_debug_extract** — debug_extract_extract_json, debug_extract_debug_extract_py, debug_extract_action_blueprint [INFERRED 0.85]
- **he_env** — env_run_migrations_offline, env_async_engine_from_config, env_alembic, env_run_migrations_online, env_env_py, env_run_async_migrations, env_database_url [INFERRED 0.85]
- **he_20260501_003029_add_paypal_and_rename_external_cols** — 20260501_003029_add_paypal_and_rename_external_cols_stripe_customer_id, 20260501_003029_add_paypal_and_rename_external_cols_external_subscription_id, 20260501_003029_add_paypal_and_rename_external_cols_20260501_003029_add_paypal_and_rename_external_cols_py, 20260501_003029_add_paypal_and_rename_external_cols_external_subscription_id_to_stripe_sub_id, 20260501_003029_add_paypal_and_rename_external_cols_external_customer_id_to_stripe_customer_id, 20260501_003029_add_paypal_and_rename_external_cols_migration, 20260501_003029_add_paypal_and_rename_external_cols_paypal_sub_id, 20260501_003029_add_paypal_and_rename_external_cols_stripe_sub_id, 20260501_003029_add_paypal_and_rename_external_cols_external_customer_id, 20260501_003029_add_paypal_and_rename_external_cols_subscriptions_table [INFERRED 0.85]
- **he_run_state** — run_state_request_cancel, run_state_active_runs, run_state_run_store, run_state_get_cancel_event, run_state_cancel_events, run_state_module_level_singleton, run_state_run_state_py, run_state_asyncio_lock, run_state_add, run_state_active_runs_1, run_state_is_active, run_state_request_cancel_all, run_state_remove, run_state_runstatestore, run_state_get_owner [INFERRED 0.85]
- **he_alerts** — alerts_get_health_check_success, alerts_check, alerts_should_fire, alerts_to_dict, alerts_notify, alerts_init, alerts_register_collector, alerts_add_rule, alerts_check_and_alert, alerts_get_alert_history, alerts_get_active_alerts, alerts_field, alerts_get_all_circuit_breakers, alerts_sum, alerts_monotonic [INFERRED 0.85]
- **he_audit** — audit_to_dict, audit_init, audit_log, audit_write_to_file, audit_get_recent_events, audit_get_events_for_correlation, audit_enter, audit_exit, audit_asdict, audit_log_func, audit_items, audit_len, audit_mkdir, audit_time, audit_open [INFERRED 0.85]
- **he_health_check** — health_check_init, health_check_check_provider, health_check_check_all_providers, health_check_get_cached_status, health_check_enumerate, health_check_build_provider, health_check_gather, health_check_isinstance, health_check_wait_for, health_check_complete [INFERRED 0.85]
- **he_observability** — observability_execute_with_observation, observability_decorator, observability_async_wrapper, observability_sync_wrapper, observability_set, observability_copy, observability_clear, observability_wraps, observability_signature, observability_bind, observability_apply_defaults, observability_iscoroutinefunction, observability_format_exc, observability_getattr, observability_import [INFERRED 0.85]
- **he_rate_limit** — rate_limit_init, rate_limit_consume, rate_limit_refill, rate_limit_check_rate_limit, rate_limit_calculate_retry_time, rate_limit_get_status, rate_limit_float, rate_limit_min [INFERRED 0.85]
- **he_retry_utils** — retry_utils_runtimeerror, retry_utils_get_circuit_breaker, retry_utils_uniform, retry_utils_call, retry_utils_sleep [INFERRED 0.85]
- **he_reverse_deps** — reverse_deps_scan, reverse_deps_walk, reverse_deps_endswith, reverse_deps_join [INFERRED 0.85]
- **he_summarize** — summarize_scan, summarize_summary, summarize_relpath, summarize_parse, summarize_iter_child_nodes, summarize_read, summarize_splitlines, summarize_sorted, summarize_strip, summarize_group, summarize_split [INFERRED 0.85]
- **he_env** — env_do_run_migrations, env_configure, env_get_section, env_run, env_begin_transaction, env_connect, env_dispose, env_run_sync [INFERRED 0.85]
- **he_20260501_003029_add_paypal_and_rename_external_cols** — 20260501_003029_add_paypal_and_rename_external_cols_upgrade, 20260501_003029_add_paypal_and_rename_external_cols_downgrade, 20260501_003029_add_paypal_and_rename_external_cols_execute [INFERRED 0.85]

## Communities (3110 total, 476 thin omitted)

### Community 0 - "Article Pipeline"
Cohesion: 0.03
Nodes (70): AmbiguityDetectorSubAgent, AmbiguityDetectorSubAgent — ONE JOB: identify what is unclear or vague in the pr, _build_prompt(), _parse_result(), PhaseSubAgent, PhaseSubAgent — abstract base class for intra-phase focused reasoning agents.  E, Accumulate token usage and cost into PipelineState., One focused reasoning task within a pipeline phase. (+62 more)

### Community 1 - "Authentication & Security"
Cohesion: 0.03
Nodes (149): Authentication and rate-limiting FastAPI dependencies., FastAPI Dependency Injectors for SaaS Auth.  These functions are used as FastA, Reset quota service singleton (useful for tests)., Reset rate limiter singleton (useful for tests)., _reset_quota_service(), _reset_rate_limiter_instance(), SaaS Router — All new SaaS-related API endpoints.  This router is mounted in api, AuthenticationError (+141 more)

### Community 2 - "Event Sourcing & Domain Events"
Cohesion: 0.08
Nodes (34): PipelineFailed, Pipeline execution failed., Get or create database connection., _get_pipeline_owner(), Return the user_id that owns *pipeline_id*, or None if not tracked., get_websocket_manager(), handle_websocket_message(), WebSocket Integration for Real-time Event Streaming  Provides real-time updates (+26 more)

### Community 3 - "Verbalized Sampling & Benchmarks"
Cohesion: 0.19
Nodes (23): _extract_balanced_structure(), extract_json_any(), _extract_json_array_value(), _extract_json_dict_fallback(), extract_json_list(), _extract_json_string_value(), extract_solution_prose(), _is_structural_quote() (+15 more)

### Community 4 - "Neuro Memory & LTM"
Cohesion: 0.07
Nodes (39): ContextChunk, cosine_similarity(), L1Cache, L2Index, l3_scan(), Neuro Cache Hierarchy L1/L2/L3 with persona-aware similarity thresholds., Scan L3 (cold) memory files for relevant context.      Embeddings are cached as, CacheConfig (+31 more)

### Community 5 - "Widgets & Calculator"
Cohesion: 0.06
Nodes (73): BaseWidget, CalculatorWidget, Calculator Widget  Evaluates mathematical expressions using simpleeval (safe eva, Format result for display., Calculator widget for mathematical expressions.      Features:     - Basic arith, Extract expression from match., Evaluate mathematical expression., DiscoverWidget (+65 more)

### Community 6 - "Next.js API Routes"
Cohesion: 0.06
Nodes (36): get_phase_retry_budget(), get_phase_timeout(), get_quality_judge_model(), get_quality_judge_threshold(), get_token_budget(), Single source of truth for all hardcoded constants used across the Reasoner proj, Get token budget for a specific role/phase., Get token budget for a specific role/phase. (+28 more)

### Community 7 - "Article Detection & Styles"
Cohesion: 0.12
Nodes (20): CircuitBreakerConfig, CircuitBreakerStats, CircuitOpenError, CircuitState, get_all_circuit_breakers(), get_circuit_breaker(), Reasoner Pipeline - Circuit Breaker Pattern Provides fault tolerance for LLM pro, Manually reset circuit to closed state. (+12 more)

### Community 8 - "Redis & Caching"
Cohesion: 0.05
Nodes (47): EventPublisher, LLMGenerationCompleted, LLM generation completed for a specific phase/role., LLM generation completed for a specific phase/role., LLM generation completed for a specific phase/role., LLM generation completed for a specific phase/role., EventPublisher, Core port: EventPublisher — decouples infrastructure from application event bus. (+39 more)

### Community 9 - "Image Generation & Encryption"
Cohesion: 0.06
Nodes (35): TaggedMemory — lightweight categorized conversation history store.  Organizes hi, clear_history(), delete_history_entry(), get_history(), get_history_entry(), get_tagged_history(), Search history endpoints., Clear all history for the authenticated user. (+27 more)

### Community 10 - "Alerting System"
Cohesion: 0.17
Nodes (11): ExtractedClaim, PersuasionDefenseResult, Single taint event in the audit trail., Integration adapter between the PersuasionDefensePipeline and the     existing R, Main integration entry point. Called by Reasoner's orchestrator., Merge persuasion taints into Reasoner's existing taint chain., Apply persuasion risk penalty to Reasoner's confidence score.         Formula: a, Aggregated output of the full 5-stage persuasion defense pipeline. (+3 more)

### Community 11 - "Application Entry Points"
Cohesion: 0.08
Nodes (34): ProviderUnavailableError, Provider service is unavailable.          This error IS retryable - may be a t, build_provider(), list_models(), Model registry and provider factory., Build a provider instance from a model ID string., Build a provider instance from a model ID string., Build a provider instance from a model ID string. (+26 more)

### Community 12 - "Subagent Framework"
Cohesion: 0.07
Nodes (42): VS Behavioral Audit Observability stage., _extract_json_block(), Verbalized Sampling primitives — generation, parsing, normalization, sampling., Probability-weighted sample., Deterministic; tie → first., Remove ```json ... ``` fences and surrounding whitespace., Find the outermost JSON object containing 'candidates'., sample_from_vs() (+34 more)

### Community 13 - "Pipeline Control & Cancellation"
Cohesion: 0.08
Nodes (22): stop_pipeline(), Register a new run and return its cancel event., Clean up a run's state., Get the cancel event for a run., Signal cancellation for a run., Signal cancellation for all active runs., Cancel all active runs in Redis using SMEMBERS (O(1) per member, not SCAN)., Check if a run is currently active (non-locking, best-effort). (+14 more)

### Community 14 - "Reasoning Phase Prompts"
Cohesion: 0.09
Nodes (53): cove_answer_prompt(), cove_draft_prompt(), cove_revise_prompt(), cove_verify_prompt(), PipelineState, pot_interpret_prompt(), build_followup_context(), _followup_context() (+45 more)

### Community 15 - "Circuit Breaker & Resilience"
Cohesion: 0.07
Nodes (35): ABC, ProviderConfig, ResilientProviderConfig, Neuro Provider Abstraction Layer Pluggable backends with circuit-breaker fallba, AnthropicReasoning, CircuitBreaker, _create_embedding(), _create_reasoning() (+27 more)

### Community 16 - "Phase Quality & Prompts"
Cohesion: 0.11
Nodes (21): _call_with_circuit(), Call LLM for role. On LLMError or timeout, tries a fallback provider:, Build metadata dict for the LLM call., Call LLM for role. On LLMError or timeout, tries a fallback provider:, Call LLM for role. On LLMError or timeout, tries a fallback provider:, Build router from model ID strings., Build router from model ID strings., Call a provider with circuit-breaker protection. (+13 more)

### Community 17 - "LLM Exceptions & Errors"
Cohesion: 0.07
Nodes (55): _collect_image_candidates(), _contains_policy_risk_terms(), _download_image_url(), _enhance_image_prompt(), _error_matches_any(), _extract_base64_from_text(), _extract_remote_urls_from_text(), _extract_text_from_content_parts() (+47 more)

### Community 18 - "Database Migrations"
Cohesion: 0.07
Nodes (28): ActiveFrictionGate, BehavioralAuditStage, CoverageAuditStage, EmbeddingModel, IntentConsistencyStage, ModelRegistry, NLIClassifier, PersuasionDefenseConfig (+20 more)

### Community 19 - "Stripe Billing & SaaS"
Cohesion: 0.16
Nodes (19): Deployment Strategy, Phase 1 Foundation, Phase 2 Auth, Phase 3 Quotas, Phase 4 Billing, Phase 5 Stripe Webhooks, Phase 6 Security, Phase 7 Monitoring (+11 more)

### Community 20 - "Image Generation API"
Cohesion: 0.14
Nodes (35): benchmark_vs_latency(), main(), write_overhead_table(), benchmark_vs_latency(), main(), measure_pipeline(), _MockLLM, _MockNLI (+27 more)

### Community 21 - "Frontend Pages"
Cohesion: 0.05
Nodes (58): apiFetch(), _calculate(), clearCache(), fetchJSON(), fetchPresets(), _fetchStocks(), _fetchWeather(), formatApiError() (+50 more)

### Community 22 - "Chat UI Components"
Cohesion: 0.04
Nodes (76): ClaimLabel, Reasoner Pipeline - Output Renderer Rich terminal display and JSON export, with, Dispatch to the appropriate method-specific renderer., render_pipeline_result(), Dispatch to the appropriate method-specific renderer., render_pipeline_result(), Renderer strategy registry for Reasoner pipeline methods., Registry that maps method names to rendering strategies. (+68 more)

### Community 23 - "JSON Parsing Utilities"
Cohesion: 0.09
Nodes (95): LLMExecutor, Stateless (per-call) infrastructure adapter that wraps ProviderRouter with     t, extract_image_models(), EnhancementHyperAgent, Orchestrates parallel synthesis subagents and produces FinalSolution., SynthesisHyperAgent, JSONDepthExceededError, Raised when JSON nesting exceeds the configured maximum depth. (+87 more)

### Community 24 - "Event Store Tests"
Cohesion: 0.00
Nodes (500): 0083ab94-e21d-4b05-abbf-4b2daae00028, 023acc92-2513-4781-b054-9ce1ee992b58, 02cf3599-7910-4355-9594-9f0e63aef2cd, 02e136f4-f936-47df-8b6d-019819b842b1, 02f7192a-be5e-411f-969a-2a8ab130ff1d, 03834b82-757d-4669-bff6-460bc861e5ab, 03a342d3-2e6e-4368-825a-077951ca6d95, 040713fd-2249-482e-83f4-da0e5d80f8fe (+492 more)

### Community 25 - "Snapshot Tests"
Cohesion: 0.03
Nodes (137): ArticleFlow, Article reasoning workflow strategy., Article workflow:     1. Retrieve Sources     2. Draft     3. Adversarial Ver, PhaseStep, Base interfaces for workflow strategies., A single step in a reasoning flow., A single step in a reasoning flow., Port defining core services provided by the orchestrator to workflows. (+129 more)

### Community 26 - "CQRS Query Handlers"
Cohesion: 0.15
Nodes (25): GetHistoryEntryQuery, GetHistoryQuery, GetModelQuery, GetPipelineHistoryQuery, GetPipelineStatusQuery, GetPresetQuery, GetProviderHealthQuery, GetWidgetStateQuery (+17 more)

### Community 27 - "Synthesis Serialization"
Cohesion: 0.05
Nodes (164): ParseError, Raised when LLM response cannot be parsed into expected structure., PhaseResult, How temperature should adapt on retry., Immutable record of one phase's execution.     Accumulated in PipelineState.pha, TemperatureStrategy, CriticDimensionScore, CriticScore (+156 more)

### Community 28 - "IP Anonymization & GDPR"
Cohesion: 0.13
Nodes (18): PipelineState, str, PipelineState, str, PipelineState, str, FinalSolution, PipelineState (+10 more)

### Community 29 - "Quality Gates"
Cohesion: 0.04
Nodes (66): check_rate_limit(), _get_auth_manager_instance_auth_deps(), get_client_id(), _get_rate_limiter_instance_auth_deps(), optional_auth(), Require valid API key authentication.     Raises HTTPException if authentication, Require valid API key authentication.     Raises HTTPException if authentication, Optional authentication - returns API key if provided, None otherwise. (+58 more)

### Community 30 - "Event Store Snapshot Tests"
Cohesion: 0.03
Nodes (80): make_phase_result(), Phase, Convenience constructor that computes duration from a start timestamp., Protocol for pipeline phases. Does NOT require inheritance —     any class with, PipelineState, Serialize state for passing to next LLM call.                  Args:, Get condensed decomposition summary for token efficiency., Get condensed decomposition summary for token efficiency. (+72 more)

### Community 31 - "Frontend Phase Tests"
Cohesion: 0.13
Nodes (20): build_vs_prompt(), compute_verbalized_entropy(), _extract_json_block(), parse_vs_response(), Verbalized Sampling primitives — generation, parsing, normalization, sampling., Strip fences, regex-extract JSON, validate structure., Probability-weighted sample., Deterministic; tie → first. (+12 more)

### Community 32 - "Event Store Count Tests"
Cohesion: 0.05
Nodes (137): clear_memory_cache(), Clear the in-memory cache (thread-safe)., clear_cache(), FastAPI middleware classes for security, memory limits, and request timeouts., Scope, BaseModel, External context integration endpoint., Run the Reasoner pipeline with external context.      This endpoint accepts coll (+129 more)

### Community 33 - "Event Store List Tests"
Cohesion: 0.03
Nodes (96): create_checkout(), create_portal(), _get_paypal_service(), _get_stripe_service(), get_subscription(), paypal_webhook(), FastAPI router for all billing endpoints., Public endpoint for Stripe webhooks. (+88 more)

### Community 34 - "Pricing & Cost Estimation"
Cohesion: 0.16
Nodes (14): clean_llm_artifacts(), InputSanitizer, Check for excessive character repetition., Check for other suspicious patterns., Sanitize problem input.      Args:         problem: Problem text from user, Strip invisible Unicode characters and LLM-specific control tokens from     outp, Comprehensive input sanitization for user-provided text., Sanitize text for logging (removes sensitive patterns). (+6 more)

### Community 35 - "Event Store Get Tests"
Cohesion: 0.06
Nodes (41): BaseException, GateDecision, HyperContext, BaseSubAgent, One job. One cache. One execute() call., GateDecision, _failed_output(), HyperGateAgent (+33 more)

### Community 36 - "Event Store Stats Tests"
Cohesion: 0.07
Nodes (20): asdict(), Simple asdict replacement for dataclasses., Serialize event to dictionary for storage., EncryptionService, generate_key(), get_encryption_service(), Encryption Service for Data at Rest (Phase 3: E2EE)  Provides AES-256-GCM encr, Get or create global EncryptionService instance (Thread-safe). (+12 more)

### Community 37 - "Event Store Save Tests"
Cohesion: 0.10
Nodes (32): _get_build_provider(), BraveSearchAdapter, Brave Search API adapter — implements SearchServicePort.  Uses Brave Search API, Implements SearchServicePort for Brave Search API.      Graceful degradation: no, _decompose_query(), _extract_search_keywords(), get_search_client(), get_search_client_for_method() (+24 more)

### Community 38 - "Chat Components & Hooks"
Cohesion: 0.08
Nodes (28): configure_logging(), LogLevel, LogSource, Reasoner Pipeline - Structured Logging Utilities Provides JSON-structured loggin, Structured log entry in JSON format., Set request-scoped context for structured logging (Critical Enhancement 7.3)., Set correlation ID for current context., Logger that outputs structured JSON logs with correlation IDs. (+20 more)

### Community 39 - "Model Loading Tests"
Cohesion: 0.06
Nodes (48): QuotaResult, Per-user query quota, reset monthly., Result of a quota check., UsageQuota, Fetch quota from cache or fallback repository., Pass through to fallback and invalidate cache on mutation., Pass through to fallback and invalidate cache on mutation., Pass through to fallback and invalidate cache on mutation. (+40 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (59): BillingPort, Billing Port — Abstract interface for payment providers.  Stripe is the default, Port for subscription billing operations., Return a checkout URL for the user to complete payment., Return a billing portal URL for self-service management., Idempotently sync a subscription from a provider webhook event.          Args:, Immediately cancel a subscription at the provider., create_checkout() (+51 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (117): extract_json(), _parse_critique_scores(), Safely build CritiqueScore objects from raw LLM output.      CritiqueScore has, Safely build CritiqueScore objects from raw LLM output.      CritiqueScore has, Extract JSON object (dict) from LLM response.     Raises ParseError if no objec, get_preset_price_tier(), Infer pricing tier from preset ID suffix., Infer pricing tier from preset ID suffix. (+109 more)

### Community 42 - "Community 42"
Cohesion: 0.40
Nodes (4): Verbalized Sampling constants — zero magic numbers outside this file., VSDeploymentProfile, Verbalized Sampling constants — zero magic numbers outside this file., VSDeploymentProfile

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (54): BiasCritiqueSubAgent, CounterfactualSubAgent, EvidenceCritiqueSubAgent, CritiqueHyperAgent, Aggregate subagent findings into per-candidate CritiqueScore objects., Index a list of dicts by perspective name., Orchestrates parallel critique subagents and produces CritiqueScore list., LogicCritiqueSubAgent (+46 more)

### Community 44 - "Community 44"
Cohesion: 0.18
Nodes (11): Architectural Audit V5, ARA Pipeline v2.0 Handover Audit, Codebase Mindmap, Meta-Orchestration Assessment v3.0, 18 Reasoning Methods Comparison, Neuro Memory Subsystem Documentation, Reasoner Pipeline Optimization Plan v2.2, Reasoner Pipeline Changelog (+3 more)
...
Cohesion: 0.05
Nodes (43): _apply_defaults(), _build_persona(), _build_provider(), _build_resilient(), get_agent_data_dir(), load_config(), _parse_config(), ProviderConfig (+35 more)

### Community 47 - "Community 47"
Cohesion: 0.08
Nodes (41): Any, float, int, str, Widget, WidgetDetectionResult, WidgetResult, CalculatorWidget (+33 more)
...
Cohesion: 0.04
Nodes (59): ActiveFrictionGate, BehavioralAuditReport, BehavioralAuditStage, check_weights_sum(), _cosine_similarity(), CoverageAuditStage, CoverageReport, EmbeddingModel (+51 more)

### Community 50 - "Community 50"
Cohesion: 0.36
Nodes (9): Dark Wooden Bookshelf with Items, Coffee or Tea Cups on Table, Living Room Interior, Photograph of Two Women in Living Room, Pink Couch with Throw Blanket, Religious Icons on Bookshelf, Framed Wall Painting, Woman in Floral Pattern Dress (+1 more)

### Community 51 - "Community 51"
Cohesion: 0.14
Nodes (14): COLOR_TEXT, COLOR_TEXT_MUTED, COLOR_TEXT_SUBTLE, generateNodes(), NeuralConstellation(), NodeData, NODES, seededRandom() (+6 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (25): EventStore, get_event_store(), Event Persistence Layer  Stores domain events in SQLite for durability and repla, Save events to the event store.          Events are persisted atomically within, Determine aggregate type from event type., Update aggregate state snapshot., SQLite-based event store for persistence.          Features:     - Append-only e, Get events for an aggregate.          Optionally filter by minimum version for i (+17 more)

### Community 53 - "Community 53"
Cohesion: 0.25
Nodes (8): E2E Encryption Research Document, E2EE Zero-Trust Security Architecture, Environment Variables Reference, Gemini Agent Project Context, Production Deployment Guide with Docker Compose, Reasoner v2.2 Project README, SaaS Production Launch Plan, John Maeda Laws of Simplicity Application
...
Cohesion: 0.29
Nodes (7): graph.html, graph.json, GRAPH_REPORT.md, Graphify CLI, Graphify Integration, graphify-out/, graphify/README.md

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (43): ═══════════════════════════════════════════════════════════════════════════════, 1. models.py (2 functions), 2. renderer.py (1 function), ═══════════════════════════════════════════════════════════════════════════════, 3. infrastructure/persistence/event_store.py (10 functions), 4. infrastructure/persistence/postgres_store.py (4 functions), 5. infrastructure/widgets/registry.py (1 function), 6. neuro/config.py (1 function) (+35 more)
...
Cohesion: 0.03
Nodes (86): ChatFeedMessage, ChatFeedProps, ContinueButton(), MessageActions(), RenderedPhase, ChatMessage, ChatMessageProps, MemoryBadge() (+78 more)

### Community 61 - "Community 61"
Cohesion: 0.03
Nodes (60): ChatFeed, ChatPage(), MessagesAction, PipelineSkeleton, PipelineSkeletonProps, conversationToMessages(), useKeyboardShortcuts(), PipelineError (+52 more)

### Community 62 - "Community 62"
Cohesion: 0.33
Nodes (5): OpenRouter, Redis, Sentry, Stripe, Supabase

### Community 63 - "Community 63"
Cohesion: 0.04
Nodes (105): Reset all usage_quotas at month start. Called by external scheduler., reset_all_quotas_monthly(), check_preset_access(), check_quota(), check_quota_if_authenticated(), check_rate_limit(), _ensure_user_in_db(), get_current_user() (+97 more)
...
Cohesion: 0.04
Nodes (53): Badge(), CalculationWidget(), ChatFeedComponent(), handleCopy(), handler(), CommandItem, CommandPalette(), CommandPaletteProps (+45 more)

### Community 69 - "Community 69"
Cohesion: 0.40
Nodes (4): Step 1, Step 2, Step 3, Step 4

### Community 70 - "Community 70"
Cohesion: 0.40
Nodes (5): Debate, Ερωτήματα ανά Method, Multi-Perspective, Scientific, Socratic

### Community 71 - "Community 71"
Cohesion: 0.40
Nodes (4): Neuro LTM, PostgreSQL, Redis, SQLite

### Community 72 - "Community 72"
Cohesion: 0.40
Nodes (4): calibration weights, GenerationStrategy, k defaults, VSDeploymentProfile

### Community 73 - "Community 73"
Cohesion: 0.03
Nodes (83): Global Exception Handlers for FastAPI  Captures all unhandled exceptions, HTTP e, Backward-compat shim — serializers moved to application/services/serializers.py., Persistent API key storage using SQLite (aiosqlite).  Provides durable storage f, _extract_json(), PayPal implementation of BillingPort for one-time and subscription payments., datetime, _extract_user_id(), generic_exception_handler() (+75 more)

### Community 74 - "Community 74"
Cohesion: 0.04
Nodes (59): app, run_stream_cached, _ser_5, ArticlePipelineMixin, BrainstormingMixin, CodingMixin, CognitiveMixin, get_token_budget() (+51 more)
...
Cohesion: 0.09
Nodes (28): _collect_image_candidates(), _extract_text_from_content_parts(), _generate_image_guarded(), _generate_image_with_images_api(), generate_image_with_model(), _get_modalities(), ImageGenerationError, Best-effort extraction of text from string or structured content parts. (+20 more)

### Community 77 - "Community 77"
Cohesion: 0.05
Nodes (95): Aggregate, PipelineAggregate, PipelineStateData, Get current state as dictionary., Data class representing pipeline state., Event-sourced aggregate for pipeline execution.          Maintains the complet, Apply event-specific state changes., Get current pipeline state. (+87 more)

### Community 78 - "Community 78"
Cohesion: 0.07
Nodes (52): calculate_expression(), geocode_location(), get_discover_content(), get_stock_data(), get_weather_data(), _has_yahooquery(), _has_yfinance(), Widgets Backend Engine Provides data for smart widgets: Weather, Stocks, Calcula (+44 more)

### Community 79 - "Community 79"
Cohesion: 0.07
Nodes (41): APIRouter, Lock, get_persona(), NeuroConfig, PersonaConfig, AuditRequest, AuditResponse, build_audit_system_prompt() (+33 more)

### Community 80 - "Community 80"
Cohesion: 0.19
Nodes (9): Build a router for an auto-selected method.          Returns:             (ef, Build a router for an auto-selected method.          Returns:             (ef, Build a router for an auto-selected method.          Returns:             (ef, Resolve a raw preset string into gate preset parameters.          Returns:, Fall back routing entries whose API key env var is missing to primary_id., Build a ProviderRouter from a preset or custom routing.         Validates model, bool, ProviderRouter (+1 more)

### Community 81 - "Community 81"
Cohesion: 0.04
Nodes (74): _extract_balanced_structure(), extract_json_any(), _extract_json_array_value(), _extract_json_dict_fallback(), extract_json_list(), _extract_json_string_value(), extract_solution_prose(), _is_structural_quote() (+66 more)

### Community 82 - "Community 82"
Cohesion: 0.40
Nodes (4): MockIntersectionObserver, MockResizeObserver, MockIntersectionObserver, MockResizeObserver

### Community 83 - "Community 83"
Cohesion: 0.50
Nodes (4): Background FX Research for Chat Interface, Cursor Design System (Warm Minimalism), Expo Design System (Cool-White Monochromatic), HashiCorp Design System (Enterprise Dual-Mode)

### Community 84 - "Community 84"
Cohesion: 0.67
Nodes (4): --bg, Dark Theme, Light Theme, --surface

### Community 85 - "Community 85"
Cohesion: 0.50
Nodes (4): cost tracking, OpenRouter, OpenRouter Integration Plan, provider fallback

### Community 86 - "Community 86"
Cohesion: 0.50
Nodes (4): feature flags, NLI, pipeline, VS

### Community 87 - "Community 87"
Cohesion: 0.50
Nodes (4): ARAPipeline, Browser, FastAPI, HyperGate

### Community 88 - "Community 88"
Cohesion: 0.50
Nodes (3): API routes, middleware, orchestration

### Community 89 - "Community 89"
Cohesion: 0.50
Nodes (3): component hierarchy, page tree, state management

### Community 90 - "Community 90"
Cohesion: 0.50
Nodes (4): external_customer_id to stripe_customer_id, external_subscription_id to stripe_sub_id, migration, paypal_sub_id

### Community 91 - "Community 91"
Cohesion: 0.67
Nodes (3): LLM Routing Optimizer Skill, Reasoner Preset Manager Skill, Reasoner Test Generator Skill

### Community 92 - "Community 92"
Cohesion: 0.07
Nodes (32): APIKey, AuthManager, AuthorizationError, Simple Token-Based Authentication Middleware Production-ready auth with API key, Hash API key using SHA-256., Set a key with LRU eviction., Generate a new API key.          Args:             name: Human-readable name for, Authenticate request with API key.          Args:             api_key: Raw API k (+24 more)

### Community 93 - "Community 93"
Cohesion: 0.06
Nodes (31): _run_store, StopPipelineCommand, ExecuteWidgetCommandHandler, get_handler_registry(), GetHistoryQueryHandler, GetPipelineStatusQueryHandler, HandlerRegistry, Application Layer - Command and Query Handlers  Handlers process commands and (+23 more)

### Community 94 - "Community 94"
Cohesion: 0.05
Nodes (56): AttachmentRef, CalculationRequest, ContextAnalysisRequest, DiscoverRequest, GenerateImageRequest, Pydantic request/response schemas for the Reasoner API., Request model for image generation., Request model for image generation. (+48 more)
...
Cohesion: 0.04
Nodes (53): ErrorOccurred, Error occurred during execution., Error occurred during execution., Error occurred during execution., Error occurred during execution., _fire_and_forget(), get_postgres_store(), initialize_postgres_store() (+45 more)

### Community 99 - "Community 99"
Cohesion: 0.04
Nodes (66): CodebaseIntrospector, ComplexityLevel, DeadCodeItem, DependencyEdge, ErrorHandlingGap, FunctionInfo, generate_markdown_report(), IntrospectionReport (+58 more)

### Community 100 - "Community 100"
Cohesion: 0.02
Nodes (102): EventBus, get_event_bus(), handle_all_events(), handle_event(), init_default_subscribers(), log_all_events(), persist_all_events(), Start the background queue consumer. (+94 more)

### Community 101 - "Community 101"
Cohesion: 0.04
Nodes (48): 1.1 Create `application/flows/pipeline_flow.py`, 1.2 Create `application/flows/__init__.py`, 1.3 Build `DefaultFlowRegistry` factory, 1.4 Refactor `ARAPipeline.run()` to use `PipelineFlow`, 1.5 Update `api/__init__.py:run_stream()` phase builder, 2.1 Create `application/services/renderer_service.py`, 2.2 Extract render functions from `renderer.py`, 2.3 Create `application/services/renderers/__init__.py` (+40 more)

### Community 102 - "Community 102"
Cohesion: 0.04
Nodes (42): CAPABILITIES, inter, metadata, AuthProvider(), Providers(), Logo(), LogoProps, faqs (+34 more)

### Community 103 - "Community 103"
Cohesion: 0.29
Nodes (3): Auth Port — Abstract interface for authentication providers.  The domain and a, Billing Port — Abstract interface for payment providers.  Stripe is the default, Quota Repository Port — Abstract interface for quota persistence.  Implementat

### Community 106 - "Community 106"
Cohesion: 0.05
Nodes (52): EventStoreCorruptionError, Raised when event store data is inconsistent (e.g. version gaps after compaction, PhaseCompleted, Phase execution completed successfully., Phase execution completed successfully., PostgreSQLEventStore, Initialize database schema., Initialize database schema. (+44 more)

### Community 107 - "Community 107"
Cohesion: 0.06
Nodes (47): PipelineCompleted, PipelineFailed, Pipeline execution completed successfully., Pipeline execution completed successfully., Pipeline execution completed successfully., Pipeline execution failed., Pipeline execution completed successfully., Pipeline execution failed. (+39 more)

### Community 108 - "Community 108"
Cohesion: 0.06
Nodes (44): get_websocket_stats(), Get WebSocket connection statistics., Any, int, str, WebSocket, get_websocket_manager(), handle_websocket_message() (+36 more)

### Community 109 - "Community 109"
Cohesion: 0.17
Nodes (13): ClientBucket, get_rate_limiter(), RateLimiter, Production-Ready Rate Limiter Token bucket algorithm with Redis-like sliding wi, # NOTE: This is a per-process singleton. For horizontal scaling, Get or create global rate limiter., Token bucket for a client., Production rate limiter with multiple algorithms.          Features:     - To (+5 more)

### Community 111 - "Community 111"
Cohesion: 0.07
Nodes (36): Feedback Persistence Layer  Stores user feedback in SQLite for durability and qu, FeedbackEntry, FeedbackStats, FeedbackStore, Feedback Persistence Layer  Stores user feedback in SQLite for durability and, Initialize database schema., Backfill existing JSONL data if table is empty and JSONL exists., Synchronous insert. Must be called inside lock. (+28 more)

### Community 112 - "Community 112"
Cohesion: 0.36
Nodes (6): scientific_hypothesis_prompt(), scientific_test_prompt(), scientific_hypothesis_prompt(), scientific_test_prompt(), PipelineState, str

### Community 113 - "Community 113"
Cohesion: 0.04
Nodes (48): assumptions, candidates, Assumptions, Perspective 1 - Constructive, Perspective 2 - Destructive, Perspective 3 - Systemic, Perspective 4 - Minimalist, errors (+40 more)

### Community 114 - "Community 114"
Cohesion: 0.04
Nodes (48): Dependency Graph, EventType consumers (4 files), God-Node Decoupling — Implementation Plan, Implementation Checklist, PerspectiveType consumers (6 files), Phase 0: Consumer Map, Phase 1 — PerspectiveRegistry, Phase 1: PerspectiveType → Runtime Registry (+40 more)

### Community 115 - "Community 115"
Cohesion: 0.04
Nodes (47): 10. Rule of Three Overuse, 11. Elegant Variation (Synonym Cycling), 12. False Ranges, 13. Passive Voice and Subjectless Fragments, 14. Em Dash Overuse, 15. Overuse of Boldface, 16. Inline-Header Vertical Lists, 17. Title Case in Headings (+39 more)

### Community 116 - "Community 116"
Cohesion: 0.13
Nodes (25): clearAllConversations(), deleteConversation(), getDB(), loadAllConversations(), loadConversation(), loadConversationsByThread(), loadConversationsPage(), saveConversation() (+17 more)

### Community 117 - "Community 117"
Cohesion: 0.04
Nodes (46): ═══════════════════════════════════════════════════════════════════════════════, ═══════════════════════════════════════════════════════════════════════════════, API Key Management, Artifact Regeneration, Artifact Validation, CI/CD INTEGRATION, CONCLUSION, Conflict Detection (+38 more)

### Community 119 - "Community 119"
Cohesion: 0.18
Nodes (11): Analysis & Debug (70-90% savings), Build & Compile (80-90% savings), Files & Search (60-75% savings), Git (59-80% savings), GitHub (26-87% savings), Infrastructure (85% savings), JavaScript/TypeScript Tooling (70-90% savings), Meta Commands (+3 more)

### Community 120 - "Community 120"
Cohesion: 0.04
Nodes (45): 10. Working with Neuro & Compression, 11. Reasoning Methods (17), 12. Presets & Model Routing, 13. CI/CD, 14. Commit & Pull Request Guidelines, 15. Workflow Orchestration (Agent Guidelines), 16. Task Management, 17. Core Principles (+37 more)

### Community 121 - "Community 121"
Cohesion: 0.04
Nodes (47): 10. Scorecard — Before & After, 1. Target State: What 9/10 Looks Like, 2. Gap Analysis: Score-by-Score Delta, 3. Phase 1: Foundation (Week 1–2) — Score 5.8 → 7.0, 4. Phase 2: Structural Realignment (Week 3–4) — Score 7.0 → 8.0, 5. Phase 3: Deep Integration (Week 5–6) — Score 8.0 → 8.7, 6. Phase 4: Excellence & Hardening (Week 7–10) — Score 8.7 → 9.0, 7. Migration Sequencing & Risk Matrix (+39 more)

### Community 122 - "Community 122"
Cohesion: 0.06
Nodes (38): getAuthToken(), getCurrentUser(), getEnabledOAuthProviders(), getSession(), guardSupabase(), signInWithEmail(), signInWithOAuth(), signOut() (+30 more)

### Community 124 - "Community 124"
Cohesion: 0.67
Nodes (3): Autonomous Debugging Protocol Execution Report, Bug Report: Failure Propagation Path, Research Article Pipeline Fix Plan

### Community 126 - "Community 126"
Cohesion: 0.67
Nodes (3): BM25, DiscoveryClient, freshness scoring

### Community 128 - "Community 128"
Cohesion: 0.04
Nodes (45): Background, Background, Background, Background, Background, Changes, CLAUDE.md Update, Code Change (+37 more)

### Community 129 - "Community 129"
Cohesion: 0.04
Nodes (44): Backward Compatibility, Build Order and Dependencies, Confirmed Gaps (post deep-read), Cross-Cutting Concerns, Definition of Done, Definition of Done, Definition of Done, Definition of Done (+36 more)

### Community 130 - "Community 130"
Cohesion: 0.04
Nodes (44): 🔴 CRITICAL, 🔴 CRITICAL, 🔴 CRITICAL, 🔴 CRITICAL, 🔴 CRITICAL, 🔴 CRITICAL, 🔴 CRITICAL, 🔴 CRITICAL (+36 more)

### Community 131 - "Community 131"
Cohesion: 0.67
Nodes (3): Reasoner UI Enhancements Plan, Project TODO, Truth Engine Implementation Plan

### Community 132 - "Community 132"
Cohesion: 0.04
Nodes (44): 1.1 Chat Page Monolith — Component Splitting, 1.2 Streaming Markdown Re-renders, 1.3 PhaseTimeline Re-computation, 1.4 Sidebar List Re-computation, 1. Performance & Rendering (P0 — Critical), 2.1 Accent Color is Visually Inert, 2.2 Error Color is Invisible, 2.3 Legacy Color Tokens in ChatFeed (+36 more)

### Community 133 - "Community 133"
Cohesion: 0.05
Nodes (46): Core abstractions for the Reasoner pipeline.  PhaseConfig  — per-phase LLM par, Core preset domain logic: dataclass, validation, and helpers., build_router(), cmd_list_models(), main(), CLI entry-point shim. Keeps `python main.py` working., Reasoner v2.0 Pipeline — Entry Point Reasoner  =================================, Resolve router from CLI args.     Priority: --routing > --preset > default (mult (+38 more)
...
Cohesion: 0.05
Nodes (41): Auto-Fix Patterns (No User Input Required), AUTONOMOUS DEBUGGING (Proactive Scanning + Auto-Fix), Commands, Commands, Debugging + Testing Protocol — Reasoner Project, Detection Test, Detection Test, EPISTEMIC RULES (+33 more)
...
Cohesion: 0.15
Nodes (18): LogRecord, get_correlation_id(), LogLevel, LogSource, Structured log entry in JSON format., Get current correlation ID or generate new one., Logger that outputs structured JSON logs with correlation IDs., Decorator to log execution time of async functions. (+10 more)

### Community 150 - "Community 150"
Cohesion: 0.05
Nodes (42): 1. Executive Summary, 2. Intended vs Actual Architecture, 3. Architecture Compliance Matrix, 4. Dependency Analysis, 5. AI Orchestrator Specific Review, 6. Architectural Anti-Patterns, 7. Refactoring Roadmap, 8. Confidence Assessment (+34 more)

### Community 151 - "Community 151"
Cohesion: 0.06
Nodes (68): _compute_image_hash(), describe_image(), _detect_mime_type(), _encode_image_base64(), ocr_image(), Image and document extraction utilities using vision-capable LLMs., Extract verbatim text from an image using an OCR-optimized model via OpenRouter., Extract verbatim text from an image using an OCR-optimized model via OpenRouter. (+60 more)

### Community 152 - "Community 152"
Cohesion: 0.05
Nodes (40): 1. Anthropic Models, 2. Google Models, 3. OpenAI Models, 4. Chinese Models, 5. Other Notable Models, 6. Best Models by Use Case, 7. Reasoner Integration Notes, ByteDance Seed 1.6 (+32 more)

### Community 153 - "Community 153"
Cohesion: 0.26
Nodes (24): _check_brainstorm_cluster(), _check_brainstorm_develop(), _check_brainstorm_generate(), _check_classification(), _check_context_vetting(), _check_critique(), _check_decompose_topic(), _check_decomposition() (+16 more)

### Community 180 - "Community 180"
Cohesion: 0.04
Nodes (65): _extract_json(), GateAgent, Gate Agent — Lightweight pre-flight router that decides whether a user prompt s, Return a GateDecision. Any failure falls back to pipeline., Extract the first JSON object from raw text., _extract_json(), GateAgent, Return a GateDecision. Any failure falls back to pipeline. (+57 more)

### Community 181 - "Community 181"
Cohesion: 0.04
Nodes (53): BaseSubAgent, _parse_result(), BaseSubAgent — abstract base class every HyperGate sub-agent must extend.  Each, Extract the first valid JSON object from raw LLM text., One job. One cache. One execute() call., Return the focused system prompt for this sub-agent's single task., Parse the LLM's raw text into a structured dict.         Must always return a di, Run the sub-agent; returns SubAgentOutput (never raises). (+45 more)

### Community 182 - "Community 182"
Cohesion: 0.05
Nodes (39): 0. Executive Summary, 10. Known Limitations, 11. Performance, 12. Rollout Strategy, 13. References, 1.1 Threats Addressed, 1.2 Threats NOT Addressed, 1. Threat Model (+31 more)

### Community 183 - "Community 183"
Cohesion: 0.11
Nodes (33): calculate_expression(), geocode_location(), get_discover_content(), get_stock_data(), get_weather_data(), _has_yahooquery(), _has_yfinance(), Widgets Backend Engine Provides data for smart widgets: Weather, Stocks, Calcula (+25 more)

### Community 184 - "Community 184"
Cohesion: 0.05
Nodes (37): Deferred to v3.1, Evaluation of the Original Plan, Migration Sequencing (Optimized), Optimized Plan, Phase 1: Foundation (Week 1–2) — Score 5.8 → 6.8, Phase 1 Gate, Phase 2 Gate, Phase 2: Structural Realignment (Week 3–4) — Score 6.8 → 7.5 (+29 more)

### Community 185 - "Community 185"
Cohesion: 0.05
Nodes (37): 10. Analogical (K), 11. Delphi (L), 12. CoVE — Chain-of-Verification (M), 13. SoT — Skeleton-of-Thought (N), 14. ToT — Tree-of-Thoughts (O), 15. PoT — Program-of-Thought (P), 16. Self-Discover (Q), 17. Writing (R) (+29 more)

### Community 186 - "Community 186"
Cohesion: 0.05
Nodes (36): 10. Development Quick Start, 1. System Overview, 2. Structural View, 3. Behavioral View, 4. Domain View, 5. Infrastructure View, 6. API Surface (30+ Endpoints), 7. Frontend View (Next.js 16 / React 19) (+28 more)

### Community 188 - "Community 188"
Cohesion: 0.05
Nodes (38): 10. Working with Neuro & Compression, 11. Reasoning Methods, 12. Presets & Model Routing, 13. CI/CD, 14. Commit & Pull Request Guidelines, 15. Workflow Orchestration (Agent Guidelines), 16. Task Management, 17. Core Principles (+30 more)

### Community 199 - "Community 199"
Cohesion: 0.50
Nodes (4): Register all exception handlers on the FastAPI app., Register all exception handlers on the FastAPI app., register_exception_handlers(), FastAPI
...
Cohesion: 0.33
Nodes (10): _authenticate_ws_token(), _extract_bearer_token(), pipeline_websocket(), Extract bearer token from query params or Authorization header., Authenticate a WebSocket token and return user_id if valid., WebSocket endpoint for real-time pipeline updates., WebSocket endpoint for specific pipeline., websocket_connect() (+2 more)
...
Cohesion: 0.09
Nodes (40): Get total number of subscribers., Track metrics for pipeline events., PhaseCompleted, PipelineCompleted, Phase execution completed successfully., Pipeline execution completed successfully., Lazy-load PostgreSQL symbols so asyncpg is not required at import time., Snapshot Strategy for Aggregate Performance  Periodic snapshots allow faster agg (+32 more)
...
Cohesion: 0.09
Nodes (10): ChatErrorBoundary, ChatErrorBoundaryProps, ChatErrorBoundaryState, ChatErrorBoundary, Error(), reportError(), withErrorReporting(), GlobalError() (+2 more)

### Community 206 - "Community 206"
Cohesion: 0.07
Nodes (40): Popen, _docker_available(), _import_smoke_test(), main(), _port_in_use(), print_banner(), Attempt to free a port. Returns True if freed., Attempt to free a port. Returns True if freed. (+32 more)

### Community 207 - "Community 207"
Cohesion: 0.07
Nodes (25): AEROSPACE_CONFIG, Aerospace vertical configuration for VS., LEGAL_CONFIG, Legal vertical configuration for VS., VS Two-Tier Verification Routing stage., RADIOLOGY_CONFIG, Radiology vertical configuration for VS., Verbalized Sampling configuration models and vertical registry. (+17 more)

### Community 208 - "Community 208"
Cohesion: 0.08
Nodes (31): CompressionLevel, ContextCompressor, from_extension(), Language, Neuro Compression Module Optimizes text context for LLM efficiency. Uses "Neur, Convenience helper for quick compression., smart_compress(), Enum (+23 more)

### Community 209 - "Community 209"
Cohesion: 0.10
Nodes (27): bool, str, DesignSystemGenerator, _detect_page_type(), format_ascii_box(), format_markdown(), format_master_md(), format_page_override_md() (+19 more)

### Community 210 - "Community 210"
Cohesion: 0.07
Nodes (27): Application flows module., execute_phases_dag(), PhaseFn, PhaseStep, PipelineFlow, Phase sequence registry and dispatcher for reasoning methods., A single step in a pipeline phase sequence., Registry that maps method names to ordered phase sequences. (+19 more)

### Community 211 - "Community 211"
Cohesion: 0.06
Nodes (34): 1. Fork & clone, 2. Configure environment, 3. Backend, 4. Frontend, 5. Sanity check, Before opening a PR, Branching, Bugs (+26 more)

### Community 225 - "Community 225"
Cohesion: 0.04
Nodes (56): BaseLLMProvider, complete(), LLMError, Raised when an LLM call fails after all retries., stream_complete(), BaseLLMProvider, _accumulate_tokens(), _compress_prompt_code_blocks() (+48 more)

### Community 226 - "Community 226"
Cohesion: 0.10
Nodes (28): EncryptionService, PostgreSQLEventStore, Record, _fetch_legacy_events(), _fetch_legacy_snapshots(), main(), migrate_events(), migrate_snapshots() (+20 more)

### Community 227 - "Community 227"
Cohesion: 0.03
Nodes (127): _chunk_text(), _cosine_similarity(), DocumentVectorStore, Per-session semantic vector store for uploaded documents.  Chunks uploaded file, Chunk and embed a document, writing embeddings to a JSON sidecar.          Args:, Retrieve the top-k most relevant chunks for a query.          Args:, Delete a document's vector sidecar., Split text into overlapping chunks.      Args:         text: Source text. (+119 more)

### Community 228 - "Community 228"
Cohesion: 0.19
Nodes (15): calculate_model_cost(), format_cost(), get_pricing(), _load_openrouter_pricing(), print_cost_summary(), LLM Pricing Database Tracks per-token pricing for all supported models.  Pric, Format cost in human-readable way., Print formatted cost summary.          Args:         phase_costs: {phase_name (+7 more)

### Community 229 - "Community 229"
Cohesion: 0.06
Nodes (32): 1. Run Introspection (Phase 1.1), 2. Generate Tests (Phase 1.2), 3. Inject Instrumentation (Phase 2.1), 4. Run Generated Tests, 5. Run Full CI/CD Pipeline, 📚 Additional Resources, ✅ Checklist, Coverage Gate (+24 more)

### Community 230 - "Community 230"
Cohesion: 0.15
Nodes (21): MemoryBadge(), AttachButton(), autoResize(), clearFileError(), formatFileSize(), handleDragLeave(), handleDragOver(), handleDrop() (+13 more)

### Community 231 - "Community 231"
Cohesion: 0.06
Nodes (35): 10. Build Order, 11. Anti-Patterns to Avoid, 12. Success Criteria, 1. What Prism Contributes, 2.1 Dependency Rule, 2.2 State Access Patterns, 2.3 Event Type Pattern, 2.4 Routing Roles (+27 more)

### Community 232 - "Community 232"
Cohesion: 0.03
Nodes (60): 045ed413-02ed-4a92-8eee-4a39d8e07cab, 0de94406-8233-4e62-a786-9d349c3ec2dd, 10e1a925-9d05-4e60-862b-aab21cbd2456, 1380a4ff-2814-4dc2-942b-7e85a3ef3dc6, 17600e48-e303-46fc-a7f2-d044ffd91f8c, 18763302-c9e9-478d-92c5-3f279fcc8f52, 1b020eb7-4eda-42f5-9908-18d5fc520965, 213d0102-f964-4c1a-8019-412d260115d1 (+52 more)

### Community 233 - "Community 233"
Cohesion: 0.12
Nodes (24): get_cache_stats(), _load_cache(), _prune_disk_cache(), _prune_memory_cache(), Remove oldest cache files if the directory exceeds the max size., # NOTE: This is a per-process cache. For horizontal scaling, use Redis or, Return memory cache telemetry., Simple FIFO eviction for the in-memory cache (thread-safe). (+16 more)

### Community 234 - "Community 234"
Cohesion: 0.06
Nodes (30): AddMessageParams, ApplyPatchParams, AskUserParams, CodeSearchParams, EndTurnParams, FindFilesParams, GlobParams, GravityIndexParams (+22 more)

### Community 235 - "Community 235"
Cohesion: 0.08
Nodes (35): Require a valid CSRF token on state-changing requests.      Reads the X-CSRF-Tok, Require a valid CSRF token on state-changing requests.      Reads the X-CSRF-Tok, require_csrf(), generate_csrf_token(), generate_signed_csrf_token(), _get_csrf_secret(), Backend CSRF token generation and validation.  Implements a stateless Double-S, Get the CSRF signing secret. CSRF_SECRET must be set independently of ADMIN_API_ (+27 more)

### Community 236 - "Community 236"
Cohesion: 0.13
Nodes (13): CircuitBreaker, Atomically check availability and acquire call slot if in HALF_OPEN.         Mus, Release call slot (decrement half_open_current_calls).         Must be called wi, Execute function with circuit breaker protection.                  Thread Safety, Handle successful call., Get health status for monitoring., Return True if the circuit allows a call right now.          For use by callers, Record a successful call (for manual use outside ``call()``). (+5 more)

### Community 237 - "Community 237"
Cohesion: 0.12
Nodes (26): configure_logging(), get_correlation_id(), LogLevel, LogSource, Reasoner Pipeline - Structured Logging Utilities Provides JSON-structured loggin, Structured log entry in JSON format., Set request-scoped context for structured logging (Critical Enhancement 7.3)., Get current correlation ID or generate new one. (+18 more)

### Community 239 - "Community 239"
Cohesion: 0.40
Nodes (4): fs, https, { parse }, path

### Community 249 - "Community 249"
Cohesion: 0.18
Nodes (16): calculate_model_cost(), format_cost(), get_pricing(), _load_openrouter_pricing(), ModelPricing, print_cost_summary(), Calculate cost for a single API call.          Args:         model_id: Model, Format cost in human-readable way. (+8 more)

### Community 250 - "Community 250"
Cohesion: 0.10
Nodes (17): CircuitBreaker, CircuitOpenError, CircuitState, get_circuit_breaker(), Atomically check availability and acquire call slot if in HALF_OPEN.         Mu, Release call slot (decrement half_open_current_calls).         Must be called w, Execute function with circuit breaker protection.                  Thread Safe, Handle successful call. (+9 more)

### Community 252 - "Community 252"
Cohesion: 0.11
Nodes (18): _bm25_score(), Simplified BM25-style relevance score between a query and a search result., Simplified BM25-style relevance score between a query and a search result., Gatekeeper for search results.     Rejects raw data files, code blobs, off-topi, Gatekeeper for search results.     Rejects raw data files, code blobs, off-topi, _should_include_result(), Search service port interface — implemented by search adapters in infrastructure, Port for Web Search functionality. (+10 more)

### Community 253 - "Community 253"
Cohesion: 0.13
Nodes (35): article_draft_prompt(), article_refine_prompt(), article_retrieval_plan_prompt(), article_verify_prompt(), cove_answer_prompt(), cove_answer_prompt_single(), cove_crosscheck_prompt(), cove_draft_prompt() (+27 more)

### Community 254 - "Community 254"
Cohesion: 0.07
Nodes (28): Approach: Stripe Coupons (native), Architecture Overview, Context, Critical Changes, Critical Files to Modify, Current State (what already exists), Deployment Targets, Environment Variables (production additions) (+20 more)

### Community 255 - "Community 255"
Cohesion: 0.07
Nodes (25): Per-run cancellation state management for the Reasoner API.  Encapsulates the, Check if a run is currently active (non-locking, best-effort)., Return the user_id that owns a run, or None if anonymous/not found., Return a snapshot of active run IDs., Clear all state (for test isolation)., Thread-safe / asyncio-safe store for per-run cancellation state.      Encapsul, Thread-safe / asyncio-safe store for per-run cancellation state.      Encapsul, Register a new run and return its cancel event. (+17 more)

### Community 256 - "Community 256"
Cohesion: 0.06
Nodes (33): Actual (post-refactoring — verified by import-lint), Agent Orchestration Model — 8/10, AI Orchestrator Specific Review, ALLOWED_LINEAGE: **2 entries** (down from 24), Architectural Anti-Patterns, Architectural Maturity Level: **Mature (Structured)**, Architecture Compliance Matrix, Architecture Fitness Functions (22) (+25 more)

### Community 257 - "Community 257"
Cohesion: 0.14
Nodes (11): RateLimiter, Reset sliding windows if expired., Check if request is allowed for client.                  Returns:             (a, Record a successful request (alternative to is_allowed)., Get rate limit stats for client., Reset rate limits for client., Check rate limit for an authenticated user with tier-scaled limits.         Runs, Reset all rate limits. (+3 more)

### Community 258 - "Community 258"
Cohesion: 0.12
Nodes (16): 0. Current State Audit, 1. Architecture Constraints (NON-NEGOTIABLE), 2.1 Perplexity Sonar Pro (upgrade existing), 2.2 Brave Search API, 2.3 Tavily Search + Extract, 2.4 OpenRouter `web_search` (inline search), 2. New Backend Adapters (4 total), 3. Per-Method Routing Table (+8 more)

### Community 259 - "Community 259"
Cohesion: 0.07
Nodes (28): GetHistoryEntryQuery, GetHistoryQuery, GetModelQuery, GetPipelineHistoryQuery, GetPipelineStatusQuery, GetPresetQuery, GetProviderHealthQuery, GetWidgetStateQuery (+20 more)

### Community 261 - "Community 261"
Cohesion: 0.13
Nodes (13): CircuitBreaker, CircuitState, Atomically check availability and acquire call slot if in HALF_OPEN.         Mu, Release call slot (decrement half_open_current_calls).         Must be called w, Execute function with circuit breaker protection.                  Thread Safe, Handle successful call., Return True if the circuit allows a call right now.          For use by caller, Record a successful call (for manual use outside ``call()``).          Release (+5 more)

### Community 262 - "Community 262"
Cohesion: 0.10
Nodes (9): ConsensusMapperSubAgent, ConsensusMapperSubAgent — ONE JOB: identify which points all perspectives agree, ContradictionResolverSubAgent, ContradictionResolverSubAgent — ONE JOB: find disagreements between perspectives, EvidenceWeighterSubAgent, EvidenceWeighterSubAgent — ONE JOB: score which candidate arguments have the str, ConsensusMapperSubAgent — ONE JOB: identify which points all perspectives agree, ContradictionResolverSubAgent — ONE JOB: find disagreements between perspectives (+1 more)

### Community 264 - "Community 264"
Cohesion: 0.07
Nodes (26): Alerting Rules (Prometheus), Architecture Overview, Backend Error Logging, Caddy won't start — port 80/443 in use, Database connection errors, Firewall Rules, Frontend build fails, Frontend Error Reporting (+18 more)

### Community 268 - "Community 268"
Cohesion: 0.05
Nodes (34): ASGI App Entry Point, Circuit Breaker, CQRS, Dual-Stream Frontend, Event Sourcing, Concrete implementation of workflow services., Hexagonal Architecture, HyperGate Pre-Routing (+26 more)

### Community 269 - "Community 269"
Cohesion: 0.15
Nodes (15): size(), CacheConfig, ContextChunk, cosine_similarity(), L1Cache, L2Index, l3_scan(), Neuro Cache Hierarchy L1/L2/L3 with persona-aware similarity thresholds. (+7 more)

### Community 270 - "Community 270"
Cohesion: 0.18
Nodes (6): createMockMessage(), createMockPhase(), createMockPipelineState(), createMockQuota(), MockAuthProvider(), renderWithProviders()

### Community 271 - "Community 271"
Cohesion: 0.15
Nodes (63): CandidateScored, ContextFetched, ContextVetted, DomainEvent, ErrorOccurred, from_dict(), MemoryRecalled, MemoryStored (+55 more)

### Community 272 - "Community 272"
Cohesion: 0.13
Nodes (22): _get_scraper_client(), Reasoner - Web Scraper Module Provides deep reading capabilities to fetch full p, Simple HTML to Markdown conversion., Fetch a URL and convert its content to markdown.          Args:         url: The, Scrape multiple URLs concurrently.          Args:         urls: List of URLs to, Return the shared scraper HTTP client, creating it on first call.     Thread-saf, scrape_url(), scrape_urls() (+14 more)

### Community 273 - "Community 273"
Cohesion: 0.08
Nodes (25): 1. Plan Node Default, 2. Subagent Strategy, 3. Self-Improvement Loop, 4. Verification Before Done, 5. Autonomous Bug Fixing, Building and Running, Coding Style, Commit Guidelines (+17 more)

### Community 274 - "Community 274"
Cohesion: 0.18
Nodes (13): classify_failure(), FailureType, FeedbackAction, FeedbackRouter — classify execution failures and route to repair strategies.  Pa, Route a classified failure to the appropriate repair strategy.      Args:, Classification of execution failures from #1's CodeExecutorPort., Repair paths available to the orchestrator., Result of routing a failure to a repair strategy. (+5 more)

### Community 275 - "Community 275"
Cohesion: 0.08
Nodes (26): dependencies, clsx, framer-motion, idb, lucide-react, next, next-themes, react (+18 more)

### Community 276 - "Community 276"
Cohesion: 0.10
Nodes (20): 0. Guiding thesis & the core mismatch, 1. Architectural principles this plan must respect, #1 — Executable verification for PoT & Coding (deterministic sensors), 2. Enhancement catalogue, #2 — Harness Scorecard (harness-level metrics from existing telemetry), 3. Cross-cutting concerns, #3 — Evidence-bundled epistemic labels, 4. Dependency graph & rollout sequence (+12 more)

### Community 277 - "Community 277"
Cohesion: 0.05
Nodes (71): FileChunk, FileSearchPort, _action_scrape(), _action_uploads_search(), _action_web_search(), _build_iteration_prompt(), _Citation, _cosine_similarity() (+63 more)

### Community 278 - "Community 278"
Cohesion: 0.11
Nodes (23): Verbalized Sampling brainstorming phase prompts and prompt builders.  VS (Verbal, Build the clustering + scoring prompt from the raw idea pool., Build the final synthesis prompt from developed ideas and cluster themes., Build the deep-development prompt for the selected top ideas., Build the VS idea-generation prompt for one round., vs_cluster_prompt(), vs_develop_prompt(), vs_generation_prompt() (+15 more)

### Community 279 - "Community 279"
Cohesion: 0.08
Nodes (36): main(), Neuro CLI Manage the internal memory engine., Neuro Memory Engine CLI., Return value if numeric and not NaN, else '?'., Check health and statistics., Start the memory engine server., _safe_num(), start() (+28 more)

### Community 280 - "Community 280"
Cohesion: 0.06
Nodes (33): Approach, Approach, Approach, Approach, Execution Order, Files to Touch, Files to Touch, Overview — What Remains (+25 more)

### Community 281 - "Community 281"
Cohesion: 0.06
Nodes (33): 14. Known Architecture Violations, 16.1 Token Optimization Flags, 16.2 Cascading Model Fallback (Cost Optimization), 16.3 Parallel Execution, 16.4 Preset Cost Estimates, 16. Performance & Optimization, 18.1 Multi-Tenant SaaS, 18.2 Billing Integration (+25 more)

### Community 282 - "Community 282"
Cohesion: 0.07
Nodes (63): benchmark_vs_diversity(), _measure_diversity(), float, str, Simplified diversity proxy using Jaccard distance on word sets., Return diversity ratio (VS / direct) per vertical., _semantic_distance(), VSFeatureFlags (+55 more)

### Community 283 - "Community 283"
Cohesion: 0.16
Nodes (22): Application Layer - Commands (Write Operations)  Commands represent intentions t, ClearHistoryCommand, ClearMemoryCommand, ClearPipelineCacheCommand, Command, DeleteHistoryCommand, ExecuteWidgetCommand, Command to store conversation in memory. (+14 more)

### Community 284 - "Community 284"
Cohesion: 0.17
Nodes (11): id, method, preset, problem, status, timestamp, tokens, input (+3 more)

### Community 285 - "Community 285"
Cohesion: 0.12
Nodes (14): Serialize state to dictionary., Serialize state to dictionary., Get events that haven't been persisted yet., Serialize event to dictionary for storage., Serialize event to dictionary for storage., Serialize event to dictionary for storage., Deserialize event from dictionary., Serialize event to dictionary for storage. (+6 more)

### Community 287 - "Community 287"
Cohesion: 0.25
Nodes (25): _check_brainstorm_cluster(), _check_brainstorm_develop(), _check_brainstorm_generate(), _check_classification(), _check_context_vetting(), _check_critique(), _check_decompose_topic(), _check_decomposition() (+17 more)

### Community 288 - "Community 288"
Cohesion: 0.50
Nodes (3): Serialise for API/CLI output. Not a full round-trip — read-only model., Any, str

### Community 289 - "Community 289"
Cohesion: 0.13
Nodes (24): PromotionRecord, Result of evaluating a HarnessMutation against held-out problems., Auditable record of a promoted harness mutation., ReplayResult, PromotionRecord, PromotionService, PromotionService — governed promotion of harness mutations (#4b).  Only regressi, Write an auditable JSON patch artifact to disk. (+16 more)

### Community 290 - "Community 290"
Cohesion: 0.17
Nodes (24): _get_v(), _is_debate(), _is_orchestrated(), _is_scientific(), _is_socratic(), Deep Read serializer., Serializer dedicated to the article Pre-Mortem phase (4.25)., Serializer dedicated to the article Journal Review phase (4.5). (+16 more)

### Community 291 - "Community 291"
Cohesion: 0.02
Nodes (96): Backward-compat shim — Neuro client moved to reasoner.clients., Background task handlers for periodic maintenance., Sentry initialization for FastAPI.  Critical Enhancement 7.5: traces_sample_rate, BM25 Re-ranking, track_pipeline_metrics(), Circuit Breaker Pattern, get_neuro_client(), Shared HTTP clients with connection pooling.  Reduces TCP handshake overhead for (+88 more)

### Community 292 - "Community 292"
Cohesion: 0.06
Nodes (31): 0-A: `asyncio.run()` inside async context  `[OPEN from prior plan]`, 0-B: Blocking `fitz.open()` inside async upload handler  `[NEW]`, 1-A: Assign each root module to its correct layer, 1-B: Delete dead empty files  `[NEW — trivial]`, 2-A: `core/search.py` → infrastructure import  `[OPEN from prior plan]`, 2-B: `infrastructure/billing/webhooks.py` → `application/services/billing_service`  `[NEW]`, 2-C: `infrastructure/llm/executor.py` → `application/event_bus/bus`  `[NEW]`, 3-A: Route `api/routes/context.py` through `PipelineOrchestrator` (+23 more)

### Community 293 - "Community 293"
Cohesion: 0.06
Nodes (30): 04 — Implementation Instructions (for executor LLM), Global "Do Not Change" list, TASK A1 — Secret hygiene (SEC-01R, SEC-13), TASK A2 — Dockerfile port (XS-10), TASK A3 — LOG_LEVEL wiring (XS-11), TASK A4/A5 — Workspace cleanup (TD-01), TASK B1 — Rate-limiter multi-worker guard (SEC-10), TASK B2 — CSRF enforcement in production (SEC-03) (+22 more)

### Community 294 - "Community 294"
Cohesion: 0.12
Nodes (30): _docker_available(), _import_smoke_test(), main(), _port_in_use(), print_banner(), bool, float, int (+22 more)

### Community 707 - "Community 707"
Cohesion: 0.06
Nodes (30): 0-A: `asyncio.run()` inside async context, 0-B: `sys.modules` mutation in request handler, 1-A: Remove infrastructure import from `core/search.py`, 1-B: Remove `pipeline.py` globals from application-layer flows, 2-A: Route `run-with-context` through `PipelineOrchestrator`, 2-B: Wire `RunPipelineCommandHandler` as the single execution entry point, 3-A: Extract lifespan initialization, 3-B: Extract route registration (+22 more)

### Community 708 - "Community 708"
Cohesion: 0.07
Nodes (29): 10.1 Unit Test — SQLite EventStore.prune_events_before, 10.2 Unit Test — CompactionService, 10.3 Integration Test, 10. Testing Strategy, 11. Implementation Order, 12. Rollout Notes, 13. Files Changed Summary, 1. Problem Statement (+21 more)

### Community 709 - "Community 709"
Cohesion: 0.07
Nodes (29): 1. Executive Summary, 2. Current UX State (What We Have), 3.10 "Continue Generating" for Truncated Responses, 3.11 Dark Mode Transitions & Contrast Audit, 3.12 Pre-Run Cost Estimate in Tier Toggle, 3.1 Cost & Token Transparency (Pre-Run + Post-Run), 3.2 Error Recovery & Retry In-Place, 3.3 Inline Source Citations (Perplexity-Style) (+21 more)

### Community 710 - "Community 710"
Cohesion: 0.07
Nodes (28): 1. Contrast Audit — WCAG AA Failures Found, 2. Focus States Audit — Inconsistent & Often Invisible, 3. Touch Target Audit — Multiple Elements Below 40×40px, 4. Background FX — "ThreeBackground" Is Misleading (Canvas2D, Not Three.js), 5. Tooltip Audit, 6. Typography System — Currently Ad Hoc, 7. Implementation Priority, Appendix: Contrast Calculation Formula (+20 more)

### Community 711 - "Community 711"
Cohesion: 0.13
Nodes (13): ExtractedClaim, PersuasionDefenseResult, Single taint event in the audit trail., Integration adapter between the PersuasionDefensePipeline and the     existing R, Main integration entry point. Called by Reasoner's orchestrator., Merge persuasion taints into Reasoner's existing taint chain., Apply persuasion risk penalty to Reasoner's confidence score.         Formula: a, Whether the friction gate has decided to block the output. (+5 more)

### Community 712 - "Community 712"
Cohesion: 0.16
Nodes (24): _docker_available(), _import_smoke_test(), main(), _port_in_use(), print_banner(), Attempt to free a port. Returns True if freed., Poll the backend root endpoint until it responds (any 2xx–4xx means it's up)., Start a subprocess and return the handle. (+16 more)

### Community 713 - "Community 713"
Cohesion: 0.07
Nodes (26): 1. Επισκόπηση Αρχιτεκτονικής, 2. Καθολικές Φάσεις, 3. Τυπικές Μέθοδοι, 4. Εξειδικευμένες Μέθοδοι, 5. Οδηγός Επιλογής Μεθόδου, Analogical, ARA Pipeline — Methods Documentation, Bayesian (+18 more)

### Community 721 - "Community 721"
Cohesion: 0.09
Nodes (22): ClearHistoryCommand, ClearMemoryCommand, ClearPipelineCacheCommand, Command, DeleteHistoryCommand, ExecuteWidgetCommand, Command to store conversation in memory., Command to clear memory. (+14 more)

### Community 722 - "Community 722"
Cohesion: 0.09
Nodes (21): Architecture, CLI, Commits, Conventions, Data flow, Dev (start everything), Entry points, Frontend (+13 more)

### Community 723 - "Community 723"
Cohesion: 0.08
Nodes (25): 3.1.1 Import Graph (Backend), 3.1.2 Frontend Import Graph, 3.1 Module-to-Module Dependencies, 3.2.1 Hot Path: API Run Request, 3.2.2 LLM Call Chain, 3.2.3 Neuro Recall Chain, 3.2 Function-to-Function Call Chains, 3.3.1 Problem → Solution Transformation Pipeline (+17 more)

### Community 724 - "Community 724"
Cohesion: 0.12
Nodes (20): AgentDefinition, AgentState, AgentStepContext, AgentTools, CodeAnalysisTools, FileEditingTools, GenerateN, ModelName (+12 more)

### Community 725 - "Community 725"
Cohesion: 0.10
Nodes (47): measure_pipeline(), _MockLLM, _MockNLI, Latency benchmark: VS vs baseline per deployment profile., ProviderError, Base exception for LLM provider errors., VS Claim Extraction stage — ClaimExtractionStage., VS Decomposition stage — QueryDecompositionStage. (+39 more)

### Community 726 - "Community 726"
Cohesion: 0.18
Nodes (16): _is_blocked_ip(), is_safe_url(), SSRF-safe URL validation for scraper and image downloaders.  Blocks private IP r, Resolve a hostname to IPv4 and IPv6 addresses., Check if an IP string falls into a blocked network., Return True if *url* is safe for the server to fetch.      Checks:       1. Sche, _resolve_to_ips(), bool (+8 more)

### Community 727 - "Community 727"
Cohesion: 0.14
Nodes (20): CriticDimensionScore, check_convergence(), _parse_critic_dimensions(), Iterative Critique (LLM Debate) — Phase Logic & Convergence Detection.  Author, Run the critic model — evaluate the current answer., Produce final synthesis from the complete debate trail., Returns (converged, reason)., Defensive float cast — LLM returns nested dicts for scores sometimes. (+12 more)

### Community 728 - "Community 728"
Cohesion: 0.18
Nodes (15): generate_probes_with_vs(), _LLMClient, VS Probe Generation stage — IntentConsistencyStage., Simplified semantic distance using sequence matcher (0.0=identical, 1.0=complete, _semantic_distance(), build_vs_prompt(), Returns (system_prompt, user_prompt). No string literals — all from constants., str (+7 more)

### Community 729 - "Community 729"
Cohesion: 0.08
Nodes (25): Appendix: Change Cost Formula, Gap 1: Layer Collapse in api/__init__.py, Gap 2: _cancelled_runs TOCTOU Race Condition, Gap 3: EventStore asyncio.Lock + Sync SQLite Mismatch, Gap 4: bus.py Side Effects at Import Time, Gap 5: Dead New Architecture, Phase 0: Scope Declaration, Phase 10: Validation System (+17 more)

### Community 730 - "Community 730"
Cohesion: 0.15
Nodes (19): _kill_ports(), _kill_processes(), _kill_processes_fallback(), Kill Target Processes, main(), Fallback when psutil is missing., Force-free known ports (handles Windows zombie sockets)., Stop the SearXNG container via docker compose. (+11 more)

### Community 731 - "Community 731"
Cohesion: 0.08
Nodes (25): 1.1 Create `RunStateStore` class in `src/reasoner/api/__init__.py`, 1.2 Replace module-level globals with `RunStateStore` instance, 1.3 Update all call sites in `api/__init__.py`, 1.4 Keep helper signatures unchanged, 1.5 Add `reset()` method for testing, 2.1 Test File: `tests/test_run_state_store.py` (NEW), 2.2 Test File: `tests/test_event_bus_isolation.py` (NEW), 2.3 Test File: `tests/test_event_store_concurrency.py` (NEW) (+17 more)

### Community 732 - "Community 732"
Cohesion: 0.07
Nodes (37): AuthenticationError, ConfigurationError, is_retryable(), JSONExtractionError, JSONValidationError, ModelNotFoundError, ParseError, PhaseError (+29 more)

### Community 733 - "Community 733"
Cohesion: 0.08
Nodes (24): 1. Domain imports Infrastructure, 2. API directly instantiates Pipeline, 3. Application imports API, API Layer → Application Layer, Application Layer → Domain Layer, Backend Import Graph, Bundle Size Targets, Circular Dependency Check (+16 more)

### Community 734 - "Community 734"
Cohesion: 0.08
Nodes (24): 5.1 Cost Tracking ✅, 5.2 Dynamic Model Discovery ✅, 5.3 Provider Comparison Tool ✅, 🏆 Achievement Unlocked, Created (11 files), Discovery & Comparison, 📁 Files Summary, 📋 Implementation Checklist (+16 more)

### Community 735 - "Community 735"
Cohesion: 0.08
Nodes (24): "API key for 'xyz-or' is not set", Available OpenRouter Presets, Can I Use Both?, Direct API vs OpenRouter Cost Comparison, FAQ, "JSON parsing failed", Migrating from Direct API to OpenRouter, Migration Steps (+16 more)

### Community 736 - "Community 736"
Cohesion: 0.08
Nodes (24): Anti-Patterns to Avoid, Cost Analysis, Executive Summary, Implementation Roadmap, P0.1 Engine Diversity + Suspension Recovery, P0.2 Reasoner-Side Circuit Breaker for SearXNG, P0 — Critical (Do First), P1.1 Search Result Redis Cache (+16 more)

### Community 737 - "Community 737"
Cohesion: 0.12
Nodes (16): lifespan(), Background task to update active users gauge every 60s (Critical Enhancement 7.3, Background task to update active users gauge every 60s (Critical Enhancement 7.3, Application lifespan: startup and shutdown orchestration., Application lifespan: startup and shutdown orchestration., _update_active_users_loop(), close_neuro_client(), Shared HTTP clients with connection pooling.  Reduces TCP handshake overhead f (+8 more)

### Community 738 - "Community 738"
Cohesion: 0.22
Nodes (13): _get_scraper_client(), Reasoner - Web Scraper Module Provides deep reading capabilities to fetch full p, Simple HTML to Markdown conversion., Fetch a URL and convert its content to markdown.          Args:         url: The, Scrape multiple URLs concurrently.          Args:         urls: List of URLs to, Return the shared scraper HTTP client, creating it on first call.     Thread-saf, scrape_url(), scrape_urls() (+5 more)

### Community 739 - "Community 739"
Cohesion: 0.13
Nodes (18): Admin endpoints — manual operations requiring ADMIN_API_KEY authentication., Raise 403 unless request carries a valid X-Admin-Key header., Manually trigger event store compaction.      Use ?dry_run=true to count eligibl, _require_admin(), trigger_compaction(), CompactionService, Application-layer compaction service.  Decides when to compact (age threshold, b, Prunes old events from the event store in daily batches. (+10 more)

### Community 740 - "Community 740"
Cohesion: 0.09
Nodes (22): Conclusion, Decision Matrix, Detailed Analysis, Implementation Plan, Knowledge Cutoff Comparison, Long-Term (full cross-diversity refresh), Long-Term (v3.5+), Mid-Term (add mistral-medium-3.1) (+14 more)

### Community 741 - "Community 741"
Cohesion: 0.14
Nodes (17): clean_llm_artifacts(), InputSanitizer, Reasoner Pipeline - Input Sanitization Comprehensive input validation and saniti, Check for excessive character repetition., Check for other suspicious patterns., Sanitize problem input.      Args:         problem: Problem text from user, Result of sanitization operation., Strip invisible Unicode characters and LLM-specific control tokens from     outp (+9 more)

### Community 742 - "Community 742"
Cohesion: 0.09
Nodes (21): Architecture Alignment, B-13 — SSE Generator Orphan on Client Disconnect, B-17 — Circuit Breaker In-Memory Only (No Cross-Worker State), B-18 — Token Cache: No Background Eviction (Memory Leak), Dependency Notes, Factory / Backend Pattern, Files Changed, Files Changed (+13 more)

### Community 743 - "Community 743"
Cohesion: 0.09
Nodes (21): Files Changed Summary, Implementation Order, Multi-Perspective Bug Hunt — Fix Plan, P0-A: Webhook Double-Processing on Redis Failure, P0-B: Event Bus Silently Drops Non-Critical Phase Events, P0-C: Fire-and-Forget Error Events Lose Audit Trail, P0 — Critical (Fix Before Next Deploy), P1-A: Circuit Breaker Fail-Open Propagates to All Workers (+13 more)

### Community 744 - "Community 744"
Cohesion: 0.09
Nodes (21): Completed Fixes, Contract Tests (1 test), Deployment Notes, Integration Tests (3 tests), Monitoring, Overview, Post-Deployment, Pre-Deployment Checklist (+13 more)

### Community 745 - "Community 745"
Cohesion: 0.11
Nodes (24): make_event(), Factory function to create domain events.          Automatically sets:     - eve, Factory function to create domain events.          Automatically sets:     - eve, Factory function to create domain events.          Automatically sets:     - eve, PhaseLifecycleManager, PhaseRunResult, PhaseLifecycleManager -- executes a single pipeline phase with retry, timeout,, Run phase_fn(state); raise on cancel or timeout. (+16 more)

### Community 746 - "Community 746"
Cohesion: 0.10
Nodes (20): Core Execution Fields, Core Types (`domain/core_types.py`), Critical Invariants, Data Models — Reasoner, Database Schemas, Domain Events, Domain Types, Event Factory (+12 more)

### Community 747 - "Community 747"
Cohesion: 0.24
Nodes (8): close_redis(), get_redis(), Shared Redis connection pool for all Redis-backed features., Get or create shared Redis client., Override Redis client (useful for tests)., Close the shared Redis connection pool., set_redis(), Shared Redis connection pool for all Redis-backed features.

### Community 748 - "Community 748"
Cohesion: 0.10
Nodes (19): Architecture — Reasoner (v3.0 Post-Refactor), CQRS (Command Query Responsibility Segregation), Cross-Layer Communication, Dependency Injection (implicit via application layer), Dependency Rule (Hexagonal DDD), Deployment Model, Event Sourcing, Hexagonal Architecture (Ports & Adapters) (+11 more)

### Community 749 - "Community 749"
Cohesion: 0.10
Nodes (19): Accessibility Features, API Routes (Next.js Proxies), Component Hierarchy (Visual Tree), CSRF Protection, Frontend Structure — Reasoner (Next.js 16 / React 19 / TypeScript 5), Global State (`app-store.ts`), Key Hooks (Core SSE Integration), Key Patterns (+11 more)

### Community 753 - "Community 753"
Cohesion: 0.05
Nodes (37): ═══════════════════════════════════════════════════════════════════════════════, ═══════════════════════════════════════════════════════════════════════════════, After Self-Healing Implementation, Artifact Verification, Before Self-Healing Implementation, CI/CD Commands, CI/CD Pipeline (1 file), 📊 CODEBASE ANALYSIS SUMMARY (+29 more)

### Community 756 - "Community 756"
Cohesion: 0.17
Nodes (21): parse_args(), color(), get_current_branch(), is_runtime_artifact(), main(), parse_status(), Remove stale git index.lock if present., Check if a file path matches runtime artifact patterns. (+13 more)

### Community 757 - "Community 757"
Cohesion: 0.30
Nodes (10): debate_cross_examine_prompt(), debate_judge_prompt(), debate_opening_prompt(), debate_rebuttal_prompt(), debate_cross_examine_prompt(), debate_judge_prompt(), debate_opening_prompt(), debate_rebuttal_prompt() (+2 more)

### Community 758 - "Community 758"
Cohesion: 0.07
Nodes (26): AutonomousDebugger, Critical Regression Tests, Auto-Fix Import Mismatches, Frontend Check, main(), Phase 2: Check all Python files for syntax errors., Phase 3: Verify all tests can be collected., Phase 4: Run critical regression tests. (+18 more)
...
Cohesion: 0.12
Nodes (19): _extract_base64_from_text(), _guess_image_mime(), _image_bytes_to_data_url(), _looks_like_base64_image(), _normalize_explicit_base64_image(), _normalize_image_data(), Heuristic check for raw image base64 payloads., Heuristic check for raw image base64 payloads. (+11 more)

### Community 764 - "Community 764"
Cohesion: 0.09
Nodes (25): Register a new run and return its cancel event., Clean up a run's state., Get the cancel event for a run., Signal cancellation for a run., Signal cancellation for all active runs., Cancel all active runs in Redis using SMEMBERS (O(1) per member, not SCAN)., Check if a run is currently active (non-locking, best-effort)., Return the user_id that owns a run, or None if anonymous/not found. (+17 more)

### Community 768 - "Community 768"
Cohesion: 0.10
Nodes (19): PhaseMetrics, PresetScorecard, Harness-level metrics value objects for the Code-as-Agent-Harness Scorecard (#2), Aggregated telemetry for a single phase within a preset run window.      All dur, Aggregated harness metrics for one preset over a time window., Fraction of runs with fallbacks that still completed successfully., DiagnosisFinding, DiagnosisReport (+11 more)
...
Cohesion: 0.11
Nodes (18): 1. Confirm Failure & Capture Context, 2. Diagnose Failure Class, 3. Verify Expected Output Schemas, 4. Check Common Provider Issues, 5. Verify Fix, Authentication Error, Common Mistakes, Critical Files (+10 more)

### Community 788 - "Community 788"
Cohesion: 0.18
Nodes (18): coding_assemble_prompt(), coding_generate_prompt(), coding_review_prompt(), coding_spec_prompt(), coding_tests_prompt(), Coding pipeline prompts — production-grade code generation., coding_assemble_prompt(), coding_generate_prompt() (+10 more)

### Community 789 - "Community 789"
Cohesion: 0.06
Nodes (50): get_architecture_components(), Lazy initialization of new architecture components., Lazy initialization of new architecture components., _get_pipeline_owner(), Pipeline ownership tracking — shared between API and websocket layers.  Extrac, Return the user_id that owns *pipeline_id*, or None if not tracked., Persist ownership mapping for a pipeline run., _save_pipeline_owner() (+42 more)

### Community 790 - "Community 790"
Cohesion: 0.11
Nodes (17): ENVIRONMENT.md, Alembic, async_engine_from_config, connect, dispose, get_section, Run migrations in 'online' mode with async engine., Run migrations in 'online' mode. (+9 more)

### Community 791 - "Community 791"
Cohesion: 0.14
Nodes (17): _patch_openai_platform_detection(), _perplexity_response_format(), Low-level LLM utilities: platform patches, JSON heuristics, response formatting., Windows WMI can hang indefinitely when the openai library calls     platform.sys, Heuristic: only enable structured outputs for prompts that already demand pure J, Return a permissive JSON-schema response format for compatible Perplexity models, _requests_strict_json(), Any (+9 more)

### Community 792 - "Community 792"
Cohesion: 0.14
Nodes (13): Reasoner - Event-Sourced Aggregates  Aggregates are the core transactional bou, make_event(), Factory function to create domain events.          Automatically sets:     - eve, Deserialize database row to domain event., from_dict(), is_completed(), is_failed(), is_running() (+5 more)

### Community 793 - "Community 793"
Cohesion: 0.10
Nodes (19): 1. Clone & Setup, 2. Start Everything (One Command), 3. CLI Quick Run, CLI, ⚙️ Configuration, Frontend linting, Full suite, Option 1: OpenRouter (Recommended) (+11 more)

### Community 794 - "Community 794"
Cohesion: 0.11
Nodes (16): Verbalized Sampling, DEPLOYMENT_STRATEGY.md, E2E_ENCRYPTION_RESEARCH.md, Graphify Integration.txt, monitoring/README.md, OpenRouter Integration Plan.md, UX_OPTIMIZATION_RESEARCH.md, VS.md (+8 more)

### Community 795 - "Community 795"
Cohesion: 0.11
Nodes (17): Common Mistakes, Critical: File Order & Interdependencies, Critical Files, Example: Adding "Financial" Perspective, Overview, Step 1: Edit `core/perspectives.py`, Step 2: Edit `presets.py` — Add to `_KNOWN_ROUTING_ROLES`, Step 3: Edit `models.py` — Add to `PerspectiveType` Enum (+9 more)

### Community 796 - "Community 796"
Cohesion: 0.11
Nodes (17): 1. CSS Organic Blobs, 2. Canvas Particle Mist, 3. Canvas Data Flow, 4. CSS Film Grain Noise, 5. @react-three/fiber Particle Field, 6. @react-three/fiber Wireframe Geometry, 7. CSS + Canvas Mesh Gradient, 8. GSAP Morphing Shapes (+9 more)

### Community 797 - "Community 797"
Cohesion: 0.27
Nodes (9): benchmark_vs_diversity(), main(), _measure_diversity(), Diversity benchmark: VS vs direct generation., Simplified diversity proxy using Jaccard distance on word sets., Return diversity ratio (VS / direct) per vertical., _semantic_distance(), main() (+1 more)

### Community 798 - "Community 798"
Cohesion: 0.15
Nodes (14): get_preset(), list_presets(), Return a copy of the preset., Return a copy of the preset., Return a copy of the preset., Return a copy of the preset., Return a copy of the preset., Return a copy of the preset. (+6 more)

### Community 799 - "Community 799"
Cohesion: 0.11
Nodes (18): 1.1 Repository Structure, 1.2.1 Core Logic (Domain + Application), 1.2.2 Infrastructure, 1.2.3 Interfaces (API + CLI), 1.2.4 Reasoning Runtime (Phases + Pipeline), 1.2.5 Specialized Subsystems, 1.2.6 Cross-Cutting Utilities, 1.2 Backend File Inventory & Classification (+10 more)

### Community 800 - "Community 800"
Cohesion: 0.22
Nodes (9): Any, float, Match, str, Fetch weather data from Open-Meteo., Parse Open-Meteo response., Extract location from match., Fetch weather data from Open-Meteo API. (+1 more)

### Community 801 - "Community 801"
Cohesion: 0.11
Nodes (17): 1.1 Search Infrastructure Extraction, 1.2 Preset Domain Purity, 1.3 LLM Infrastructure Relocation, 1. Goal, 2.1 Decouple PipelineState, 2.2 Layer-Specific Schemas, 2. Phase 1: Stop the Bleeding (Dependency Inversion), 3.1 Transition to Flow Strategies (+9 more)

### Community 802 - "Community 802"
Cohesion: 0.12
Nodes (17): Alembic, CQRS, Docker Compose, Event Sourcing, FastAPI, Hexagonal Architecture, HyperGate, Mixin Pattern (+9 more)
...
Cohesion: 0.12
Nodes (16): 1. Understand PipelinePreset Structure, 2. Check Validation Rules, 3. Create Preset Entry, 4. If Adding New METHOD, 5. Validate at Import Time, 6. Test Full Pipeline with New Preset, Common Mistakes, Critical Files (+8 more)

### Community 805 - "Community 805"
Cohesion: 0.12
Nodes (16): Common Mistakes & Gotchas, Critical Files, Critical Warning: JSON Extraction Will Break First, Example: Adding Cohere Provider, Overview, Step 1: Create Provider Subclass, Step 2: Register in `_REGISTRY`, Step 3: Add Provider Builder (+8 more)

### Community 806 - "Community 806"
Cohesion: 0.10
Nodes (19): 10. Analogical, 11. Coding, 12. CoVE (Chain-of-Verification), 13. ToT (Tree-of-Thoughts), 14. SoT (Skeleton-of-Thought), 15. PoT (Program-of-Thought), 16. Self-Discover, 17. Delphi (+11 more)

### Community 807 - "Community 807"
Cohesion: 0.26
Nodes (11): critique_prompt(), perspective_prompt(), stress_test_prompt(), critique_prompt(), perspective_prompt(), Verbalized-Sampling block appended to the critique prompt (premium tier)., stress_test_prompt(), _vs_hypotheses_instruction() (+3 more)

### Community 808 - "Community 808"
Cohesion: 0.12
Nodes (16): 10. THE ONE: Subtract the Obvious, Add the Meaningful, 1. DFM (Design for Manufacturability): UI Component Audit, 2. DFA (Design for Assembly): Flow Optimization, 2. ORGANIZE: Making Many Appear Fewer, 3. Digital Poka-Yoke: Error-Proofing, 3. TIME: Savings in Time feel like Simplicity, 4. LEARN: Knowledge Makes Everything Simpler, 5. DIFFERENCES: Simplicity and Complexity Need Each Other (+8 more)

### Community 809 - "Community 809"
Cohesion: 0.12
Nodes (17): devDependencies, eslint, eslint-config-next, jsdom, @playwright/test, tailwindcss, @tailwindcss/postcss, @testing-library/jest-dom (+9 more)

### Community 810 - "Community 810"
Cohesion: 0.17
Nodes (15): do_run_migrations(), Alembic environment configuration., Run migrations in 'offline' mode., Run migrations in 'online' mode with async engine., Run migrations in 'online' mode., run_async_migrations(), run_migrations_offline(), run_migrations_online() (+7 more)

### Community 811 - "Community 811"
Cohesion: 0.16
Nodes (12): _normalize_url(), _parse_freshness(), Normalize URL for deduplication.      Handles protocol, www, trailing slashes (, Normalize URL for deduplication.      Handles protocol, www, trailing slashes (, Derive a freshness score in [0, 1] from SearXNG's publishedDate field.      Re, Derive a freshness score in [0, 1] from SearXNG's publishedDate field.      Re, Fetch one page of SearXNG results and apply the quality filter.          Returns, SearXNGAdapter (+4 more)

### Community 812 - "Community 812"
Cohesion: 0.18
Nodes (14): benchmark_vs_calibration(), main(), _pearson_r(), Calibration benchmark: verbalized entropy vs uncertainty correlation., Simulate entropy vs uncertainty measurements., benchmark_vs_calibration(), main(), _pearson_r() (+6 more)

### Community 813 - "Community 813"
Cohesion: 0.27
Nodes (6): AuthenticationError, ModelNotFoundError, Requested model doesn't exist.          This error is NOT retryable - the mode, Invalid or missing API key.          This error is NOT retryable - retrying wi, int, str

### Community 814 - "Community 814"
Cohesion: 0.27
Nodes (7): Any, Match, str, Parse yahooquery data., Extract stock symbol from match., Fetch stock data from Yahoo Finance., Fetch stock data from Yahoo Finance.

### Community 815 - "Community 815"
Cohesion: 0.13
Nodes (14): 1. Executive Summary, 2. Intended vs Actual Architecture, 3. Architecture Compliance Matrix, 4. Dependency Analysis, 5. AI Orchestrator Specific Review, 6. Architectural Anti-Patterns Detected, 7. Refactoring Roadmap, 8. Confidence Assessment (+6 more)

### Community 816 - "Community 816"
Cohesion: 0.14
Nodes (14): api/__init__.py, pipeline.py, presets.py, renderer.py, resilience, stability, STRATEGY_A.md, STRATEGY_B_REFACTOR_PLAN.md (+6 more)

### Community 817 - "Community 817"
Cohesion: 0.11
Nodes (18): ANALOGICAL BUDGET, ANALOGICAL PREMIUM, Deep Research: Optimal Model Routing per Phase per Preset, DELPHI BUDGET, DELPHI PREMIUM, Model Capability Matrix, Phase: `expert`, Phase: `expert` (+10 more)

### Community 818 - "Community 818"
Cohesion: 0.13
Nodes (14): Added, Added, Added, Added, Added, Changed, Changelog, Fixed (+6 more)

### Community 819 - "Community 819"
Cohesion: 0.11
Nodes (17): 06 — Testing Gaps, 1. Missing Unit Tests — Backend (highest risk), 2. Missing Unit Tests — Frontend, 3. Missing Integration Tests, 4. Missing E2E Tests (Playwright — currently 1 spec), 5. Missing Observability Checks, Event bus (new, from this audit) — MEDIUM, Suggested sequencing (+9 more)

### Community 820 - "Community 820"
Cohesion: 0.31
Nodes (9): check_code_safety(), _check_node(), _max_tier(), AST-based code safety guard for the execution sandbox (#1).  Tiers:   SAFE — pas, Check code safety and return the safety tier.      Args:         code: Source co, Return the more restrictive tier., Check a single AST node and return its safety tier., AST (+1 more)

### Community 821 - "Community 821"
Cohesion: 0.02
Nodes (214): _cache_key(), HistoryEntry, _list_history(), List history entries, sorted by timestamp descending.      If user_id is provi, Save a history entry to disk., _save_history_entry(), get_critical_phases(), get_phase_start_models() (+206 more)

### Community 822 - "Community 822"
Cohesion: 0.17
Nodes (9): PhaseSubAgentInput, Sent by a PhaseHyperAgent to each sub-agent., Any, str, PhaseSubAgentInput, PhaseSubAgentOutput, Data models for PhaseSubAgent communication protocol.  Phase-level subagents rec, Sent by a PhaseHyperAgent to each sub-agent. (+1 more)

### Community 823 - "Community 823"
Cohesion: 0.26
Nodes (11): Startup health validation — auto-disables features when dependencies are missing, all_healthy(), _check_openrouter_key(), _check_perplexity_key(), HealthReport, Startup health validation — auto-disables features when dependencies are missing, Quick validation that the OpenRouter key is not empty and syntactically valid., Quick validation that the Perplexity key is not empty and syntactically valid. (+3 more)

### Community 824 - "Community 824"
Cohesion: 0.15
Nodes (20): Rerank memory chunks (ContextChunk objects) before compression.      Args:, Score a single document against a query using Nemotron Rerank VL via logprobs., Rerank documents using NVIDIA Nemotron Rerank VL (free, via OpenRouter)., Rerank memory chunks (ContextChunk objects) before compression.      Args:, Strip null bytes, normalize Unicode, truncate., Strip null bytes, normalize Unicode, truncate., Rerank documents via cross-encoder (Cohere via OpenRouter by default).      Args, Rerank documents via cross-encoder (Cohere via OpenRouter by default).      Ar (+12 more)

### Community 825 - "Community 825"
Cohesion: 0.17
Nodes (10): Any, AsyncClient, bool, str, DeepLClient, _get_base_url(), Quick health check by querying usage., Select the correct DeepL endpoint based on the key type. (+2 more)

### Community 826 - "Community 826"
Cohesion: 0.23
Nodes (12): delphi_aggregation_prompt(), delphi_convergence_prompt(), delphi_dissent_prompt(), delphi_round1_prompt(), delphi_round2_prompt(), delphi_aggregation_prompt(), delphi_convergence_prompt(), delphi_dissent_prompt() (+4 more)

### Community 827 - "Community 827"
Cohesion: 0.11
Nodes (17): 1. Scoring Rubric — where the 3 points come from, 2. Architectural Ground Rules (apply to every task), 3. Workstreams, 4. Sequencing & Dependencies, 5. Risk Register for the Program Itself, 6. Effort Estimate, 7. Milestone Gates & Re-scoring, 8. Score Log (+9 more)

### Community 828 - "Community 828"
Cohesion: 0.14
Nodes (13): Built on graphify — Penpax, Common commands, Full command reference, Ignoring files, Install, Learn more, Make your assistant always use the graph, Pick your platform (+5 more)

### Community 829 - "Community 829"
Cohesion: 0.17
Nodes (16): estimate_cost(), calculate_model_cost(), format_cost(), get_pricing(), _load_openrouter_pricing(), ModelPricing, print_cost_summary(), LLM Pricing Database Tracks per-token pricing for all supported models.  Pricing (+8 more)

### Community 830 - "Community 830"
Cohesion: 0.11
Nodes (18): 0. Executive Summary, 4.1 Design Patterns, 4.2 Architectural Style, 4.3 Trade-offs and Constraints, 5.1 Bottlenecks, 5.2 Single Points of Failure, 5.3 Tight Coupling Risks, 5.4 Scaling Limitations (+10 more)

### Community 831 - "Community 831"
Cohesion: 0.16
Nodes (15): PhaseQualityResult, _build_format_values(), _build_summary(), _parse_judge_response(), PhaseMonitor, Return all template substitution values derived from pipeline state., Return all template substitution values derived from pipeline state., Build a short text summary of phase output for the generic judge template. (+7 more)

### Community 832 - "Community 832"
Cohesion: 0.11
Nodes (17): 0. Pre-Flight Checklist, 1. Architecture Overview, 2. Day-by-Day Implementation Schedule, 3. File Inventory, 4. Environment Variables, 5. Design Decisions & Rationale, 6. Risk Mitigation, 7. Definition of Done (Phase 2) (+9 more)

### Community 833 - "Community 833"
Cohesion: 0.07
Nodes (70): DELETE(), POST(), POST(), POST(), POST(), POST(), POST(), API (+62 more)

### Community 834 - "Community 834"
Cohesion: 0.36
Nodes (7): pot_execute_prompt(), pot_generate_prompt(), pot_interpret_prompt(), pot_execute_prompt(), pot_generate_prompt(), PipelineState, str

### Community 835 - "Community 835"
Cohesion: 0.15
Nodes (12): 1.1. Automated Test State Isolation (Action 4.1), 1.2. Observability Strictness & Metrics (Actions 3.1, 3.2), 2.1. Graceful Decryption Failures (Actions 2.4, 2.5), 2.2. PostgreSQL Connection Resilience (Actions 1.1, 1.2), 3.1. Differentiated Queue Handling (Actions 2.1, 2.2, 2.3), 4.1. Strict Production Rate Limiting (Action 1.5), 4.2. Envelope Encryption Migration Script (Action 1.4), Phase 1: Testing & Observability Foundations (+4 more)

### Community 836 - "Community 836"
Cohesion: 0.11
Nodes (19): 2A.1 Layered Architecture, 2A.2 Module Hierarchy, 2A.3 Dependency Graph (High-Level), 2A. Structural View, 2B.1 Complete Request Lifecycle (API Path), 2B.2 CLI Request Lifecycle, 2B.3 Pipeline Internal Control Flow, 2B.4 State Management (+11 more)

### Community 837 - "Community 837"
Cohesion: 0.60
Nodes (5): sot_assemble_prompt(), sot_skeleton_prompt(), sot_solve_prompt(), PipelineState, str

### Community 838 - "Community 838"
Cohesion: 0.30
Nodes (10): bayesian_likelihood_prompt(), bayesian_posterior_prompt(), bayesian_prior_prompt(), bayesian_sensitivity_prompt(), bayesian_likelihood_prompt(), bayesian_posterior_prompt(), bayesian_prior_prompt(), bayesian_sensitivity_prompt() (+2 more)

### Community 839 - "Community 839"
Cohesion: 0.26
Nodes (9): Centralized environment-aware settings.  This is the ONLY module in the projec, cors_origins_list(), _ensure_dotenv(), internal_api_base_url(), neuro_embedding_fallbacks(), neuro_reasoning_fallbacks(), Centralized environment-aware settings.  This is the ONLY module in the project, Application settings derived from environment variables. (+1 more)
...
Cohesion: 0.21
Nodes (16): Parse JSON from an LLM response, degrading gracefully on failure.      Budget, run_coding_assemble_phase(), run_coding_generate_phase(), run_coding_review_phase(), run_coding_spec_phase(), run_coding_tests_phase(), _safe_extract_json(), _apply_promotion() (+8 more)

### Community 842 - "Community 842"
Cohesion: 0.30
Nodes (10): dialectical_antithesis_prompt(), dialectical_aufhebung_prompt(), dialectical_contradictions_prompt(), dialectical_thesis_prompt(), dialectical_antithesis_prompt(), dialectical_aufhebung_prompt(), dialectical_contradictions_prompt(), dialectical_thesis_prompt() (+2 more)

### Community 843 - "Community 843"
Cohesion: 0.30
Nodes (10): jury_critic_prompt(), jury_generator_prompt(), jury_meta_eval_prompt(), jury_verifier_prompt(), jury_critic_prompt(), jury_generator_prompt(), jury_meta_eval_prompt(), jury_verifier_prompt() (+2 more)
...
Cohesion: 0.21
Nodes (13): audit_claim_coverage_vs(), _check_overlap_with_evidence(), CoverageAuditResult, _generate_paraphrases_vs(), _LLMClient, VS Coverage Audit stage — CoverageAuditStage., Generate paraphrases of a claim using VS., Simplified overlap check: max proportion of words in any evidence sentence. (+5 more)

### Community 846 - "Community 846"
Cohesion: 0.16
Nodes (19): analyze_results(), check_searxng_health(), main(), bool, int, str, Query scientific method and verify relevant academic sources are still found., Analyze search results and return a quality report. (+11 more)
...
Cohesion: 0.19
Nodes (12): GET(), generateSignedCsrfToken(), getCsrfSecret(), signCsrfToken(), verifyCsrfToken(), REASONER_WS_HOSTS, REASONER_WS_PORTS, buildConnectSrc() (+4 more)

### Community 1268 - "Community 1268"
Cohesion: 0.29
Nodes (7): Phase 0 Classification, Phase 1 Decomposition, Phase 2 Perspectives, Phase 3 Critique, Phase 4 Stress Testing, Phase 5 Synthesis, Temperature Values

### Community 1269 - "Community 1269"
Cohesion: 0.17
Nodes (13): HarnessMutation, A governed change-contract for harness mutation (#4).      Immutable once create, HarnessMutation, check_mutation_invariants(), get_model_lab(), HarnessGuard — invariant validation for governed harness mutations (#4).  Paper, Return the training ecosystem for a model alias.      Unknown models default to, Check that a proposed mutation preserves hard invariants.      Args:         mut (+5 more)

### Community 1270 - "Community 1270"
Cohesion: 0.09
Nodes (22): Base URL for internal self-calls (e.g., Neuro endpoints from streaming)., Parse NEURO_REASONING_FALLBACK_MODELS into a list., Parse NEURO_EMBEDDING_FALLBACK_MODELS into a list., Parse CORS_ORIGINS env var into a list of origin strings., Base URL for internal self-calls (e.g., Neuro endpoints from streaming)., Parse NEURO_REASONING_FALLBACK_MODELS into a list., Base URL for internal self-calls (e.g., Neuro endpoints from streaming)., Parse NEURO_EMBEDDING_FALLBACK_MODELS into a list. (+14 more)
...
Cohesion: 0.30
Nodes (15): _count_methods(), _count_models(), _count_presets(), _count_py_files(), main(), _patch(), bool, int (+7 more)
...
Cohesion: 0.18
Nodes (10): Codebase Introspection Report, Complexity Distribution, Dead Code, Error Handling Gaps, Severity Summary, Summary, Top 20 Gaps, Top 20 Gaps (+2 more)

### Community 1275 - "Community 1275"
Cohesion: 0.18
Nodes (10): id, method, preset, problem, status, timestamp, tokens, input (+2 more)
...
Cohesion: 0.03
Nodes (119): Exception, AuthenticationError, ConfigurationError, InfrastructureError, is_retryable(), JSONExtractionError, JSONValidationError, LLMError (+111 more)
...
Cohesion: 0.33
Nodes (8): sd_adapt_prompt(), sd_implement_prompt(), sd_select_prompt(), sd_adapt_prompt(), sd_implement_prompt(), sd_select_prompt(), PipelineState, str

### Community 2692 - "Community 2692"
Cohesion: 0.17
Nodes (7): FeedbackStats, Initialize database schema., Backfill existing JSONL data if table is empty and JSONL exists., Synchronous insert. Must be called inside lock., Synchronous stats aggregation. Must be called inside lock., Aggregated feedback statistics., Get or create database connection.

### Community 2693 - "Community 2693"
Cohesion: 0.20
Nodes (9): 1.1. External Traffic, 1.2. Internal Network (Zero-Trust), 1. Data In-Transit (Network Encryption), 2.1. Cryptographic Standards, 2.2. Encrypted Data Fields, 2. Data At-Rest (Application-Layer Encryption), 3. Key Management, 4. Security Verification (+1 more)

### Community 2694 - "Community 2694"
Cohesion: 0.13
Nodes (14): API Endpoints, Architecture, ❄️ COLD — Full Archive, Configuration, Frontend Integration, 🔥 HOT — Recent Conversations (`sessions.py`), Neuro Memory Subsystem, `POST /neuro/audit` — "Check this answer..." (+6 more)

### Community 2695 - "Community 2695"
Cohesion: 0.25
Nodes (9): Neuro Session Manager The Live Wire — captures every prompt/response as it happe, A single prompt/response exchange., SessionEntry, Neuro Session Manager The Live Wire — captures every prompt/response as it happe, A single prompt/response exchange., SessionEntry, stats(), _write_entry() (+1 more)

### Community 2696 - "Community 2696"
Cohesion: 0.11
Nodes (17): Architectural Compliance Audit, Byte-identical budget path, Dependency direction check, Design, Effort, Feature flag, File changes, Integration with existing CodeExecutorPort (+9 more)

### Community 2697 - "Community 2697"
Cohesion: 0.20
Nodes (10): language, linter, type_system, repository_map, coding_conventions, concurrency_boundaries, core_modules, critical_paths (+2 more)

### Community 2698 - "Community 2698"
Cohesion: 0.20
Nodes (10): run_metadata, agent_model, repository, scope, timestamp, bug_budget, context_strategy, max_files_in_context (+2 more)

### Community 2699 - "Community 2699"
Cohesion: 0.20
Nodes (3): _NoOpMetric, Prometheus metrics for Reasoner.  Critical Enhancements: - 7.2: metrics_endpo, Stub metric that silently accepts all operations.

### Community 2700 - "Community 2700"
Cohesion: 0.20
Nodes (9): 1. Strict Provenance (Taint Tracking), 2. Source Reliability Weighting (The Authority Matrix), 3. Cross-Lab Forensic Audit, 4. Adversarial Red-Teaming (Destructive Critique), 5. Formal Logical Verification (NLI), 6. Inference-Time Compute Scaling, 7. The "Unknown" Victory (Epistemic Refusal), Implementation Status: Forensic Architecture (+1 more)

### Community 2701 - "Community 2701"
Cohesion: 0.22
Nodes (8): failure_scenarios, patches, protocol_version, root_cause_analyses, safety_gate, blocking_reasons, human_review_items, verdict

### Community 2702 - "Community 2702"
Cohesion: 0.28
Nodes (7): Distributed run state backed by Redis with in-memory fallback.  Replaces modul, Internal signal that Redis is not reachable., _RedisUnavailable, active_runs(), Distributed run state backed by Redis with in-memory fallback.  Replaces module-, Internal signal that Redis is not reachable., _RedisUnavailable

### Community 2703 - "Community 2703"
Cohesion: 0.13
Nodes (14): Configuration, Design, Downgrade Logic, Downgrade Signals, Edge Cases, Execution Order, Files Modified, Integration (+6 more)
...
Cohesion: 0.13
Nodes (14): 1. Add `MODEL_CLAUDE_HAIKU` constant, 2. Fix `neuro/config.py` fallback model paths [CRITICAL], 3. Fix `QUALITY_JUDGE_MODELS["premium"]` in constants_limits [HIGH], 4. Fix `settings.py` NEURO_REASONING_MODEL default [MEDIUM], 5. Add `"fusion"` to `PHASE_TEMPERATURES` [MEDIUM], 6. Fix deep_read token inconsistency in search_phases.py [MEDIUM], 7. Add missing phase budget entries [MEDIUM], 8. Move `TOKEN_OPTIMIZATION` flags to `Settings` [MEDIUM] (+6 more)

### Community 2706 - "Community 2706"
Cohesion: 0.22
Nodes (8): 1. Creating New Test Files, 2. Adding Test Cases to Existing Files, 3. Implementing Regression Tests, 4. Running Tests, 5. Best Practices, Reasoner Test Generator, Resources:, Workflow:

### Community 2707 - "Community 2707"
Cohesion: 0.22
Nodes (9): 6.1 System Overview, 6.2 Hexagonal Architecture Layers, 6.3 Reasoning Runtime, 6.4 Pre-Routing & Subsystems, 6.5 Cross-Cutting Utilities, 6.6 Frontend Architecture (`ui-next/`), 6.7 Data Flow Cross-Links, 6.8 Key Dependency Arrows (+1 more)

### Community 2708 - "Community 2708"
Cohesion: 0.22
Nodes (9): all_existing_interfaces_preserved, all_new_tests_pass, blast_radius_analyzed_and_contained, coding_conventions_followed, no_new_race_conditions, no_performance_regression, no_security_vulnerability_introduced, rollback_plan_documented (+1 more)
...
Cohesion: 0.22
Nodes (8): 1. PostgreSQL Encryption Blindspot Fix (Blind Indexing & Envelope Encryption), 2. Distributed Rate Limiter with Atomic Redis Lua Scripting, 3. LLM-Native Observability Integration (Event Bus to Langfuse), Execution Order, Implementation Steps:, Implementation Steps:, Implementation Steps:, Phase 5 Optimizations: Master Implementation Plan

### Community 2711 - "Community 2711"
Cohesion: 0.22
Nodes (9): scripts, build, dev, lint, start, test, test:e2e, test:e2e:ui (+1 more)

### Community 2712 - "Community 2712"
Cohesion: 0.29
Nodes (8): Audit, Strategy A, Strategy B, Strategy C, PROGRESS_TRACKER.md, OpenRouter, SaaS 9-Phase Roadmap, RunStateStore

### Community 2713 - "Community 2713"
Cohesion: 0.25
Nodes (7): Core Philosophy, Empty States, Icon Sizing, Icon Stroke Width, Images and Icons, Quick Reference: Common Mistakes, Refactoring UI Design System

### Community 2714 - "Community 2714"
Cohesion: 0.29
Nodes (6): PerspectiveDefinition, Data-driven perspective definitions for Phase 2 (Multi-Perspective Analysis).  R, Self-contained definition of one analysis perspective.      name        — matche, PerspectiveDefinition, Data-driven perspective definitions for Phase 2 (Multi-Perspective Analysis).  R, Self-contained definition of one analysis perspective.      name        — matche

### Community 2715 - "Community 2715"
Cohesion: 0.25
Nodes (3): Baseline — all PostgreSQL schema  Revision ID: df9629e72f17 Revises: Create Date, # NOTE: usage_quotas schema aligned with PostgresQuotaRepository expectations, # NOTE: usage_quotas schema aligned with PostgresQuotaRepository expectations
...
Cohesion: 0.23
Nodes (9): ClientBucket, RateLimiter, Token bucket for a client., Production rate limiter with multiple algorithms.          Features:     - To, Any, bool, float, int (+1 more)

### Community 2718 - "Community 2718"
Cohesion: 0.13
Nodes (17): get_telemetry_store(), TelemetryStore — queryable per-phase telemetry for cross-run analytics.  Store, Aggregate stats for a preset: avg cost, avg fallback rate, phase retries., Return per-phase aggregated metrics for all presets over a time window., Return fallback events grouped by preset over the time window., Return per-preset run counts (total, completed, failed) over a window., Count runs per preset that had fallbacks but still completed., Queryable per-phase telemetry for cross-run analytics. (+9 more)

### Community 2719 - "Community 2719"
Cohesion: 0.09
Nodes (30): HarnessScorecard, Complete harness scorecard for one query over a time window., EvolutionAgent, EvolutionAgent — orchestrates the five-stage evolution loop (#4).  Paper groundi, Generate HarnessMutations from diagnosis findings., Orchestrates the five-stage harness evolution loop.      Usage (from run_healing, Lazy-init all services to avoid circular imports at module level., Execute the full five-stage evolution loop.          Args:             window_da (+22 more)

### Community 2720 - "Community 2720"
Cohesion: 0.11
Nodes (17): 3. OpenRouter `web_search` Injection for LLM Calls (general), Architecture compliance, Architecture compliance, Current state, Current state, Enhancement 1: OpenRouter `web_search` for HyperGate Direct Path, Enhancement 2: Tavily Extract for Deep Read Phase, Fix: router-level parameter passthrough (+9 more)

### Community 2721 - "Community 2721"
Cohesion: 0.14
Nodes (14): Acceptance Criteria, Acceptance Criteria, Acceptance Criteria, Background, Background, Background, Implementation, Implementation (+6 more)

### Community 2722 - "Community 2722"
Cohesion: 0.25
Nodes (7): Architecture Notes, Build, Development, Environment Variables, Project Structure, Reasoner UI — Next.js Frontend, Tech Stack

### Community 2723 - "Community 2723"
Cohesion: 0.33
Nodes (4): downgrade(), execute, Add PayPal support and rename external_* columns to provider-specific names  Rev, upgrade()

### Community 2724 - "Community 2724"
Cohesion: 0.14
Nodes (13): 0. Pre-Flight Checklist, 1. Directory Structure to Create, 2. Day-by-Day Implementation Schedule, 3. Files Changed Summary, 4. Design Decisions & Rationale, 5. Risk Mitigation, 6. Handoff to Phase 2, Day 1 — Domain Entities + Event Types (+5 more)
...
Cohesion: 0.04
Nodes (77): SuggestionRequestModel, detect_topic(), extract_topic(), generate_suggestions(), generate_suggestions_async(), Smart Suggestions Engine Generates intelligent search suggestions based on parti, Async wrapper for generate_suggestions., Request for generating suggestions. (+69 more)

### Community 2727 - "Community 2727"
Cohesion: 0.29
Nodes (5): deep_research_prompt(), deep_research_prompt(), int, PipelineState, str

### Community 2728 - "Community 2728"
Cohesion: 0.43
Nodes (5): check_component(), main(), Check a component and print status., check_component(), main()

### Community 2729 - "Community 2729"
Cohesion: 0.33
Nodes (3): buildCsp(), withBundleAnalyzer(), nextConfig

### Community 2730 - "Community 2730"
Cohesion: 0.29
Nodes (6): 1. Understanding LLM Routing, 2. Strategies for Optimization, 3. Implementing Routing Changes, LLM Routing Optimizer, Resources:, Workflow:

### Community 2731 - "Community 2731"
Cohesion: 0.29
Nodes (6): 1. Creating a New Preset, 2. Modifying an Existing Preset, 3. Validating Presets, Reasoner Preset Manager, Resources:, Workflow:

### Community 2732 - "Community 2732"
Cohesion: 0.30
Nodes (10): pre_mortem_backtrack_prompt(), pre_mortem_failure_prompt(), pre_mortem_redesign_prompt(), pre_mortem_signals_prompt(), pre_mortem_backtrack_prompt(), pre_mortem_failure_prompt(), pre_mortem_redesign_prompt(), pre_mortem_signals_prompt() (+2 more)

### Community 2733 - "Community 2733"
Cohesion: 0.15
Nodes (20): enrich_problem_with_youtube(), _enrich_query(), _extract_youtube_id(), _fetch_youtube_metadata(), Search and vetting phase logic., run_context_vetting_phase(), run_deep_read_phase(), validate_evidence_coverage() (+12 more)

### Community 2734 - "Community 2734"
Cohesion: 0.29
Nodes (7): A.1 Backend (`src/reasoner/`), A.2 Frontend (`ui-next/src/`), A. Complete File Inventory, APPENDICES, B. Model Registry Summary, C. Preset Configuration Matrix, D. Event Taxonomy

### Community 2735 - "Community 2735"
Cohesion: 0.38
Nodes (4): clean_model_id(), process_presets(), clean_model_id(), process_presets()

### Community 2736 - "Community 2736"
Cohesion: 0.29
Nodes (7): Accessibility, Color, Design Audit Checklist, Hierarchy, Responsive, Spacing, Typography

### Community 2737 - "Community 2737"
Cohesion: 0.29
Nodes (7): Accessible Color Contrast, Building a Color Palette, Color, Color for UI States, Defining Colors with HSL, Don't Use Pure Black, Grays Aren't Truly Gray
...
Cohesion: 0.10
Nodes (39): build_followup_context(), build_synthesis_context(), _followup_context(), is_referential_followup(), Build a compact follow-up context block for injection into prompts.      Resul, Wrap user-controlled text in explicit delimiters., Build Prism citation block for synthesis prompts., Detect if a follow-up message refers to prior context. (+31 more)

### Community 2743 - "Community 2743"
Cohesion: 0.20
Nodes (10): cn(), getPrefersReducedMotion(), getPrefersReducedMotionServer(), subscribePrefersReducedMotion(), useMounted(), usePrefersReducedMotion(), BackgroundBlobs(), BackgroundBlobsProps (+2 more)
...
Cohesion: 0.07
Nodes (30): _get_searxng_cb(), asdict(), CircuitBreakerConfig, CircuitBreakerStats, CircuitOpenError, get_all_circuit_breakers(), get_circuit_breaker(), _get_memory_circuit_breaker() (+22 more)

### Community 2746 - "Community 2746"
Cohesion: 0.36
Nodes (6): socratic_answer_prompt(), socratic_question_prompt(), socratic_answer_prompt(), socratic_question_prompt(), PipelineState, str

### Community 2747 - "Community 2747"
Cohesion: 0.15
Nodes (10): metrics_endpoint(), Prometheus metrics endpoints (FastAPI layer).  Metric definitions are in reaso, Expose Prometheus metrics.      Critical Enhancement 7.2: generate_latest is s, generate_latest(), metrics_endpoint(), _NoOpMetric, Prometheus metrics for Reasoner.  Critical Enhancements: - 7.2: metrics_endpoint, Expose Prometheus metrics.      Critical Enhancement 7.2: generate_latest is syn (+2 more)

### Community 2748 - "Community 2748"
Cohesion: 0.26
Nodes (12): Cross-encoder reranking service for search and memory retrieval.  Supports Coh, _is_circuit_open(), Cross-encoder reranking service for search and memory retrieval.  Supports Coher, Rerank memory chunks (ContextChunk objects) before compression.      Args:, Strip null bytes, normalize Unicode, truncate., Lightweight circuit breaker based on recent failures., Rerank documents via cross-encoder (Cohere via OpenRouter by default).      Args, _record_failure() (+4 more)

### Community 2749 - "Community 2749"
Cohesion: 0.33
Nodes (6): Breakpoint Strategy, Mobile-First Patterns, Mobile-First Responsive Design, Touch Targets, Typography Scaling, Why Mobile-First

### Community 2750 - "Community 2750"
Cohesion: 0.33
Nodes (6): Button Placement, Error States, Field Grouping, Form Design Patterns, Input Styling, Label Placement

### Community 2751 - "Community 2751"
Cohesion: 0.33
Nodes (6): Font Size Scale, Font Weight Strategy, Letter Spacing, Line Height, Line Length, Typography
...
Cohesion: 0.40
Nodes (4): src/reasoner, ui-next, IndexedDB, Zustand

### Community 2754 - "Community 2754"
Cohesion: 0.40
Nodes (4): color system, component library, spacing scale, typography scale

### Community 2755 - "Community 2755"
Cohesion: 0.09
Nodes (35): CodeSafetyError, Raised when code is blocked by the safety guard., NoopExecutor, NoopExecutor — graceful degradation when sandbox is unavailable.  Returns execut, Fallback executor that returns a disabled result.      Used when the platform sa, SubprocessExecutor — sandboxed subprocess execution for PoT verification.  Runs, Execute Python code in an isolated subprocess.      Thread-safety: uses tempfile, SubprocessExecutor (+27 more)

### Community 2756 - "Community 2756"
Cohesion: 0.40
Nodes (5): UI_UX_AUDIT_AND_OPTIMIZATION_PLAN.md, background optimization, contrast failures, focus system, touch target fixes

### Community 2757 - "Community 2757"
Cohesion: 0.40
Nodes (5): UX_OPTIMIZATION.md, command palette, cost transparency, error recovery, keyboard shortcuts
...
Cohesion: 0.40
Nodes (5): callers, dependencies, shared_state, api/__init__.py, dependency_graph

### Community 2760 - "Community 2760"
Cohesion: 0.40
Nodes (5): test_results, baseline, delta, full_suite, regression_tests

### Community 2761 - "Community 2761"
Cohesion: 0.40
Nodes (5): Accessibility Beyond Contrast, Focus States, Interactive Element Sizing, Motion Sensitivity, Semantic HTML

### Community 2762 - "Community 2762"
Cohesion: 0.40
Nodes (5): Alignment, Don't Fill the Whole Width, Give Elements Room to Breathe, Grids Aren't Always the Answer, Layout

### Community 2763 - "Community 2763"
Cohesion: 0.40
Nodes (5): Color Adjustments, Dark Mode Design, Reduce Contrast, Not Invert, Saturation Shifts, Surface Hierarchy

### Community 2764 - "Community 2764"
Cohesion: 0.40
Nodes (5): De-emphasize by Reducing Contrast, Labels and Data, Semantic Color vs Visual Hierarchy, The Hierarchy Toolkit, Visual Hierarchy

### Community 2765 - "Community 2765"
Cohesion: 0.40
Nodes (5): Easing Functions, Hover Feedback, Subtle Animation & Transitions, Timing Principles, What to Animate

### Community 2766 - "Community 2766"
Cohesion: 0.40
Nodes (5): Padding Consistency, Spacing, Spacing Relationships, Spacing Scale, Start with Too Much Space

### Community 2767 - "Community 2767"
Cohesion: 0.23
Nodes (12): _check_contradictions(), CrossCandidateConflict, _NLIGate, VS Conflict Surfacing stage — ConflictSurfacingStage., Check which candidates contradict the given claim via NLI., surface_cross_candidate_conflicts(), GenerationCandidate, str (+4 more)

### Community 2768 - "Community 2768"
Cohesion: 0.40
Nodes (5): SETUP_MINDMAP.md, API Keys, fastapi, Python 3.10+, uvicorn

### Community 2769 - "Community 2769"
Cohesion: 0.50
Nodes (3): Critical project constraints, Key files, Review checklist

### Community 2770 - "Community 2770"
Cohesion: 0.50
Nodes (3): Diagnostic approach, Output format, What you know

### Community 2771 - "Community 2771"
Cohesion: 0.50
Nodes (3): Key files, Output format, Rules you must enforce

### Community 2772 - "Community 2772"
Cohesion: 0.29
Nodes (7): ModelPricing, Immutable pricing data for a model., ModelPricing, get_pricing(), Application-layer pricing service.  Wraps domain pricing with registry-aware mod, Get pricing for a model, resolving registry shorthand IDs when needed.      Trie, str

### Community 2773 - "Community 2773"
Cohesion: 0.50
Nodes (3): CRITICAL findings, HIGH findings, MEDIUM findings

### Community 2774 - "Community 2774"
Cohesion: 0.19
Nodes (13): get_phase_retry_budget(), get_phase_timeout(), get_quality_judge_model(), get_quality_judge_threshold(), Single source of truth for all hardcoded constants used across the Reasoner proj, Return the maximum number of retries allowed for a given phase., Return the LLM model to use for quality judging based on preset tier., Return the minimum score required to pass quality evaluation. (+5 more)

### Community 2775 - "Community 2775"
Cohesion: 0.28
Nodes (5): Fetch RAG-optimised context snippets via Brave's LLM Context endpoint., Any, AsyncClient, int, str

### Community 2776 - "Community 2776"
Cohesion: 0.29
Nodes (8): SynthesisWriterSubAgent — ONE JOB: write the final synthesized solution. Receiv, _fmt_contradictions(), _fmt_decomposition(), _fmt_evidence(), _fmt_list(), _fmt_stress(), SynthesisWriterSubAgent — ONE JOB: write the final synthesized solution. Receive, SynthesisWriterSubAgent

### Community 2777 - "Community 2777"
Cohesion: 0.50
Nodes (4): MCP-SERVER-GUIDE.md, MCP server, SSE transport, stdio transport

### Community 2778 - "Community 2778"
Cohesion: 0.29
Nodes (6): get_scorecard(), Telemetry API routes — read-only harness metrics., Return harness-level scorecard metrics for the last N days.      Read-only aggre, Return harness-level scorecard metrics for the last N days.      Read-only aggre, int, User

### Community 2779 - "Community 2779"
Cohesion: 0.17
Nodes (12): ActiveFrictionGate, BehavioralAuditStage, CoverageAuditStage, PersuasionDefenseConfig, PersuasionDefensePipeline, PersuasionDefenseStage, Base class for all persuasion defense stages., Measures whether extracted claims are supported by the retrieval set.     Flags (+4 more)

### Community 2780 - "Community 2780"
Cohesion: 0.50
Nodes (3): dependencies, @supabase/ssr, @supabase/supabase-js

### Community 2782 - "Community 2782"
Cohesion: 0.18
Nodes (13): BehavioralAuditReport, CoverageReport, FrictionAction, FrictionDecision, IntentConsistencyReport, PersuasionTactic, Reasoner Persuasion Defense Module ================================== Production, Output of Stage 1: CoverageAuditStage. (+5 more)

### Community 2783 - "Community 2783"
Cohesion: 0.13
Nodes (12): get_discovery_client(), get_searxng_base_url(), Reset the global discovery client. Call this if base_url changes., Reset the global discovery client. Call this if base_url changes., Return the configured SearXNG base URL., Return the configured SearXNG base URL., Get or create the shared discovery client., Get or create the shared discovery client. (+4 more)

### Community 2784 - "Community 2784"
Cohesion: 0.50
Nodes (3): preset, problem, top_k

### Community 2785 - "Community 2785"
Cohesion: 0.50
Nodes (3): b5d54c39e66671c9731b9f471e585d8262cd4f54963f0c93082d8dcf334d4c78, c336459dd0fb92f033c10d6b193d5099be818677b0b22cd98aa61e71d0730ccd, cfb30cfc72b7be56e6b121e169d4bbbb6a5117859dd1e9148cab281418e3b14a

### Community 2786 - "Community 2786"
Cohesion: 0.50
Nodes (4): Combining Shadows, Depth and Shadows, Natural Shadow Direction, Shadow Elevation System

### Community 2787 - "Community 2787"
Cohesion: 0.18
Nodes (10): _extract_json(), GateAgent, Gate Agent — Lightweight pre-flight router that decides whether a user prompt sh, Extract the first JSON object from raw text., _check_depth(), Safe JSON loading with depth limits to prevent stack exhaustion., Recursively check nesting depth of parsed JSON object., Parse JSON with a strict depth limit.      Args:         data: JSON string or by (+2 more)
...
Cohesion: 0.43
Nodes (5): Execute a standalone web search (for /api/search and streaming)., Stream web search results as a virtual single-phase pipeline.          Results, Any, int, str

### Community 2794 - "Community 2794"
Cohesion: 0.32
Nodes (5): HyperContext, Assembled by HyperGateAgent after Phase 1 completes.     Passed (as to_dict()), Serialise for injection into TieBreakerSubAgent context., Any, str

### Community 2797 - "Community 2797"
Cohesion: 0.08
Nodes (37): _contains_policy_risk_terms(), _download_image_url(), _enhance_image_prompt(), _error_matches_any(), _extract_remote_urls_from_text(), generate_images(), _heuristic_policy_safe_rewrite(), _looks_like_remote_image_url() (+29 more)

### Community 2800 - "Community 2800"
Cohesion: 0.40
Nodes (4): Trusted-proxy-aware client IP resolution.  Prevents X-Forwarded-For spoofing by, get_client_ip(), Trusted-proxy-aware client IP resolution.  Prevents X-Forwarded-For spoofing by, Resolve the actual client IP from a request.      Strategy:     1. If no trusted

### Community 2815 - "Community 2815"
Cohesion: 0.15
Nodes (12): access_count, created_at, key, last_accessed, model_id, phase, problem_hash, prompt_hash (+4 more)

### Community 2818 - "Community 2818"
Cohesion: 0.06
Nodes (35): AuditService, Audit Service — Logs query executions as domain events.  Publishes to the Even, EventBus, get_event_bus(), handle_all_events(), handle_event(), init_default_subscribers(), log_all_events() (+27 more)

### Community 2825 - "Community 2825"
Cohesion: 0.50
Nodes (3): estimate_cost(), Cost estimate endpoint — POST /api/estimate.  Estimates tokens, cost, and durati, Estimate tokens, cost, and duration for a pipeline run.
...
Cohesion: 0.33
Nodes (5): Close database connection and thread pool., Reset global event store (for testing)., Close database connection and thread pool., Reset global event store (for testing)., reset_event_store()

### Community 2875 - "Community 2875"
Cohesion: 0.13
Nodes (15): main(), Self-Healing Loop Orchestrator  This script connects the independent self-heal, Run a python script and return success., run_script(), _build_context(), export_healing_context(), Export recent telemetry to healing_context.json for static healing scripts.  Cal, Query TelemetryStore and aggregate by preset. (+7 more)

### Community 2876 - "Community 2876"
Cohesion: 0.50
Nodes (4): 9. Appendix: All Touchpoints, Data Flow, Environment Variables, File-by-File Reference

### Community 2877 - "Community 2877"
Cohesion: 0.30
Nodes (10): analogical_abstraction_prompt(), analogical_domain_search_prompt(), analogical_mapping_prompt(), analogical_transfer_prompt(), analogical_abstraction_prompt(), analogical_domain_search_prompt(), analogical_mapping_prompt(), analogical_transfer_prompt() (+2 more)

### Community 2878 - "Community 2878"
Cohesion: 0.33
Nodes (4): __getattr__(), __getattr__(), Infrastructure Persistence Package  Event storage and retrieval for event-source, Lazy-load PostgreSQL symbols so asyncpg is not required at import time.

### Community 2879 - "Community 2879"
Cohesion: 0.50
Nodes (4): `ArticlePipelineMixin._phase_article_retrieve()` (`article_pipeline.py`), Layer 2: Pipeline Mixins, `ResearchMixin._phase_research_web_search()` (`research_mixin.py`), `SearchMixin` (`search_mixin.py`)
...
Cohesion: 0.07
Nodes (74): _filter_routing(), Drop routing entries whose API key is missing; fall back to primary., Drop routing entries whose API key is missing; fall back to primary., Wrap run_stream_cached with Prometheus metrics., Wrap run_stream_cached with Prometheus metrics., Backward-compat gate: require auth when legacy API key mode is disabled., Run pipeline with optional authentication and rate limiting.      Authenticate, Backward-compat gate: require auth when legacy API key mode is disabled. (+66 more)
...
Cohesion: 0.67
Nodes (3): P1 Technical Debt Details, PHASE 4 — TECHNICAL DEBT ANALYSIS, Technical Debt Register
...
Cohesion: 0.06
Nodes (29): error_result(), _execute_impl(), Execute with error handling., success_result(), Any, bool, float, Match (+21 more)
...
Cohesion: 0.28
Nodes (4): Verbalized Sampling configuration models and vertical registry., VSVerticalConfig, VSVerticalRegistry, int

### Community 2889 - "Community 2889"
Cohesion: 0.15
Nodes (12): Adding a direct provider adapter (non-OpenRouter), Adding a new model, Architecture overview, Building a router in tests, Constants for token budgets, Diversity rules (enforced in CI `pr-architecture.yml`), Fallback chain design rules, Lab taxonomy (cross-lab diversity rule) (+4 more)

### Community 2890 - "Community 2890"
Cohesion: 0.15
Nodes (12): 1. Βασική Λίστα (`list`) — Append-Only Log, 2. `collections.deque` — Sliding Window / Ring Buffer, 3. Stack (LIFO) — Undo/Backtracking, 4. Queue (FIFO) — Task Pipeline, 5. Priority Queue — Weighted Task Scheduling, 6. Dictionary / `defaultdict` — Keyed State Store, 7. Time-Series Memory — Timestamped Events με TTL, 8. Tagged / Categorized Memory — `defaultdict[str, list]` (+4 more)

### Community 2891 - "Community 2891"
Cohesion: 0.15
Nodes (13): Acceptance Criteria, Acceptance Criteria, Acceptance Criteria, Background, Background, Background, H1 — Remove Redundant `dataclasses.fields()` Loop from All Property Setters, H3 — EventBus Graceful Drain on Shutdown (+5 more)

### Community 2892 - "Community 2892"
Cohesion: 0.15
Nodes (13): Acceptance Criteria, Acceptance Criteria, Acceptance Criteria, Background, Background, Background, E1 — Expose `EventBus` Dead-Letter Count to Health Endpoint, E2 — Replace Stale Preset Count Comment with Runtime Assertion (+5 more)

### Community 2893 - "Community 2893"
Cohesion: 0.15
Nodes (12): 1. Spoofing, 2. Tampering, 3. Repudiation, 4. Information Disclosure, 5. Denial of Service, 6. Elevation of Privilege, Open Items, Reasoner Threat Model (STRIDE) (+4 more)
...
Cohesion: 0.17
Nodes (11): 1. Write the phase prompt module, 2. Add routing role keys (if new roles needed), 3. Add presets (Budget + Premium minimum), 4. Register the method name in HyperGate, 5. Wire the orchestrator, 6. Handle PipelineState (if method needs dedicated state), 7. Write the test, Adding a Reasoning Method to Reasoner (+3 more)

### Community 2896 - "Community 2896"
Cohesion: 0.17
Nodes (11): Async test pattern, Common fixture patterns, Coverage, Mocking LLM providers, Mocking ProviderRouter, Parsing — always use extract_json, Pytest marks, Reasoner Testing Reference (+3 more)

### Community 2897 - "Community 2897"
Cohesion: 0.17
Nodes (11): Classification, Constructive, Decomposition, Destructive, Minimalist, OpenRouter Model Recommendations for ARA Pipeline, Role-Based Model Selection, Scoring (+3 more)

### Community 2898 - "Community 2898"
Cohesion: 0.17
Nodes (11): 0. Pre-Flight Checklist, 1. Architecture Overview, 2. Day-by-Day Implementation Schedule, Day 1 — Stripe Adapter, Day 2 — Webhook Handler + Router, Day 3 — Subscription Persistence + Sync, Day 4–5 — Frontend Pricing + Checkout, Day 6 — Billing Portal + Invoices (+3 more)

### Community 2899 - "Community 2899"
Cohesion: 0.17
Nodes (11): 1. What SearXNG Is, 2. Internal Architecture, 7. Failure Modes & Mitigations, Core Principles, Engine Architecture, Engine Categories, How It Differs from a Search Engine, Request Flow (+3 more)

### Community 2900 - "Community 2900"
Cohesion: 0.17
Nodes (11): Configuration, Deployment Profiles, Fallback Behavior, Feature Flags, Generation Strategies, Integration Points, Magic Numbers, Overview (+3 more)
...
Cohesion: 0.05
Nodes (60): _extract_user_id(), generic_exception_handler(), _get_error_store(), http_exception_handler(), _log_error(), Build a safe JSON error response that doesn't leak internals., Build a safe JSON error response that doesn't leak internals., Handle HTTPException (4xx, 5xx from FastAPI/Starlette). (+52 more)
...
Cohesion: 0.27
Nodes (7): Port: telemetry persistence for cross-run analytics., Queryable per-phase telemetry for cross-run analytics., TelemetryStorePort, Any, float, int, str
...
Cohesion: 0.18
Nodes (10): Fix Priority Matrix, Incident Summary, Problem 1: CRITICAL — `streaming.py` bypasses article detection entirely, Problem 2: PRIMARY — `is_article_request()` is English-only, Problem 3: SEMANTIC MISMATCH — Generic decomposition on creative writing, Problem 4: TOKEN BUDGET NOT ENFORCED, Problem 5: PHASE TIMEOUT COVERS BOTH DECOMPOSITION + VETTING, Recommended Fix: Unified Article Detection in streaming.py (+2 more)

### Community 2910 - "Community 2910"
Cohesion: 0.18
Nodes (11): 10.1 System Overview, 10.2 Architecture Explanation with Design Rationale, 10.3 Design Decision Log, 10.4 Operational Runbook, 10.5 Dependency Map + Upgrade Schedule, 10.6 Human-Flag Zones, 10.7 Onboarding Guide (Day 1 Setup), How to Debug Common Failures (+3 more)

### Community 2911 - "Community 2911"
Cohesion: 0.18
Nodes (10): Debate Pipeline Fix Plan, Fix 1 — Circular import (already applied), Fix 2 — Replace `seed-2.0-mini` in `debate-budget`, Fix 3 — Update `debate-budget` primary model, Fix 4 — Debate judge prompt: explicit `CritiqueScore` schema, Fix 5 — Richer `DEBATE_JUDGE_SYSTEM` prompt, Fix 6 — Defensive type guard in `_parse_critique_scores`, Fix 7 — Empty-rounds guard in `run_debate_judge_phase` (+2 more)

### Community 2912 - "Community 2912"
Cohesion: 0.18
Nodes (10): Core LLM, CSRF & Security, Database, Environment Variables, Neuro Memory, Other, Rate Limiting & Auth, Search (+2 more)

### Community 2913 - "Community 2913"
Cohesion: 0.18
Nodes (10): 0. Pre-Flight Checklist, 1. Architecture Overview, 2. Day-by-Day Implementation Schedule, 3. Definition of Done (Phase 3), Day 1 — Postgres Quota Repository, Day 2 — Cached Quota Repository + Redis Invalidation, Day 3 — FastAPI Dependency Integration, Day 4 — Frontend Usage Indicators (+2 more)

### Community 2914 - "Community 2914"
Cohesion: 0.18
Nodes (10): 0. Pre-Flight Checklist, 1. Architecture Overview, 2. Day-by-Day Implementation Schedule, 3. Definition of Done (Phase 5), Day 1 — Backend Dockerfile, Day 2 — Frontend Dockerfile, Day 3 — Docker Compose + Environment, Day 4 — Caddy / Nginx Reverse Proxy (+2 more)

### Community 2915 - "Community 2915"
Cohesion: 0.18
Nodes (10): 0. Pre-Flight Checklist, 1. Architecture Overview, 2. Day-by-Day Implementation Schedule, 3. Definition of Done (Phase 9), Day 1 — Redis Run State Manager, Day 2 — Migrate Pipeline to RunStateManager, Day 3 — Connection Pool Tuning, Day 4 — Database Query Optimization (+2 more)

### Community 2916 - "Community 2916"
Cohesion: 0.18
Nodes (11): 6. Reasoner Integration Map, Architecture Overview, Layer 3: API Routes, Layer 4: Widgets, Layer 5: Sub-agents, `src/reasoner/api/__init__.py`, `src/reasoner/api/routes/context.py`, `src/reasoner/infrastructure/widgets/discover.py` (+3 more)

### Community 2917 - "Community 2917"
Cohesion: 0.18
Nodes (10): 10. Living Documentation, 1. Project Overview, 3. Project Structure, 6. Working with Neuro & Compression, 7. Cross-Cutting Concerns, 8. Workflow Orchestration, 9. Core Principles, Architecture Style (+2 more)

### Community 2918 - "Community 2918"
Cohesion: 0.18
Nodes (11): 5. Key Architecture Details, Core Pipeline Flow, HyperGate Pre-Router, JSON Extraction, Key Invariants, Model Routing Philosophy, Presets (42), Presets (48) (+3 more)

### Community 2919 - "Community 2919"
Cohesion: 0.20
Nodes (9): 03 — Implementation Plan, Cross-cutting rollback strategy, Phase A — Quick Wins: configuration & hygiene (no code-path behavior change), Phase B — Safety guards (config-validation code, fail-fast at startup), Phase C — Verified bug fixes (surgical, one file each), Phase D — Reliability hardening, Phase E — Test coverage (see 06 for full specs), Phase F — Strategic improvements (separate efforts; not quick wins) (+1 more)

### Community 2920 - "Community 2920"
Cohesion: 0.20
Nodes (10): Acceptance Criteria, Acceptance Criteria, Approach, Background, Background, C1 — CQRS Alignment for the Streaming Path, C2 — Rate Limiter Startup Guard Hardening, Implementation (+2 more)

### Community 2921 - "Community 2921"
Cohesion: 0.20
Nodes (10): DEBATE BUDGET, Phase: `classification`, Phase: `constructive`, Phase: `decomposition`, Phase: `destructive`, Phase: `minimalist`, Phase: `scoring`, Phase: `stress_testing` (+2 more)

### Community 2922 - "Community 2922"
Cohesion: 0.20
Nodes (10): DEBATE PREMIUM, Phase: `classification`, Phase: `constructive`, Phase: `decomposition`, Phase: `destructive`, Phase: `minimalist`, Phase: `scoring`, Phase: `stress_testing` (+2 more)

### Community 2923 - "Community 2923"
Cohesion: 0.20
Nodes (10): ITERATIVE BUDGET, Phase: `classification`, Phase: `constructive`, Phase: `decomposition`, Phase: `destructive`, Phase: `minimalist`, Phase: `scoring`, Phase: `stress_testing` (+2 more)

### Community 2924 - "Community 2924"
Cohesion: 0.20
Nodes (10): ITERATIVE PREMIUM, Phase: `classification`, Phase: `constructive`, Phase: `decomposition`, Phase: `destructive`, Phase: `minimalist`, Phase: `scoring`, Phase: `stress_testing` (+2 more)

### Community 2925 - "Community 2925"
Cohesion: 0.20
Nodes (10): JURY BUDGET, Phase: `classification`, Phase: `constructive`, Phase: `decomposition`, Phase: `destructive`, Phase: `minimalist`, Phase: `scoring`, Phase: `stress_testing` (+2 more)

### Community 2926 - "Community 2926"
Cohesion: 0.20
Nodes (10): JURY PREMIUM, Phase: `classification`, Phase: `constructive`, Phase: `decomposition`, Phase: `destructive`, Phase: `minimalist`, Phase: `scoring`, Phase: `stress_testing` (+2 more)

### Community 2927 - "Community 2927"
Cohesion: 0.20
Nodes (10): MULTI PERSPECTIVE BUDGET, Phase: `classification`, Phase: `constructive`, Phase: `decomposition`, Phase: `destructive`, Phase: `minimalist`, Phase: `scoring`, Phase: `stress_testing` (+2 more)

### Community 2928 - "Community 2928"
Cohesion: 0.20
Nodes (10): MULTI PERSPECTIVE PREMIUM, Phase: `classification`, Phase: `constructive`, Phase: `decomposition`, Phase: `destructive`, Phase: `minimalist`, Phase: `scoring`, Phase: `stress_testing` (+2 more)

### Community 2929 - "Community 2929"
Cohesion: 0.20
Nodes (10): Phase: `classification`, Phase: `constructive`, Phase: `decomposition`, Phase: `destructive`, Phase: `minimalist`, Phase: `scoring`, Phase: `stress_testing`, Phase: `synthesis` (+2 more)
...
Cohesion: 0.20
Nodes (9): 0. Pre-Flight Checklist, 1. Day-by-Day Implementation Schedule, 2. Definition of Done (Phase 6), Day 1 — HTTPS Enforcement + HSTS, Day 2 — Secrets Management, Day 3 — Audit Logging, Day 4 — GDPR Endpoints, Day 5 — Dependency Scanning + Security Tests (+1 more)

### Community 2936 - "Community 2936"
Cohesion: 0.20
Nodes (9): 0. Pre-Flight Checklist, 1. Day-by-Day Implementation Schedule, 2. Definition of Done (Phase 7), Day 1 — Prometheus Metrics Endpoint, Day 2 — Sentry Integration, Day 3 — Structured Logging Enrichment, Day 4 — Uptime Monitoring + Alerting, Day 5 — Load Testing + Performance Baseline (+1 more)

### Community 2937 - "Community 2937"
Cohesion: 0.20
Nodes (9): 0. Pre-Flight Checklist, 1. Day-by-Day Implementation Schedule, 2. Definition of Done (Phase 8), Day 1 — Auth Pages Polish, Day 2 — Dashboard, Day 3 — Upgrade Modal, Day 4 — Premium Preset Locks, Day 5 — E2E Test + Polish (+1 more)

### Community 2938 - "Community 2938"
Cohesion: 0.20
Nodes (9): Critical Enhancements, Database Indexes, Environment Variables, Horizontal Scaling, Known Limits, Load Testing, Recommended Setup, Run State Architecture (+1 more)

### Community 2939 - "Community 2939"
Cohesion: 0.20
Nodes (9): API Keys Required, Architecture Overview, Common Commands, File Structure, Quick Start Commands, Reasoner - Setup Mindmap, Reasoning Methods, Support Files (+1 more)

### Community 2940 - "Community 2940"
Cohesion: 0.50
Nodes (4): _is_circuit_open(), Lightweight circuit breaker based on recent failures., Lightweight circuit breaker based on recent failures., bool
...
Cohesion: 0.22
Nodes (7): 1. Think Before Coding, 2. Simplicity First, 3. Surgical Changes, 4. Goal-Driven Execution, Golden Rule, RTK (Rust Token Killer) - Token-Optimized Commands, Token Savings Overview
...
Cohesion: 0.22
Nodes (8): ARA Pipeline v2.0 — Complete Project Handover Audit, Executive Summary, Failure Mode Catalog, Fixes Applied, P1 Failure Modes (No Mitigation Strategy), P1 Fixes (All Completed), P2 Fixes (All Completed), PHASE 5 — FAILURE MODE ANALYSIS

### Community 2945 - "Community 2945"
Cohesion: 0.22
Nodes (8): Backward Compatibility, Cross-Cutting Concerns, Guiding Principles, Reasoner Enhancement & Fix Plan, Rollout Order, Security Considerations, Summary Table, Testing Strategy

### Community 2946 - "Community 2946"
Cohesion: 0.22
Nodes (9): 3.1 Dependency Flow (Inward Only), 3.2 Known Violations (Documented in CLAUDE.md), 3.3 Layer Breakdown, 3. Layered Architecture (Hexagonal DDD + CQRS), API Layer (`src/reasoner/api/`), Application Layer (`src/reasoner/application/`), Core Layer (`src/reasoner/core/`), Domain Layer (`src/reasoner/domain/`) (+1 more)
...
Cohesion: 0.04
Nodes (60): Clear the outputs written by the given phase so a retry starts clean., reset_phase_state(), methods(), Registry that maps method names to rendering strategies., Register a renderer for a method., Render pipeline state using the strategy for the given method., Return all registered method names., RendererService (+52 more)
...
Cohesion: 0.25
Nodes (7): 1. k Defaults per Stage, 2. VSDeploymentProfile, 3. GenerationStrategy Default, 4. Tail Thresholds, 5. JSON Parse Error Strategy, 6. Calibration Weights, VS Constants Decisions
...
Cohesion: 0.29
Nodes (6): 01 — Executive Summary, Architectural Assessment (summary — full review in 05), Overall Health Score: **6 / 10**, Prioritized Action List, Repository Overview, Top Risks (prioritized)

### Community 2955 - "Community 2955"
Cohesion: 0.29
Nodes (6): 05 — Architecture Review, Architectural Strengths, Architectural Weaknesses, Maintainability Risks, Recommended Future Direction, Scaling Risks

### Community 2956 - "Community 2956"
Cohesion: 0.29
Nodes (6): Backend Structure — Reasoner, Core Module Dependencies, Key Metrics, LLM Provider Routing, Package Hierarchy, Phase Execution Pipeline

### Community 2957 - "Community 2957"
Cohesion: 0.29
Nodes (6): Execution, Goal, Output Parsing, Problem Statement (written to tasks/reasoner-self-analysis-prompt.txt), Reasoner Self-Analysis Plan, Verification

### Community 2958 - "Community 2958"
Cohesion: 0.29
Nodes (7): 3. Configuration (`settings.yml`), `engines`, `general`, Key Sections, `outgoing`, `search` (CRITICAL), `server`

### Community 2959 - "Community 2959"
Cohesion: 0.29
Nodes (7): 4. Docker Deployment, Environment Variables, First-Boot Timeline, Port Mapping, The CI Healthcheck Failure — Root Cause Analysis, The Reasoner's Compose File, Volume Mounts

### Community 2960 - "Community 2960"
Cohesion: 0.29
Nodes (7): 5. Search API, Example: Academic Search, Example: Code Search, Fields Consumed by Reasoner, JSON Endpoint, Query Parameters, Response Schema

### Community 2962 - "Community 2962"
Cohesion: 0.29
Nodes (7): 13.1 App Router Structure, 13.2 Client State Management, 13.3 Server State Management, 13.4 SSE Stream Handling, 13.5 Component Architecture, 13.6 Styling (Tailwind CSS v4), 13. Frontend Architecture (Next.js 16 + React 19)

### Community 2963 - "Community 2963"
Cohesion: 0.29
Nodes (7): 3.7.1 PipelineState Field Naming Convention, 3.7.2 PhaseStep Naming Convention, 3.7.3 Subagent Output Shape, 3.7.4 Prompt Template Conventions, 3.7.5 SSE Event Shape, 3.7.6 Synthesis Output Format, 3.7 Implicit Contracts

### Community 2964 - "Community 2964"
Cohesion: 0.29
Nodes (6): Commands, Conventions, Layout, Reasoner — Reasonix knowledge base, Stack, Watch out for
...
Cohesion: 0.33
Nodes (6): Circuit Breaker Configuration, Graceful Degradation Behavior, PHASE 9 — RECOVERY PLAYBOOK, Recovery Procedures for P0/P1 Failure Modes, Retry Policy, Throttling / Load Shedding

### Community 2968 - "Community 2968"
Cohesion: 0.33
Nodes (6): BAYESIAN BUDGET, Phase: `constructive`, Phase: `destructive`, Phase: `prompt_enhancement`, Phase: `scoring`, Phase: `synthesis`

### Community 2969 - "Community 2969"
Cohesion: 0.33
Nodes (6): BAYESIAN PREMIUM, Phase: `constructive`, Phase: `destructive`, Phase: `prompt_enhancement`, Phase: `scoring`, Phase: `synthesis`

### Community 2970 - "Community 2970"
Cohesion: 0.33
Nodes (6): DIALECTICAL BUDGET, Phase: `constructive`, Phase: `destructive`, Phase: `prompt_enhancement`, Phase: `scoring`, Phase: `synthesis`

### Community 2971 - "Community 2971"
Cohesion: 0.33
Nodes (6): DIALECTICAL PREMIUM, Phase: `constructive`, Phase: `destructive`, Phase: `prompt_enhancement`, Phase: `scoring`, Phase: `synthesis`

### Community 2972 - "Community 2972"
Cohesion: 0.33
Nodes (5): `alerts-reference.yml`, Current Status, Deployment, Monitoring Reference, Required Metrics

### Community 2973 - "Community 2973"
Cohesion: 0.33
Nodes (6): Layer 6: Configuration & Health, `src/reasoner/core/constants.py`, `src/reasoner/core/health_validator.py`, `src/reasoner/core/settings.py`, `src/reasoner/main.py`, `src/reasoner/start_all.py`

### Community 2974 - "Community 2974"
Cohesion: 0.33
Nodes (6): 11.1 Security (Defense in Depth), 11.2 Authentication & Authorization, 11.3 Rate Limiting, 11.4 Circuit Breaker, 11.5 CSRF Protection, 11. Cross-Cutting Concerns

### Community 2975 - "Community 2975"
Cohesion: 0.33
Nodes (6): 4.1 Architecture, 4.2 Sub-Agent Roles, 4.3 Creative Writing Fast-Path, 4.4 Real-Time Query Detection, 4.5 Fallback Behavior, 4. HyperGate Pre-Router (Request Classification)

### Community 2976 - "Community 2976"
Cohesion: 0.33
Nodes (6): 4. Commands, CLI, Development, Development Environment, Frontend, Testing

### Community 2977 - "Community 2977"
Cohesion: 0.40
Nodes (5): 1.1 System Overview, 1.2 Architecture Map, 1.3 Dependency Inventory, 1.4 API & Contract Inventory, PHASE 1 — SYSTEM RECONSTRUCTION

### Community 2978 - "Community 2978"
Cohesion: 0.40
Nodes (5): 6.1 Code Quality Scan, 6.2 Performance Issues, 6.3 Structural Issues, Code Improvements (Diff Format), PHASE 6 — CODEBASE REFINEMENT

### Community 2979 - "Community 2979"
Cohesion: 0.40
Nodes (5): 7.1 Key Metrics, 7.2 Health Triggers, 7.3 Alerting Strategy, 7.4 Distributed Tracing Plan, PHASE 7 — RUNTIME OBSERVABILITY DESIGN

### Community 2980 - "Community 2980"
Cohesion: 0.40
Nodes (5): 8.1 Deployment Strategy, 8.2 Schema Migration Safety, 8.3 Feature Flag Strategy, 8.4 Release Checklist, PHASE 8 — DEPLOYMENT & MIGRATION RISK

### Community 2981 - "Community 2981"
Cohesion: 0.40
Nodes (5): Action Items (Prioritized), CI Exit Conditions by Phase, FINAL SUMMARY, Overall Audit Result, Production Readiness Checklist

### Community 2982 - "Community 2982"
Cohesion: 0.40
Nodes (5): P1 Threats (Must fix within 48h), PHASE 3 — SECURITY THREAT MODEL, Secrets Detection, Security Threat Register, STRIDE Analysis

### Community 2983 - "Community 2983"
Cohesion: 0.40
Nodes (5): PHASE 11 — DISASTER SIMULATION, Scenario 1: Traffic Spike (10x Normal Load), Scenario 2: Primary Dependency Shutdown (Anthropic Down), Scenario 3: Network Partition (Split-Brain), Scenario 4: Malicious Input (Adversarial Traffic)

### Community 2984 - "Community 2984"
Cohesion: 0.40
Nodes (5): Acceptance Criteria, Background, H2 — User-Scope the Token Cache Key, Implementation, Note on Existing Cache Entries

### Community 2985 - "Community 2985"
Cohesion: 0.40
Nodes (5): Phase: `destructive`, Phase: `prompt_enhancement`, Phase: `scoring`, Phase: `synthesis`, PRE MORTEM BUDGET

### Community 2986 - "Community 2986"
Cohesion: 0.40
Nodes (5): Phase: `destructive`, Phase: `prompt_enhancement`, Phase: `scoring`, Phase: `synthesis`, PRE MORTEM PREMIUM

### Community 2987 - "Community 2987"
Cohesion: 0.40
Nodes (5): 8. Value to the Reasoner, Configuration Best Practices, The Optimal Architecture, When Perplexity Is Better, Why SearXNG Is Essential

### Community 2988 - "Community 2988"
Cohesion: 0.40
Nodes (5): `DiscoveryClient`, `get_search_client()` — Factory Pattern, Layer 1: Core Search (`src/reasoner/core/search.py`), `PerplexitySearchClient`, `smart_search()`

### Community 2989 - "Community 2989"
Cohesion: 0.40
Nodes (5): 12.1 Architecture, 12.2 Recall Phase, 12.3 Learn Phase, 12.4 Compression, 12. Neuro Long-Term Memory (L1/L2/L3)

### Community 2990 - "Community 2990"
Cohesion: 0.40
Nodes (5): 15.1 Backend Setup, 15.2 Frontend Setup, 15.3 Full Stack, 15.4 CLI Usage (Standalone), 15. Development Workflow & Commands

### Community 2991 - "Community 2991"
Cohesion: 0.40
Nodes (5): 17.1 Logging, 17.2 Metrics (Prometheus), 17.3 Error Tracking, 17.4 Health Checks, 17. Observability & Monitoring

### Community 2992 - "Community 2992"
Cohesion: 0.40
Nodes (5): 7.1 Tier Structure, 7.2 Preset Naming Convention, 7.3 Preset Configuration, 7.4 Key Routing Principles, 7. Preset Taxonomy (42+ Presets)

### Community 2993 - "Community 2993"
Cohesion: 0.50
Nodes (3): 02 — Findings Register, Active Findings, Refuted Findings (second-pass — do NOT implement)
...
Cohesion: 0.50
Nodes (4): Acceptance Criteria, Background, Implementation, M3 — Document or Remove the `article` Workflow Strategy

### Community 2996 - "Community 2996"
Cohesion: 0.50
Nodes (4): Acceptance Criteria, Background, Implementation, O2 — HyperGate Fast-Path Length Guard

### Community 2997 - "Community 2997"
Cohesion: 0.50
Nodes (4): Acceptance Criteria, Background, Implementation, O3 — `PipelineState.to_context_dict()` Dirty Flag

### Community 2998 - "Community 2998"
Cohesion: 0.50
Nodes (4): Acceptance Criteria, Background, E3 — Update CLAUDE.md Known Violations Section, Implementation

### Community 2999 - "Community 2999"
Cohesion: 0.50
Nodes (4): Acceptance Criteria, Background, Implementation, O4 — Add `healing/generated_tests/` to Pytest Discovery

### Community 3000 - "Community 3000"
Cohesion: 0.50
Nodes (3): Executive Summary, OpenRouter Recommendations for ARA Pipeline, Recommended Default: 'balanced' preset
...
Cohesion: 0.67
Nodes (3): check_component(), main(), Check a component and print status.
...
Cohesion: 0.50
Nodes (4): 10.1 Event Flow, 10.2 Event Types (from `core/events/domain_events.py`), 10.3 Event Store & Aggregates, 10. Event Sourcing & CQRS

### Community 3007 - "Community 3007"
Cohesion: 0.50
Nodes (4): 1.1 Repository Root, 1.2 Backend Subdirectory Tree, 1.3 Frontend Structure (`ui-next/src/`), 1. Project Structure & File Organization

### Community 3008 - "Community 3008"
Cohesion: 0.50
Nodes (4): 8.1 Model Ecosystem Coverage, 8.2 Provider Routing, 8.3 Model Selection Strategy, 8. Model Registry (100+ Models)

### Community 3009 - "Community 3009"
Cohesion: 0.50
Nodes (4): 9.1 Cache Tiers, 9.2 Executor Flow, 9.3 Cascading Routing with Quality Check, 9. LLM Executor & Caching Strategy
...
Cohesion: 0.67
Nodes (3): Assumption Table, PHASE 2 — EPISTEMIC AUDIT, Tests Required for HYPOTHESIS/UNKNOWN

### Community 3013 - "Community 3013"
Cohesion: 0.67
Nodes (3): Context Summary (Confirmed Inputs), PHASE 0 — CONTEXT INTAKE, Unknowns List
...
Cohesion: 0.67
Nodes (3): 2. Technology Stack, Backend, Frontend (`ui-next/`)
...
Cohesion: 0.28
Nodes (6): get_api_keys_status(), API key status and validation endpoints., Get status of all configured LLM provider API keys.      Returns which keys are, Pre-flight validation of API keys.      Tests each configured provider with a mi, validate_api_keys(), API key status and validation endpoints.
...
Cohesion: 0.50
Nodes (4): test_infrastructure, ci_pipeline, coverage_estimate, framework
...
Cohesion: 0.17
Nodes (12): PipelinePreset, A named routing configuration with metadata., A named routing configuration with metadata., A named routing configuration with metadata., Validate routing keys at construction time., Validate routing keys at construction time., Validate routing keys at construction time., PipelinePreset (+4 more)

### Community 3079 - "Community 3079"
Cohesion: 0.24
Nodes (10): _check_openrouter_key(), _check_perplexity_key(), HealthReport, Quick validation that the OpenRouter key is not empty and syntactically valid., Quick validation that the Perplexity key is not empty and syntactically valid., Run all health checks and return a report.      This function is idempotent — ca, validate_all(), ValidationResult (+2 more)

### Community 3080 - "Community 3080"
Cohesion: 0.18
Nodes (8): get_postgres_store(), initialize_postgres_store(), PostgreSQL Event Store  Production-grade event persistence using PostgreSQL. Sup, Initialize connection pools., Close connection pools., Get or create PostgreSQL event store., Initialize PostgreSQL event store., Initialize database schema.

### Community 3081 - "Community 3081"
Cohesion: 0.21
Nodes (10): ClientBucket, get_rate_limiter(), Production-Ready Rate Limiter Token bucket algorithm with Redis-like sliding win, # NOTE: This is a per-process singleton. For horizontal scaling, Get or create global rate limiter., Token bucket for a client., get_rate_limiter(), Production-Ready Rate Limiter Token bucket algorithm with Redis-like sliding wi (+2 more)

### Community 3082 - "Community 3082"
Cohesion: 0.21
Nodes (10): Reasoner Pipeline - Input Sanitization Comprehensive input validation and saniti, Result of sanitization operation., SanitizationResult, clean_llm_artifacts(), Reasoner Pipeline - Input Sanitization Comprehensive input validation and saniti, Result of sanitization operation., Strip invisible Unicode characters and LLM-specific control tokens from     outp, Sanitize text for logging (removes sensitive patterns). (+2 more)

### Community 3083 - "Community 3083"
Cohesion: 0.21
Nodes (10): BehavioralAuditReport, CoverageReport, FrictionDecision, IntentConsistencyReport, Output of Stage 1: CoverageAuditStage., Output of Stage 2: TacticDetectionStage., Output of Stage 3: IntentConsistencyStage., Output of Stage 4: ActiveFrictionGate. (+2 more)

### Community 3084 - "Community 3084"
Cohesion: 0.17
Nodes (8): LLMVerifier, ModelRegistry, Whether the friction gate has decided to block the output., Protocol for LLM-based verification., Registry abstraction for structured LLM calls., Any, bool, int

### Community 3085 - "Community 3085"
Cohesion: 0.20
Nodes (9): build_auto_preset(), Build a preset name from method classifier output., Build a preset name from method classifier output., Build a preset name from method classifier output., Return {env_var: is_set} for all required API keys., Return {env_var: is_set} for all required API keys., Return {env_var: is_set} for all required API keys., bool (+1 more)

### Community 3086 - "Community 3086"
Cohesion: 0.20
Nodes (9): get_all_circuit_breakers(), Get health status for monitoring., Get status of all circuit breakers., health_check(), Health check endpoint — /api/health.  Comprehensive health check for system st, Comprehensive health check endpoint., Comprehensive health check endpoint., Request (+1 more)

### Community 3087 - "Community 3087"
Cohesion: 0.18
Nodes (11): build_custom_router(), get_method_from_preset(), is_valid_preset_name(), Build a ProviderRouter from a custom role->model_id dict.     The 'primary' key, Return True if name is a known preset key., Return True if name is a known preset key., Extract method name from preset string.      First checks the preset registry, Build a ProviderRouter from a custom role->model_id dict.     The 'primary' key (+3 more)

### Community 3088 - "Community 3088"
Cohesion: 0.24
Nodes (7): InputSanitizer, Check for excessive character repetition., Check for other suspicious patterns., Sanitize problem input.      Args:         problem: Problem text from user, Comprehensive input sanitization for user-provided text., Sanitize input text.          Args:             text: Input text to sanitize, sanitize_problem()

### Community 3089 - "Community 3089"
Cohesion: 0.25
Nodes (6): EmbeddingModel, IntentConsistencyStage, Protocol for text embedding (used in intent consistency)., Detects persuasive intent instability by generating probe variants of the     ou, Generate up to N variants by substituting probe variable values., float

### Community 3090 - "Community 3090"
Cohesion: 0.42
Nodes (9): critic_evaluation_prompt(), generator_initial_prompt(), generator_revision_prompt(), _get_best_answer(), Iterative Critique (LLM Debate) — Adversarial Refinement Through Runtime Harness, synthesis_prompt(), int, PipelineState (+1 more)

### Community 3091 - "Community 3091"
Cohesion: 0.20
Nodes (7): CircuitBreakerConfig, CircuitBreakerStats, Manually reset circuit to closed state., Reset all circuit breakers., Configuration for circuit breaker behavior., Statistics for circuit breaker., reset_all_circuits()

### Community 3092 - "Community 3092"
Cohesion: 0.24
Nodes (6): NLIClassifier, Protocol for NLI-based verification (DeBERTa-v3-large in production)., Returns (label, confidence) where label ∈ {entailment, contradiction, neutral}., Two-tier persuasion detection following Reasoner's NLI-before-LLM cost ordering., Fast regex-based first pass., TacticDetectionStage

### Community 3093 - "Community 3093"
Cohesion: 0.22
Nodes (8): PhaseConfig, LLM call parameters for a single phase.     Frozen so preset overrides produce, Return a new PhaseConfig with selected fields replaced., get_preset_tier(), Return the minimum subscription tier required for a preset., Return the minimum subscription tier required for a preset., Return the minimum subscription tier required for a preset., SubscriptionTier

### Community 3094 - "Community 3094"
Cohesion: 0.31
Nodes (6): Any, Match, str, Format result for display., Extract expression from match., Evaluate mathematical expression.

### Community 3095 - "Community 3095"
Cohesion: 0.31
Nodes (6): Any, Match, str, Search using SearXNG., Extract topic from match., Fetch trending content for topic.

### Community 3096 - "Community 3096"
Cohesion: 0.31
Nodes (6): Any, int, Match, str, Extract search query from match., Search images using SearXNG.

### Community 3097 - "Community 3097"
Cohesion: 0.31
Nodes (6): Any, int, Match, str, Extract search query from match., Search videos using SearXNG.

### Community 3098 - "Community 3098"
Cohesion: 0.25
Nodes (6): Preset data registry — all declarative preset configurations., # NOTE: kimi-k2.x "code" reasoning models emit output in a separate, # NOTE: avoid kimi-k2.x "code" and glm-4.7-flash here — both are reasoning, # NOTE: avoid kimi-k2.x "code" and glm-4.7-flash here — both are reasoning, # NOTE: avoid kimi-k2.x "code" and glm-4.7-flash here — both are reasoning, Preset data registry — all declarative preset configurations.

### Community 3099 - "Community 3099"
Cohesion: 0.40
Nodes (5): _anonymize_ip(), Mask the last octet of IPv4 or last 64 bits of IPv6 for GDPR compliance (SEC-018, Sanitize PII from URLs before audit logging (Critical Enhancement 6.6)., _sanitize_url_for_audit(), str

### Community 3100 - "Community 3100"
Cohesion: 0.40
Nodes (4): Sanitize text for LLM prompts without HTML escaping.      Reuses InputSanitizer, sanitize_for_prompt(), Sanitize text for LLM prompts without HTML escaping.      Reuses InputSanitizer, sanitize_for_prompt()

### Community 3101 - "Community 3101"
Cohesion: 0.40
Nodes (5): GenerateImageRequest, generate_image_endpoint(), Generate images from a text prompt using 2 multimodal models in parallel.      A, Request, User

### Community 3102 - "Community 3102"
Cohesion: 0.50
Nodes (4): ClientErrorReport, Error reporting and admin error log endpoints.  POST /api/error-report  — clie, Accept error reports from the frontend. No auth required., report_client_error()

### Community 3103 - "Community 3103"
Cohesion: 0.50
Nodes (4): MONITORING_GUIDE.md, Grafana, Prometheus, Sentry

### Community 3104 - "Community 3104"
Cohesion: 0.50
Nodes (4): get_method_from_preset(), Extract method name from preset string., Extract method name from preset string., Extract method name from preset string.

### Community 3105 - "Community 3105"
Cohesion: 0.50
Nodes (4): _pop_writing(), Clear the outputs written by the given phase so a retry starts clean., reset_phase_state(), str

### Community 3106 - "Community 3106"
Cohesion: 0.50
Nodes (3): LLMVerifier, Protocol for LLM-based verification., int

### Community 3107 - "Community 3107"
Cohesion: 0.67
Nodes (3): get_api_keys_status(), Get status of all configured LLM provider API keys.      Returns which keys ar, User

## Ambiguous Edges - Review These
- `ASGI App Entry Point` → `Reasoner AI Reasoning Orchestrator`  [AMBIGUOUS]
  asgi.py · relation: conceptually_related_to
- `CLI Entry Point` → `Reasoner AI Reasoning Orchestrator`  [AMBIGUOUS]
  main.py · relation: conceptually_related_to
- `Start All Orchestrator` → `Reasoner AI Reasoning Orchestrator`  [AMBIGUOUS]
  start_all.py · relation: conceptually_related_to
- `_broadcast_ws` → `Circuit Breaker Pattern`  [AMBIGUOUS]
  src/reasoner/api/streaming.py · relation: conceptually_related_to
- `Dark Wooden Bookshelf with Items` → `Religious Icons on Bookshelf`  [AMBIGUOUS]
  src/reasoner/uploads/f0bec2c6-26e.jpg · relation: contains

## Knowledge Gaps
- **22257 isolated node(s):** `nodes`, `edges`, `protocol_version`, `timestamp`, `mode` (+22252 more)
...
- **What is the exact relationship between `ASGI App Entry Point` and `Reasoner AI Reasoning Orchestrator`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **What is the exact relationship between `CLI Entry Point` and `Reasoner AI Reasoning Orchestrator`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **What is the exact relationship between `Start All Orchestrator` and `Reasoner AI Reasoning Orchestrator`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **What is the exact relationship between `_broadcast_ws` and `Circuit Breaker Pattern`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **What is the exact relationship between `Dark Wooden Bookshelf with Items` and `Religious Icons on Bookshelf`?**
  _Edge tagged AMBIGUOUS (relation: contains) - confidence is low._
- **Why does `PipelineState` connect `Event Store Snapshot Tests` to `Community 2691`, `Redis & Caching`, `Community 3090`, `Community 3093`, `Chat UI Components`, `Community 277`, `Community 278`, `Community 153`, `Snapshot Tests`, `Synthesis Serialization`, `IP Anonymization & GDPR`, `Community 3105`, `Community 290`, `Community 807`, `Community 2727`, `Community 41`, `Community 43`, `Community 2732`, `Community 2733`, `Community 821`, `Community 2742`, `Community 826`, `Community 2746`, `Community 2877`, `Community 831`, `Community 834`, `Community 2755`, `Community 837`, `Community 838`, `Community 841`, `Community 842`, `Community 843`, `Community 210`, `Community 727`, `Community 745`, `Community 112`, `Community 757`, `Community 253`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `PipelineEventType` connect `Synthesis Serialization` to `Community 289`, `Community 226`, `Community 97`, `Community 100`, `Redis & Caching`, `Community 73`, `Community 106`, `Community 271`, `Community 208`, `Snapshot Tests`, `Event Store Snapshot Tests`?**
