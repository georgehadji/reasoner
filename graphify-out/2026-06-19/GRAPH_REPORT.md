# Graph Report - Reasoner  (2026-06-19)

## Corpus Check
- 2591 files · ~1,057,647 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 36445 nodes · 52334 edges · 3016 communities (2531 shown, 485 thin omitted)
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 11475 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `21a99f04`
...
## Communities (3016 total, 485 thin omitted)

### Community 0 - "Article Pipeline"
Cohesion: 0.02
Nodes (127): AmbiguityDetectorSubAgent, AmbiguityDetectorSubAgent — ONE JOB: identify what is unclear or vague in the pr, _build_prompt(), _parse_result(), PhaseSubAgent, PhaseSubAgent — abstract base class for intra-phase focused reasoning agents.  E, Accumulate token usage and cost into PipelineState., One focused reasoning task within a pipeline phase. (+119 more)

### Community 1 - "Authentication & Security"
Cohesion: 0.04
Nodes (58): FastAPI router for all billing endpoints., PayPal implementation of BillingPort for one-time and subscription payments., BillingPort, Billing Port — Abstract interface for payment providers.  Stripe is the default, Port for subscription billing operations., Return a checkout URL for the user to complete payment., Return a billing portal URL for self-service management., Idempotently sync a subscription from a provider webhook event.          Args: (+50 more)

### Community 2 - "Event Sourcing & Domain Events"
Cohesion: 0.10
Nodes (35): PhaseFailed, PipelineFailed, Phase execution failed., Pipeline execution failed., _get_pipeline_owner(), Return the user_id that owns *pipeline_id*, or None if not tracked., get_websocket_manager(), handle_websocket_message() (+27 more)

### Community 3 - "Verbalized Sampling & Benchmarks"
Cohesion: 0.21
Nodes (9): CompressionLevel, ContextCompressor, from_extension(), Language, Neuro Compression Module Optimizes text context for LLM efficiency. Uses "Neur, Convenience helper for quick compression., smart_compress(), Neuro Compression Module Optimizes text context for LLM efficiency. Uses "Neur (+1 more)

### Community 4 - "Neuro Memory & LTM"
Cohesion: 0.07
Nodes (40): ContextChunk, cosine_similarity(), L1Cache, L2Index, l3_scan(), Neuro Cache Hierarchy L1/L2/L3 with persona-aware similarity thresholds., Scan L3 (cold) memory files for relevant context.      Embeddings are cached as, size() (+32 more)

### Community 5 - "Widgets & Calculator"
Cohesion: 0.13
Nodes (45): BaseWidget, CalculatorWidget, Calculator widget for mathematical expressions.      Features:     - Basic arith, DiscoverWidget, Discover widget for trending content.          Features:     - Topic-based aggre, Extract topic from match., ImageSearchWidget, Image search widget using SearXNG.          Features:     - Visual search result (+37 more)

### Community 6 - "Next.js API Routes"
Cohesion: 0.06
Nodes (34): Persistent API key storage using SQLite (aiosqlite).  Provides durable storage f, AuthStore, Persistent API key storage using SQLite (aiosqlite).  Provides durable storage f, Retrieve a key by its hash. Returns None if not found., Increment usage_count and set last_used_at to now., Deactivate a key. Returns True if the key existed., Return all keys (for admin listing)., Convert a database row to a dict. Decrypts metadata (Phase 3: E2EE). (+26 more)

### Community 7 - "Article Detection & Styles"
Cohesion: 0.04
Nodes (62): BM25 Re-ranking, Circuit Breaker Pattern, Reasoner - Web Discovery Tool Provides internal web search capabilities for con, TestSearchFallbackBug, TestSearchFallbackBug, analyze_results(), check_searxng_health(), main() (+54 more)

### Community 8 - "Redis & Caching"
Cohesion: 0.05
Nodes (48): EventPublisher, LLMGenerationCompleted, LLM generation completed for a specific phase/role., LLM generation completed for a specific phase/role., LLM generation completed for a specific phase/role., LLM generation completed for a specific phase/role., EventPublisher, Core port: EventPublisher — decouples infrastructure from application event bus. (+40 more)

### Community 9 - "Image Generation & Encryption"
Cohesion: 0.04
Nodes (68): Sentry initialization for FastAPI.  Critical Enhancement 7.5: traces_sample_rate, track_pipeline_metrics(), _cosine_similarity(), Per-session semantic vector store for uploaded documents.  Chunks uploaded file, Compute cosine similarity between two vectors., Backfill existing JSONL data if table is empty and JSONL exists., Return a GateDecision. Any failure falls back to pipeline., Perform complete codebase scan.                  Returns:             Introspect (+60 more)

### Community 10 - "Alerting System"
Cohesion: 0.05
Nodes (58): BaseModel, ActiveFrictionGate, BehavioralAuditReport, BehavioralAuditStage, CoverageAuditStage, CoverageReport, EmbeddingModel, ExtractedClaim (+50 more)

### Community 11 - "Application Entry Points"
Cohesion: 0.19
Nodes (15): ProviderUnavailableError, Provider service is unavailable.          This error IS retryable - may be a t, list_models(), Return all model IDs grouped by ecosystem., Return all model IDs grouped by ecosystem., OpenRouterProvider, OpenRouter provider — unified access to 346+ models through single API key., ProviderUnavailableError (+7 more)

### Community 12 - "Subagent Framework"
Cohesion: 0.06
Nodes (57): audit_claim_coverage_vs(), _check_overlap_with_evidence(), _generate_paraphrases_vs(), _LLMClient, VS Coverage Audit stage — CoverageAuditStage., Generate paraphrases of a claim using VS., Simplified overlap check: max proportion of words in any evidence sentence., VS Decomposition stage — QueryDecompositionStage. (+49 more)
...
Cohesion: 0.11
Nodes (45): analogical_abstraction_prompt(), analogical_domain_search_prompt(), analogical_mapping_prompt(), analogical_transfer_prompt(), cove_answer_prompt(), cove_draft_prompt(), cove_revise_prompt(), cove_verify_prompt() (+37 more)
...
Cohesion: 0.02
Nodes (130): Fetch relevant past context from Neuro memory., Fetch relevant past context from Neuro memory., Fetch relevant past context from Neuro memory., Build a ReasonerPipeline from a PreflightDecision., Build a ReasonerPipeline from a PreflightDecision., Build a ReasonerPipeline from a PreflightDecision., Run the pipeline with the given decision. Returns final state., Run the pipeline with the given decision. Returns final state. (+122 more)
...
Cohesion: 0.04
Nodes (71): ActiveFrictionGate, BehavioralAuditReport, BehavioralAuditStage, check_weights_sum(), _cosine_similarity(), CoverageAuditStage, CoverageReport, EmbeddingModel (+63 more)
...
Cohesion: 0.08
Nodes (52): _collect_image_candidates(), _contains_policy_risk_terms(), _download_image_url(), _error_matches_any(), _extract_base64_from_text(), _extract_remote_urls_from_text(), _extract_text_from_content_parts(), _generate_image_guarded() (+44 more)
...
Cohesion: 0.04
Nodes (89): methods(), Registry that maps method names to rendering strategies., Register a renderer for a method., Render pipeline state using the strategy for the given method., Return all registered method names., RendererService, RenderStrategy, Reasoner Pipeline - Output Renderer Rich terminal display and JSON export, with (+81 more)

### Community 23 - "JSON Parsing Utilities"
Cohesion: 0.08
Nodes (108): Core abstractions for the Reasoner pipeline.  PhaseConfig  — per-phase LLM par, Enum, LLMExecutor, DecompositionHyperAgent, EnhancementHyperAgent, Orchestrates parallel search subagents., Orchestrates parallel synthesis subagents and produces FinalSolution., SynthesisHyperAgent (+100 more)
...
Cohesion: 0.04
Nodes (176): Execute the reasoning pipeline., ParseError, Raised when LLM response cannot be parsed into expected structure., PhaseResult, How temperature should adapt on retry., Immutable record of one phase's execution.     Accumulated in PipelineState.pha, TemperatureStrategy, CriticScore (+168 more)

### Community 28 - "IP Anonymization & GDPR"
Cohesion: 0.04
Nodes (68): SaaS Router — All new SaaS-related API endpoints.  This router is mounted in api, Backward-compat shim — serializers moved to application/services/serializers.py., _extract_json(), MemoryEventType, get_architecture_components(), _anonymize_ip(), Mask the last octet of IPv4 or last 64 bits of IPv6 for GDPR compliance (SEC-018, Sanitize PII from URLs before audit logging (Critical Enhancement 6.6). (+60 more)

### Community 29 - "Quality Gates"
Cohesion: 0.03
Nodes (85): check_rate_limit(), _get_auth_manager_instance_auth_deps(), get_client_id(), _get_rate_limiter_instance_auth_deps(), optional_auth(), Require valid API key authentication.     Raises HTTPException if authentication, Require valid API key authentication.     Raises HTTPException if authentication, Optional authentication - returns API key if provided, None otherwise. (+77 more)

### Community 30 - "Event Store Snapshot Tests"
Cohesion: 0.02
Nodes (85): PipelineState, Get condensed decomposition summary for token efficiency., Get condensed decomposition summary for token efficiency., Get condensed candidates summary for token efficiency., Serialize complete state to dictionary (for persistence)., Save state to JSON file.                  Args:             path: File path t, Save state to JSON file.                  Args:             path: File path t, Load state from JSON file.                  Args:             path: File path (+77 more)

### Community 31 - "Frontend Phase Tests"
Cohesion: 0.38
Nodes (8): Authentication and rate-limiting FastAPI dependencies., check_rate_limit(), _get_auth_manager_instance_auth_deps(), get_client_id(), _get_rate_limiter_instance_auth_deps(), optional_auth(), Authentication and rate-limiting FastAPI dependencies., require_auth()

### Community 32 - "Event Store Count Tests"
Cohesion: 0.07
Nodes (118): app, Scope, ErrorEntry, Single error occurrence with full context., LLMError, RateLimitError, Base exception for LLM errors., Rate limit exceeded.          This error IS retryable after the specified dela (+110 more)

### Community 33 - "Event Store List Tests"
Cohesion: 0.04
Nodes (88): create_checkout(), create_portal(), _get_paypal_service(), _get_stripe_service(), get_subscription(), paypal_webhook(), Public endpoint for Stripe webhooks., Public endpoint for PayPal webhooks. (+80 more)

### Community 34 - "Pricing & Cost Estimation"
Cohesion: 0.05
Nodes (97): Reset all usage_quotas at month start. Called by external scheduler., reset_all_quotas_monthly(), check_preset_access(), check_quota(), check_quota_if_authenticated(), check_rate_limit(), _ensure_user_in_db(), get_current_user() (+89 more)
...
Cohesion: 0.10
Nodes (20): get_auth_adapter(), Auth adapter factory.  Selects the appropriate auth adapter based on environment, Get or create the global auth adapter., Override the auth adapter (useful for tests)., set_auth_adapter(), LocalAuthAdapter, Development auth adapter using local HS256 JWT.      Generates and validates tok, Create a local JWT for testing. (+12 more)

### Community 37 - "Event Store Save Tests"
Cohesion: 0.03
Nodes (124): _bm25_score(), _get_build_provider(), _normalize_url(), _parse_freshness(), Normalize URL for deduplication.      Handles protocol, www, trailing slashes (, Normalize URL for deduplication.      Handles protocol, www, trailing slashes (, Simplified BM25-style relevance score between a query and a search result., Simplified BM25-style relevance score between a query and a search result. (+116 more)

### Community 38 - "Chat Components & Hooks"
Cohesion: 0.06
Nodes (80): get_phase_retry_budget(), get_phase_timeout(), get_quality_judge_model(), get_quality_judge_threshold(), Single source of truth for all hardcoded constants used across the Reasoner proj, Return the maximum number of retries allowed for a given phase., Return the LLM model to use for quality judging based on preset tier., Return the minimum score required to pass quality evaluation. (+72 more)
...
Cohesion: 0.03
Nodes (114): _cache_key(), _load_cache(), _prune_memory_cache(), Simple FIFO eviction for the in-memory cache (thread-safe)., _save_cache(), HistoryEntry, _list_history(), List history entries, sorted by timestamp descending.      If user_id is provi (+106 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (102): extract_json(), Extract JSON object (dict) from LLM response.     Raises ParseError if no objec, Article writing pipeline phase logic., run_article_adversarial_verify_phase(), run_article_draft_phase(), run_article_refine_phase(), run_article_retrieve_sources_phase(), Brainstorming phase logic. (+94 more)
...
Cohesion: 0.15
Nodes (18): SearchServicePort, classify_query(), PrismClassification, Prism query classifier — ports Prism's classifier.ts to Python., Classify a query via a cheap LLM call.      Returns a PrismClassification withou, PipelineState, str, WorkflowServices (+10 more)
...
Cohesion: 0.10
Nodes (39): list_widgets(), List all available widgets., Any, float, int, str, Widget, WidgetDetectionResult (+31 more)
...
Cohesion: 0.08
Nodes (32): _extract_user_id(), generic_exception_handler(), _get_error_store(), http_exception_handler(), _log_error(), Global Exception Handlers for FastAPI  Captures all unhandled exceptions, HTTP e, Build a safe JSON error response that doesn't leak internals., Handle HTTPException (4xx, 5xx from FastAPI/Starlette). (+24 more)
...
Cohesion: 0.08
Nodes (17): EncryptionService, generate_key(), get_encryption_service(), Encryption Service for Data at Rest (Phase 3: E2EE)  Provides AES-256-GCM encr, Get or create global EncryptionService instance (Thread-safe)., Handles symmetric encryption and decryption for sensitive data at rest., Initialize with one or more keys.         The first key in the list is used for, Encrypt data and return a URL-safe base64 encoded string. (+9 more)
...
Cohesion: 0.03
Nodes (79): ChatFeedMessage, ChatFeedProps, ContinueButton(), MessageActions(), RenderedPhase, ChatMessage, ChatMessageProps, MemoryBadge() (+71 more)
...
Cohesion: 0.10
Nodes (58): Reasoner - Event-Sourced Aggregates  Aggregates are the core transactional bou, asdict(), Simple asdict replacement for dataclasses., CandidateScored, ContextFetched, ContextVetted, PerspectiveGenerated, PhaseStarted (+50 more)
...
Cohesion: 0.04
Nodes (51): Badge(), CalculationWidget(), ChatFeedComponent(), handleCopy(), handler(), CommandItem, CommandPalette(), CommandPaletteProps (+43 more)
...
Cohesion: 0.10
Nodes (36): BiasCritiqueSubAgent, CounterfactualSubAgent, EvidenceCritiqueSubAgent, CritiqueHyperAgent, Aggregate subagent findings into per-candidate CritiqueScore objects., Index a list of dicts by perspective name., Orchestrates parallel critique subagents and produces CritiqueScore list., LogicCritiqueSubAgent (+28 more)

### Community 74 - "Community 74"
Cohesion: 0.04
Nodes (58): run_stream_cached, _ser_5, ArticlePipelineMixin, BrainstormingMixin, CodingMixin, CognitiveMixin, get_token_budget(), Get token budget for a specific role/phase. (+50 more)
...
Cohesion: 0.09
Nodes (26): configure_logging(), LogLevel, LogSource, Reasoner Pipeline - Structured Logging Utilities Provides JSON-structured loggin, Structured log entry in JSON format., Set request-scoped context for structured logging (Critical Enhancement 7.3)., Set correlation ID for current context., Decorator to log execution time of async functions. (+18 more)
...
Cohesion: 0.07
Nodes (43): APIRouter, Lock, get_persona(), NeuroConfig, PersonaConfig, AuditRequest, AuditResponse, build_audit_system_prompt() (+35 more)

### Community 80 - "Community 80"
Cohesion: 0.03
Nodes (79): AttachmentRef, ContextAnalysisRequest, GenerateImageRequest, Pydantic request/response schemas for the Reasoner API., Request model for image generation., Request model for image generation., Request model for running pipeline with external context., Request model for running pipeline with external context. (+71 more)

### Community 81 - "Community 81"
Cohesion: 0.04
Nodes (78): _extract_balanced_structure(), extract_json_any(), _extract_json_array_value(), _extract_json_dict_fallback(), extract_json_list(), _extract_json_string_value(), extract_solution_prose(), _is_structural_quote() (+70 more)
...
Cohesion: 0.06
Nodes (37): APIKey, AuthManager, AuthorizationError, get_auth_manager(), Simple Token-Based Authentication Middleware Production-ready auth with API key, Hash API key using SHA-256., Set a key with LRU eviction., Generate a new API key.          Args:             name: Human-readable name for (+29 more)

### Community 93 - "Community 93"
Cohesion: 0.07
Nodes (26): _run_store, StopPipelineCommand, ExecuteWidgetCommandHandler, get_handler_registry(), GetHistoryQueryHandler, GetPipelineStatusQueryHandler, HandlerRegistry, ListPresetsQueryHandler (+18 more)

### Community 94 - "Community 94"
Cohesion: 0.08
Nodes (55): benchmark_vs_latency(), main(), measure_pipeline(), _MockLLM, _MockNLI, Latency benchmark: VS vs baseline per deployment profile., write_overhead_table(), benchmark_vs_latency() (+47 more)
...
Cohesion: 0.04
Nodes (125): FastAPI Dependency Injectors for SaaS Auth.  These functions are used as FastA, Reset quota service singleton (useful for tests)., Reset rate limiter singleton (useful for tests)., _reset_quota_service(), _reset_rate_limiter_instance(), AuthenticationError, Require valid API key authentication.     Raises HTTPException if authentication, Optional authentication - returns API key if provided, None otherwise. (+117 more)
...
Cohesion: 0.03
Nodes (74): Backward-compat shim — Neuro client moved to reasoner.clients., get_neuro_client(), Shared HTTP clients with connection pooling.  Reduces TCP handshake overhead for, Get or create a shared AsyncClient for Neuro endpoints., Core preset domain logic: dataclass, validation, and helpers., Persist ownership mapping for a pipeline run., Save a history entry to disk., _save_history_entry() (+66 more)
...
Cohesion: 0.12
Nodes (39): delete_file(), _extract_docx(), _extract_image(), _extract_md(), _extract_pdf(), extract_text(), _extract_txt(), _get_file_extension() (+31 more)
...
Cohesion: 0.05
Nodes (42): Protocol, BehavioralAuditStage, CoverageAuditStage, EmbeddingModel, ExtractedClaim, IntentConsistencyStage, LLMVerifier, ModelRegistry (+34 more)
...
Cohesion: 0.03
Nodes (71): BaseSubAgent, _parse_result(), BaseSubAgent — abstract base class every HyperGate sub-agent must extend.  Each, Extract the first valid JSON object from raw LLM text., One job. One cache. One execute() call., Return the focused system prompt for this sub-agent's single task., Parse the LLM's raw text into a structured dict.         Must always return a di, Run the sub-agent; returns SubAgentOutput (never raises). (+63 more)
...
Cohesion: 0.07
Nodes (33): build_vs_prompt(), compute_verbalized_entropy(), _extract_json_block(), parse_vs_response(), Verbalized Sampling primitives — generation, parsing, normalization, sampling., Strip fences, regex-extract JSON, validate structure., Probability-weighted sample., Deterministic; tie → first. (+25 more)
...
Cohesion: 0.06
Nodes (89): Application Layer - Event Bus  The event bus distributes domain events to subscr, Stop the background queue consumer., Background worker that consumes the event queue., Publish an event to all subscribers.          Handlers are called concurrently w, Execute handler with error isolation and retry., Clear all subscriptions., Get number of subscribers for an event type., Get total number of subscribers. (+81 more)
...
Cohesion: 0.08
Nodes (26): ClaimLabel, Reasoner Pipeline - Output Renderer Rich terminal display and JSON export, with, Dispatch to the appropriate method-specific renderer., render_pipeline_result(), Dispatch to the appropriate method-specific renderer., render_pipeline_result(), Registry that maps method names to rendering strategies., Register a renderer for a method. (+18 more)

### Community 206 - "Community 206"
Cohesion: 0.11
Nodes (27): _docker_available(), _import_smoke_test(), main(), _port_in_use(), print_banner(), Attempt to free a port. Returns True if freed., Attempt to free a port. Returns True if freed., Poll the backend root endpoint until it responds (any 2xx–4xx means it's up). (+19 more)

### Community 207 - "Community 207"
Cohesion: 0.08
Nodes (24): AEROSPACE_CONFIG, Aerospace vertical configuration for VS., LEGAL_CONFIG, Legal vertical configuration for VS., VS Two-Tier Verification Routing stage., Radiology vertical configuration for VS., Verbalized Sampling configuration models and vertical registry., VSVerticalConfig (+16 more)

### Community 208 - "Community 208"
Cohesion: 0.09
Nodes (15): AuditService, Audit Service — Logs query executions as domain events.  Publishes to the Even, EventBus, get_event_bus(), handle_all_events(), handle_event(), init_default_subscribers(), log_all_events() (+7 more)
...
Cohesion: 0.08
Nodes (26): Application flows module., execute_phases_dag(), PhaseFn, PhaseStep, PipelineFlow, Phase sequence registry and dispatcher for reasoning methods., A single step in a pipeline phase sequence., Registry that maps method names to ordered phase sequences. (+18 more)
...
Cohesion: 0.13
Nodes (11): CircuitBreaker, Atomically check availability and acquire call slot if in HALF_OPEN.         Mus, Release call slot (decrement half_open_current_calls).         Must be called wi, Execute function with circuit breaker protection.                  Thread Safety, Handle successful call., Get health status for monitoring., Return True if the circuit allows a call right now.          For use by callers, Record a successful call (for manual use outside ``call()``). (+3 more)
...
Cohesion: 0.08
Nodes (33): classify_error(), ConfigurationError, is_retryable(), JSONExtractionError, JSONValidationError, ParseError, PhaseError, PipelineError (+25 more)

### Community 228 - "Community 228"
Cohesion: 0.10
Nodes (30): MemoryBadge(), AttachButton(), autoResize(), clearFileError(), formatFileSize(), handleDragLeave(), handleDragOver(), handleDrop() (+22 more)
...
Cohesion: 0.05
Nodes (39): 0de94406-8233-4e62-a786-9d349c3ec2dd, 10e1a925-9d05-4e60-862b-aab21cbd2456, 1380a4ff-2814-4dc2-942b-7e85a3ef3dc6, 17600e48-e303-46fc-a7f2-d044ffd91f8c, 1b020eb7-4eda-42f5-9908-18d5fc520965, 225c9182-38f2-46b5-bdbd-be7413f60905, 2369eb54-5ba4-423c-8b54-934a79e4c970, 27f952b2-88e0-4320-92d1-85ff69826cc8 (+31 more)
...
Cohesion: 0.11
Nodes (19): main(), Neuro CLI Manage the internal memory engine., Neuro Memory Engine CLI., Return value if numeric and not NaN, else '?'., Check health and statistics., Start the memory engine server., _safe_num(), start() (+11 more)
...
Cohesion: 0.09
Nodes (25): ErrorOccurred, from_dict(), make_event(), MemoryRecalled, MemoryStored, Reasoner - Domain Events for Event Sourcing  All events are immutable (frozen da, New source added to context., Memory stored in Neuro system. (+17 more)
...
Cohesion: 0.16
Nodes (23): _compute_image_hash(), describe_image(), _detect_mime_type(), _encode_image_base64(), ocr_image(), Image and document extraction utilities using vision-capable LLMs., Extract verbatim text from an image using an OCR-optimized model via OpenRouter., Extract verbatim text from an image using an OCR-optimized model via OpenRouter. (+15 more)
...
Cohesion: 0.07
Nodes (30): ClientBucket, get_rate_limiter(), RateLimiter, Production-Ready Rate Limiter Token bucket algorithm with Redis-like sliding win, Reset sliding windows if expired., Check if request is allowed for client.                  Returns:             (a, Record a successful request (alternative to is_allowed)., Get rate limit stats for client. (+22 more)

### Community 258 - "Community 258"
Cohesion: 0.05
Nodes (48): get_phase_retry_budget(), get_phase_timeout(), get_quality_judge_model(), get_quality_judge_threshold(), get_token_budget(), Single source of truth for all hardcoded constants used across the Reasoner proj, Get token budget for a specific role/phase., Get token budget for a specific role/phase. (+40 more)
...
Cohesion: 0.15
Nodes (22): Widget, suggestions, and UI status endpoints., Check if UI integration is available., ui_status(), Request for generating suggestions., SuggestionRequest, api_models(), api_presets(), detect_widgets() (+14 more)

### Community 262 - "Community 262"
Cohesion: 0.15
Nodes (12): CircuitBreaker, Atomically check availability and acquire call slot if in HALF_OPEN.         Mu, Release call slot (decrement half_open_current_calls).         Must be called w, Execute function with circuit breaker protection.                  Thread Safe, Handle successful call., Return True if the circuit allows a call right now.          For use by caller, Record a successful call (for manual use outside ``call()``).          Release, Record a failed call (for manual use outside ``call()``).          Releases th (+4 more)
...
Cohesion: 0.09
Nodes (16): Concrete implementation of workflow services., HyperGate Pre-Routing, Neuro Long-Term Memory, Routing Table Patch, Provider Router with Fallbacks, ReasonerPipeline, CLI Cleanup Test, Quick jury fix verification. (+8 more)
...
Cohesion: 0.09
Nodes (13): EventStore, get_event_store(), Event Persistence Layer  Stores domain events in SQLite for durability and repla, Determine aggregate type from event type., Get events for an aggregate.          Optionally filter by minimum version for i, Deserialize database row to domain event., Get events since a specific version (for sync/resume)., Get or create database connection. (+5 more)

### Community 272 - "Community 272"
Cohesion: 0.12
Nodes (24): _get_scraper_client(), Reasoner - Web Scraper Module Provides deep reading capabilities to fetch full p, Simple HTML to Markdown conversion., Fetch a URL and convert its content to markdown.          Args:         url: The, Scrape multiple URLs concurrently.          Args:         urls: List of URLs to, Return the shared scraper HTTP client, creating it on first call.     Thread-saf, scrape_url(), scrape_urls() (+16 more)
...
Cohesion: 0.13
Nodes (16): _get_searxng_cb(), asdict(), CircuitState, get_all_circuit_breakers(), get_circuit_breaker(), _get_memory_circuit_breaker(), _get_redis_circuit_breaker(), Reasoner Pipeline - Circuit Breaker Pattern Provides fault tolerance for LLM pr (+8 more)
...
Cohesion: 0.08
Nodes (79): measure_pipeline(), _MockLLM, _MockNLI, bool, float, str, ProviderError, Base exception for LLM provider errors. (+71 more)
...
Cohesion: 0.10
Nodes (18): Serialize state to dictionary., Serialize state to dictionary., Get events that haven't been persisted yet., Serialize event to dictionary for storage., Serialize event to dictionary for storage., Serialize event to dictionary for storage., Deserialize event from dictionary., Serialize event to dictionary for storage. (+10 more)
...
Cohesion: 0.20
Nodes (9): AutonomousDebugger, Phase 2: Check all Python files for syntax errors., Phase 3: Verify all tests can be collected., Phase 4: Run critical regression tests., Phase 5: Check frontend tests., Print summary of findings and fixes., Fully autonomous codebase scanner and fixer., Run complete autonomous debugging and fixing cycle. (+1 more)

### Community 712 - "Community 712"
Cohesion: 0.16
Nodes (14): _chunk_text(), DocumentVectorStore, Chunk and embed a document, writing embeddings to a JSON sidecar.          Args:, Retrieve the top-k most relevant chunks for a query.          Args:, Delete a document's vector sidecar., Split text into overlapping chunks.      Args:         text: Source text., Lightweight per-session vector store using JSON sidecars.      No external DB de, Lazy-load Neuro embedder to avoid circular imports at module load. (+6 more)
...
Cohesion: 0.20
Nodes (14): generate_probes_with_vs(), _LLMClient, VS Probe Generation stage — IntentConsistencyStage., Simplified semantic distance using sequence matcher (0.0=identical, 1.0=complete, _semantic_distance(), RADIOLOGY_CONFIG, str, generate_probes_with_vs() (+6 more)
...
Cohesion: 0.10
Nodes (31): CriticDimensionScore, CriticDimensionScore, Score for one candidate across one critic's 4 dimensions., Score for one candidate across one critic's 4 dimensions., Score for one candidate across one critic's 4 dimensions., Score for one candidate across one critic's 4 dimensions., Score for one candidate across one critic's 4 dimensions., AdversarialRound (+23 more)
...
Cohesion: 0.09
Nodes (24): AuthenticationError, ConfigurationError, is_retryable(), JSONExtractionError, JSONValidationError, ModelNotFoundError, ParseError, PhaseError (+16 more)
...
Cohesion: 0.18
Nodes (12): calculate_model_cost(), format_cost(), get_pricing(), ModelPricing, print_cost_summary(), LLM Pricing Database Tracks per-token pricing for all supported models.  Pricing, Calculate cost for a single API call.          Args:         model_id: Model ide, Format cost in human-readable way. (+4 more)
...
Cohesion: 0.18
Nodes (10): AutonomousDebugger, main(), Phase 2: Check all Python files for syntax errors., Phase 3: Verify all tests can be collected., Phase 4: Run critical regression tests., Phase 5: Check frontend tests., Print summary of findings and fixes., Fully autonomous codebase scanner and fixer. (+2 more)
...
Cohesion: 0.08
Nodes (27): Register a new run and return its cancel event., Clean up a run's state., Get the cancel event for a run., Signal cancellation for a run., Signal cancellation for all active runs., Cancel all active runs in Redis using SMEMBERS (O(1) per member, not SCAN)., Check if a run is currently active (non-locking, best-effort)., Return the user_id that owns a run, or None if anonymous/not found. (+19 more)
...
Cohesion: 0.17
Nodes (19): coding_assemble_prompt(), coding_generate_prompt(), coding_review_prompt(), coding_spec_prompt(), coding_tests_prompt(), Coding pipeline prompts — production-grade code generation., coding_assemble_prompt(), coding_generate_prompt() (+11 more)

### Community 789 - "Community 789"
Cohesion: 0.09
Nodes (33): get_architecture_components(), Lazy initialization of new architecture components., Lazy initialization of new architecture components., _get_pipeline_owner(), Pipeline ownership tracking — shared between API and websocket layers.  Extrac, Return the user_id that owns *pipeline_id*, or None if not tracked., Persist ownership mapping for a pipeline run., _save_pipeline_owner() (+25 more)
...
Cohesion: 0.11
Nodes (20): _enhance_image_prompt(), Enhance a simple image prompt into a detailed one.      Returns the enhanced pro, Public wrapper for image-prompt enhancement used by API preflight flows., _patch_openai_platform_detection(), _perplexity_response_format(), Low-level LLM utilities: platform patches, JSON heuristics, response formatting., Windows WMI can hang indefinitely when the openai library calls     platform.sys, Heuristic: only enable structured outputs for prompts that already demand pure J (+12 more)

### Community 792 - "Community 792"
Cohesion: 0.13
Nodes (12): DashboardContent(), HistoryEntry, QuotaStatus, useQuota(), UsageBadge(), apiFetch(), ChartSkeleton(), isValidPortalUrl() (+4 more)
...
Cohesion: 0.04
Nodes (61): clear_memory_cache(), get_cache_stats(), _prune_disk_cache(), Remove oldest cache files if the directory exceeds the max size., # NOTE: This is a per-process cache. For horizontal scaling, use Redis or, Return memory cache telemetry., Clear the in-memory cache (thread-safe)., Trusted-proxy-aware client IP resolution.  Prevents X-Forwarded-For spoofing by (+53 more)
...
Cohesion: 0.17
Nodes (6): Search using SearXNG., Fetch trending content for topic., Search images using SearXNG., get_searxng_urls(), Return the list of SearXNG URLs to try, respecting SEARXNG_URL env var., Search videos using SearXNG.
...
Cohesion: 0.10
Nodes (15): CircuitBreakerConfig, CircuitBreakerStats, CircuitOpenError, Manually reset circuit to closed state., Raised when circuit breaker is open., Circuit breaker with Redis-backed shared state across workers.      Delegates, Return True if the circuit allows a call right now., Record a successful call. (+7 more)

### Community 813 - "Community 813"
Cohesion: 0.14
Nodes (28): _check_depth(), Safe JSON loading with depth limits to prevent stack exhaustion., Recursively check nesting depth of parsed JSON object., Parse JSON with a strict depth limit.      Args:         data: JSON string or by, safe_json_loads(), _extract_balanced_structure(), extract_json_any(), _extract_json_array_value() (+20 more)
...
Cohesion: 0.08
Nodes (30): AuthenticationError, InfrastructureError, MemoryError, ModelNotFoundError, Base exception for infrastructure errors., Requested model doesn't exist.          This error is NOT retryable - the mode, Authentication failed (invalid API key)., Base exception for search errors. (+22 more)

### Community 821 - "Community 821"
Cohesion: 0.38
Nodes (6): CompressionLevel, ContextCompressor, Language, Convenience helper for quick compression., smart_compress(), str

### Community 822 - "Community 822"
Cohesion: 0.13
Nodes (20): CalculationRequest, DiscoverRequest, StockRequest, WeatherRequest, CalculationRequest, calculate(), discover(), get_stock() (+12 more)
...
Cohesion: 0.13
Nodes (25): _is_circuit_open(), Cross-encoder reranking service for search and memory retrieval.  Supports Coh, Rerank memory chunks (ContextChunk objects) before compression.      Args:, Score a single document against a query using Nemotron Rerank VL via logprobs., Rerank documents using NVIDIA Nemotron Rerank VL (free, via OpenRouter)., Rerank memory chunks (ContextChunk objects) before compression.      Args:, Strip null bytes, normalize Unicode, truncate., Strip null bytes, normalize Unicode, truncate. (+17 more)

### Community 825 - "Community 825"
Cohesion: 0.30
Nodes (11): _authenticate_ws_token(), _extract_bearer_token(), pipeline_websocket(), WebSocket endpoints for real-time pipeline updates., Extract bearer token from query params or Authorization header., Authenticate a WebSocket token and return user_id if valid., WebSocket endpoint for real-time pipeline updates., WebSocket endpoint for specific pipeline. (+3 more)
...
Cohesion: 0.16
Nodes (28): AgentConfig, _apply_defaults(), _build_persona(), _build_provider(), _build_resilient(), CacheConfig, get_agent_data_dir(), get_persona() (+20 more)
...
Cohesion: 0.24
Nodes (11): _is_circuit_open(), Cross-encoder reranking service for search and memory retrieval.  Supports Coher, Rerank memory chunks (ContextChunk objects) before compression.      Args:, Strip null bytes, normalize Unicode, truncate., Lightweight circuit breaker based on recent failures., Rerank documents via cross-encoder (Cohere via OpenRouter by default).      Args, _record_failure(), _record_success() (+3 more)
...
Cohesion: 0.04
Nodes (58): PhaseConfig, LLM call parameters for a single phase.     Frozen so preset overrides produce, Return a new PhaseConfig with selected fields replaced., build_auto_preset(), get_method_from_preset(), get_preset_tier(), PipelinePreset, Extract method name from preset string. (+50 more)
...
Cohesion: 0.20
Nodes (11): HarnessMutation, A governed change-contract for harness mutation (#4).      Immutable once create, HarnessMutation, check_mutation_invariants(), get_model_lab(), HarnessGuard — invariant validation for governed harness mutations (#4).  Paper, Return the training ecosystem for a model alias.      Unknown models default to, Check that a proposed mutation preserves hard invariants.      Args:         mut (+3 more)

### Community 1270 - "Community 1270"
Cohesion: 0.14
Nodes (13): Base URL for internal self-calls (e.g., Neuro endpoints from streaming)., Parse NEURO_REASONING_FALLBACK_MODELS into a list., Parse NEURO_EMBEDDING_FALLBACK_MODELS into a list., Parse CORS_ORIGINS env var into a list of origin strings., Base URL for internal self-calls (e.g., Neuro endpoints from streaming)., Parse NEURO_REASONING_FALLBACK_MODELS into a list., Parse NEURO_EMBEDDING_FALLBACK_MODELS into a list., Parse CORS_ORIGINS env var into a list of origin strings. (+5 more)
...
Cohesion: 0.20
Nodes (16): Base exception for all Reasoner pipeline errors.          Attributes:, ReasonerError, Exception, BaseLLMProvider, LLMError, Raised when an LLM call fails after all retries., ConfigurationError, is_retryable() (+8 more)
...
Cohesion: 0.18
Nodes (10): AuthenticationError, ModelNotFoundError, PhaseError, PipelineError, Requested model doesn't exist.          This error is NOT retryable - the mode, Base exception for pipeline execution errors., Error during a specific pipeline phase.          Attributes:         phase (i, Invalid or missing API key.          This error is NOT retryable - retrying wi (+2 more)
...
Cohesion: 0.08
Nodes (13): CodebaseIntrospector, Main introspector class.          Scans the codebase and generates comprehensive, Discover all Python files in project., Parse a single Python module., Extract function information from AST node., Map test coverage to functions., Build dependency graph from imports., Detect circular dependencies using DFS. (+5 more)

### Community 2717 - "Community 2717"
Cohesion: 0.05
Nodes (44): BaseLLMProvider, complete(), LLMError, Raised when an LLM call fails after all retries., stream_complete(), BaseLLMProvider, Base exception for all Reasoner pipeline errors.          Attributes:, ReasonerError (+36 more)
...
Cohesion: 0.10
Nodes (25): HarnessScorecard, Complete harness scorecard for one query over a time window., EvolutionAgent, EvolutionAgent — orchestrates the five-stage evolution loop (#4).  Paper groundi, Generate HarnessMutations from diagnosis findings., Orchestrates the five-stage harness evolution loop.      Usage (from run_healing, Lazy-init all services to avoid circular imports at module level., Execute the full five-stage evolution loop.          Args:             window_da (+17 more)
...
Cohesion: 0.06
Nodes (55): SuggestionRequestModel, detect_topic(), extract_topic(), generate_suggestions(), generate_suggestions_async(), Smart Suggestions Engine Generates intelligent search suggestions based on parti, Async wrapper for generate_suggestions., Request for generating suggestions. (+47 more)
...
Cohesion: 0.09
Nodes (42): analogical_abstraction_prompt(), analogical_domain_search_prompt(), analogical_mapping_prompt(), analogical_transfer_prompt(), build_followup_context(), build_synthesis_context(), detect_language(), _followup_context() (+34 more)
...
Cohesion: 0.09
Nodes (21): _extract_json(), GateAgent, Gate Agent — Lightweight pre-flight router that decides whether a user prompt s, Return a GateDecision. Any failure falls back to pipeline., Extract the first JSON object from raw text., _extract_json(), GateAgent, Return a GateDecision. Any failure falls back to pipeline. (+13 more)

### Community 2745 - "Community 2745"
Cohesion: 0.11
Nodes (25): clear_history(), delete_history_entry(), get_history(), get_history_entry(), _list_history(), Search history endpoints., Clear all history for the authenticated user., Get search history for the authenticated user. (+17 more)
...
Cohesion: 0.09
Nodes (34): CodeSafetyError, Raised when code is blocked by the safety guard., NoopExecutor, NoopExecutor — graceful degradation when sandbox is unavailable.  Returns execut, Fallback executor that returns a disabled result.      Used when the platform sa, SubprocessExecutor — sandboxed subprocess execution for PoT verification.  Runs, Execute Python code in an isolated subprocess.      Thread-safety: uses tempfile, SubprocessExecutor (+26 more)
...
Cohesion: 0.18
Nodes (4): ChatErrorBoundary, ChatErrorBoundaryProps, ChatErrorBoundaryState, ChatErrorBoundary
...
Cohesion: 0.18
Nodes (11): GetHarnessScorecardQuery, handle_get_harness_scorecard(), GetHarnessScorecardQuery — CQRS read query for harness-level metrics.  A read-on, Query to retrieve harness scorecard metrics.      Args:         window_days: Num, Handle GetHarnessScorecardQuery — delegates to ScorecardService., get_scorecard(), Telemetry API routes — read-only harness metrics., Return harness-level scorecard metrics for the last N days.      Read-only aggre (+3 more)
...
Cohesion: 0.06
Nodes (19): Calculator Widget  Evaluates mathematical expressions using simpleeval (safe eva, Format result for display., Extract expression from match., Evaluate mathematical expression., BaseWidget, Base class for widgets with common functionality.          Provides:     - Patte, Detect if widget should activate based on patterns., Extract parameters from query using regex patterns. (+11 more)
...
Cohesion: 0.06
Nodes (58): _collect_image_candidates(), _contains_policy_risk_terms(), _download_image_url(), _enhance_image_prompt(), _error_matches_any(), _extract_base64_from_text(), _extract_remote_urls_from_text(), _extract_text_from_content_parts() (+50 more)
...
Cohesion: 0.29
Nodes (7): Critical Regression Tests, Auto-Fix Import Mismatches, Frontend Check, main(), Syntax Check, Test Collection Verification, Self-Healing CI

### Community 2818 - "Community 2818"
Cohesion: 0.33
Nodes (5): FineTunedProvider, Provider for fine-tuned models on custom endpoints.      Inherits all retry, str, Any, int, str
...
Cohesion: 0.40
Nodes (4): Background task handlers for periodic maintenance., Background task handlers for periodic maintenance., Reset all usage_quotas at month start. Called by external scheduler., reset_all_quotas_monthly()

### Community 2873 - "Community 2873"
Cohesion: 0.40
Nodes (4): External context integration endpoint., Run the Reasoner pipeline with external context.      This endpoint accepts coll, run_with_context(), External context integration endpoint.
...
Cohesion: 0.40
Nodes (4): estimate_cost(), Cost estimate endpoint — POST /api/estimate.  Estimates tokens, cost, and durati, Estimate tokens, cost, and duration for a pipeline run., RunRequest
...
Cohesion: 0.05
Nodes (83): _filter_routing(), Drop routing entries whose API key is missing; fall back to primary., Drop routing entries whose API key is missing; fall back to primary., Wrap run_stream_cached with Prometheus metrics., Wrap run_stream_cached with Prometheus metrics., Backward-compat gate: require auth when legacy API key mode is disabled., Run pipeline with optional authentication and rate limiting.      Authenticate, Backward-compat gate: require auth when legacy API key mode is disabled. (+75 more)
...
Cohesion: 0.09
Nodes (42): _extract_user_id(), generic_exception_handler(), _get_error_store(), http_exception_handler(), _log_error(), Global Exception Handlers for FastAPI  Captures all unhandled exceptions, HTTP e, Build a safe JSON error response that doesn't leak internals., Build a safe JSON error response that doesn't leak internals. (+34 more)
...
Cohesion: 0.67
Nodes (3): Stop the SearXNG container if we started it., Stop the SearXNG container if we started it., _stop_searxng()
...
Cohesion: 0.06
Nodes (39): Error Persistence Layer  Stores application errors in SQLite for durability and, ErrorStats, ErrorStore, Error Persistence Layer  Stores application errors in SQLite for durability an, Run sync function in thread pool with locking., Initialize database schema., Remove errors older than retention period., Insert an error entry asynchronously. (+31 more)
...
Cohesion: 0.67
Nodes (3): main(), Verify model swaps fix the budget preset JSON format issues., run_one()
...
Cohesion: 0.67
Nodes (3): Render PDF pages to PNG bytes. Runs in a thread pool — all fitz I/O is sync., _render_pdf_pages_sync(), int
...
## Knowledge Gaps
- **21245 isolated node(s):** `nodes`, `edges`, `protocol_version`, `timestamp`, `mode` (+21240 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **485 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.
...
- **Why does `PipelineState` connect `Event Store Snapshot Tests` to `Community 258`, `Community 2690`, `Community 2691`, `Redis & Caching`, `Phase Quality & Prompts`, `LLM Exceptions & Errors`, `Community 788`, `Chat UI Components`, `Community 278`, `Snapshot Tests`, `Synthesis Serialization`, `Community 290`, `Event Store Save Tests`, `Chat Components & Hooks`, `Community 2727`, `Community 40`, `Community 41`, `Community 43`, `Community 2732`, `Community 2742`, `Community 2871`, `Community 826`, `Community 2746`, `Community 2755`, `Community 838`, `Community 73`, `Community 841`, `Community 842`, `Community 844`, `Community 205`, `Community 843`, `Community 2767`, `Community 210`, `Community 727`, `Community 2800`, `Community 112`, `Community 757`, `Community 763`, `Community 253`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `PipelineEventType` connect `Synthesis Serialization` to `Community 289`, `Community 226`, `Community 2755`, `Community 100`, `Community 249`, `Community 97`, `Redis & Caching`, `Community 106`, `JSON Parsing Utilities`, `Snapshot Tests`, `IP Anonymization & GDPR`, `Event Store Snapshot Tests`?**
